...
namespace Hl7.DemoFileSystemFhirServer
{
    ...
    /// </summary>
    public class AzureBlobStorageSystemService : Hl7.Fhir.WebApi.IFhirSystemServiceR4<IServiceProvider>
    {
        public AzureBlobStorageSystemService()
        {
            InitializeIndexes();
        }
        ...
        {
            return new AzureBlobStorageResourceService() { RequestDetails = request, ResourceName = resourceName };
        }
        ...
        public System.Threading.Tasks.Task<Resource> PerformOperation(ModelBaseInputs<IServiceProvider> request, string operation, Parameters operationParameters, SummaryType summary)
        {
            if (operation == "count-em")
            {
                ...
                result.Issue.Add(new OperationOutcome.IssueComponent()
                {
                    ...
                    Details = new CodeableConcept(null, null, $"All resource type instances: {System.IO.Directory.EnumerateFiles(AzureBlobStorageSystemService.Directory, $"*.xml").Count()}")
                });
        ...
        public System.Threading.Tasks.Task<Bundle> SystemHistory(ModelBaseInputs<IServiceProvider> request, DateTimeOffset? since, DateTimeOffset? Till, int? Count, SummaryType summary)
        {
            ...
            var files = System.IO.Directory.EnumerateFiles(AzureBlobStorageSystemService.Directory);
