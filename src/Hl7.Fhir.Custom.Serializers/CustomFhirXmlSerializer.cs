...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    public partial class CustomFhirXmlSerializer2 : XmlSerializer
    {
        ...
        {
            var fw = writer as FhirCustomXmlSerializationWriter;
            fw.Write(o as Base);
        }

        protected override XmlSerializationWriter CreateWriter()
        {
            return new FhirCustomXmlSerializationWriter();
        }

        protected override object Deserialize(XmlSerializationReader reader)
        {
            var fr = reader as FhirCustomXmlSerializationReader;
            return fr.Parse();
        }

        protected override XmlSerializationReader CreateReader()
        {
            return new FhirCustomXmlSerializationReader();
        }
    }
}
...
//                if (o is Base b)
//                {
//                    FhirCustomXmlWriter.SerializeBase(b, xw, "root", new CancellationToken());
//                }
//                xw.Flush();
//            }
//        }
