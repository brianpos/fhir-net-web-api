...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(Account result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "status":
							...
							Parse(result.StatusElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.Account.AccountStatus>, reader, outcome, locationPath + ".status"); // 100
							break;
						case "type":
						...
						case "subject":
							...
							Parse(newItem_subject, reader, outcome, locationPath + ".subject["+result.Subject.Count+"]"); // 130
							result.Subject.Add(newItem_subject);
							break;
						case "servicePeriod":
							result.ServicePeriod = new Hl7.Fhir.Model.Period();
							Parse(result.ServicePeriod as Hl7.Fhir.Model.Period, reader, outcome, locationPath + ".servicePeriod"); // 140
							break;
						case "coverage":
							var newItem_coverage = new Hl7.Fhir.Model.Account.CoverageComponent();
							Parse(newItem_coverage, reader, outcome, locationPath + ".coverage["+result.Coverage.Count+"]"); // 150
							result.Coverage.Add(newItem_coverage);
							break;
						case "owner":
							result.Owner = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Owner as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".owner"); // 160
							break;
						case "description":
							result.DescriptionElement = new Hl7.Fhir.Model.FhirString();
							Parse(result.DescriptionElement as Hl7.Fhir.Model.FhirString, reader, outcome, locationPath + ".description"); // 170
							break;
						case "guarantor":
							var newItem_guarantor = new Hl7.Fhir.Model.Account.GuarantorComponent();
							Parse(newItem_guarantor, reader, outcome, locationPath + ".guarantor["+result.Guarantor.Count+"]"); // 180
							result.Guarantor.Add(newItem_guarantor);
							break;
						case "partOf":
							result.PartOf = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.PartOf as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".partOf"); // 190
							break;
						default:
							// Property not found
		...
		private async System.Threading.Tasks.Task ParseAsync(Account result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "status":
							result.StatusElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.Account.AccountStatus>();
							await ParseAsync(result.StatusElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.Account.AccountStatus>, reader, outcome, locationPath + ".status"); // 100
							break;
						case "type":
							result.Type = new Hl7.Fhir.Model.CodeableConcept();
						...
						case "subject":
							var newItem_subject = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_subject, reader, outcome, locationPath + ".subject["+result.Subject.Count+"]"); // 130
							result.Subject.Add(newItem_subject);
							break;
						case "servicePeriod":
							result.ServicePeriod = new Hl7.Fhir.Model.Period();
							await ParseAsync(result.ServicePeriod as Hl7.Fhir.Model.Period, reader, outcome, locationPath + ".servicePeriod"); // 140
							break;
						case "coverage":
							var newItem_coverage = new Hl7.Fhir.Model.Account.CoverageComponent();
							await ParseAsync(newItem_coverage, reader, outcome, locationPath + ".coverage["+result.Coverage.Count+"]"); // 150
							result.Coverage.Add(newItem_coverage);
							break;
						case "owner":
							result.Owner = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Owner as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".owner"); // 160
							break;
						case "description":
							result.DescriptionElement = new Hl7.Fhir.Model.FhirString();
							await ParseAsync(result.DescriptionElement as Hl7.Fhir.Model.FhirString, reader, outcome, locationPath + ".description"); // 170
							break;
						case "guarantor":
							var newItem_guarantor = new Hl7.Fhir.Model.Account.GuarantorComponent();
							await ParseAsync(newItem_guarantor, reader, outcome, locationPath + ".guarantor["+result.Guarantor.Count+"]"); // 180
							result.Guarantor.Add(newItem_guarantor);
							break;
						case "partOf":
							result.PartOf = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.PartOf as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".partOf"); // 190
							break;
						default:
							// Property not found
