...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(ActivityDefinition result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "kind":
							...
							Parse(result.KindElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.ActivityDefinition.RequestResourceType>, reader, outcome, locationPath + ".kind"); // 370
							break;
						case "profile":
							result.ProfileElement = new Hl7.Fhir.Model.Canonical();
							Parse(result.ProfileElement as Hl7.Fhir.Model.Canonical, reader, outcome, locationPath + ".profile"); // 380
							break;
						case "code":
							result.Code = new Hl7.Fhir.Model.CodeableConcept();
							Parse(result.Code as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".code"); // 390
							break;
						case "intent":
							result.IntentElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.RequestIntent>();
							Parse(result.IntentElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.RequestIntent>, reader, outcome, locationPath + ".intent"); // 400
							break;
						case "priority":
							result.PriorityElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.RequestPriority>();
							Parse(result.PriorityElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.RequestPriority>, reader, outcome, locationPath + ".priority"); // 410
							break;
						case "doNotPerform":
							result.DoNotPerformElement = new Hl7.Fhir.Model.FhirBoolean();
							Parse(result.DoNotPerformElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome, locationPath + ".doNotPerform"); // 420
							break;
						case "timingTiming":
							result.Timing = new Hl7.Fhir.Model.Timing();
							Parse(result.Timing as Hl7.Fhir.Model.Timing, reader, outcome, locationPath + ".timing"); // 430
							break;
						case "timingDateTime":
							result.Timing = new Hl7.Fhir.Model.FhirDateTime();
							Parse(result.Timing as Hl7.Fhir.Model.FhirDateTime, reader, outcome, locationPath + ".timing"); // 430
							break;
						case "timingAge":
							result.Timing = new Hl7.Fhir.Model.Age();
							Parse(result.Timing as Hl7.Fhir.Model.Age, reader, outcome, locationPath + ".timing"); // 430
							break;
						case "timingPeriod":
							result.Timing = new Hl7.Fhir.Model.Period();
							Parse(result.Timing as Hl7.Fhir.Model.Period, reader, outcome, locationPath + ".timing"); // 430
							break;
						case "timingRange":
							result.Timing = new Hl7.Fhir.Model.Range();
							Parse(result.Timing as Hl7.Fhir.Model.Range, reader, outcome, locationPath + ".timing"); // 430
							break;
						case "timingDuration":
							result.Timing = new Hl7.Fhir.Model.Duration();
							Parse(result.Timing as Hl7.Fhir.Model.Duration, reader, outcome, locationPath + ".timing"); // 430
							break;
						case "location":
							result.Location = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Location as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".location"); // 440
							break;
						case "participant":
							var newItem_participant = new Hl7.Fhir.Model.ActivityDefinition.ParticipantComponent();
							Parse(newItem_participant, reader, outcome, locationPath + ".participant["+result.Participant.Count+"]"); // 450
							result.Participant.Add(newItem_participant);
							break;
						case "productReference":
							result.Product = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Product as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".product"); // 460
							break;
						case "productCodeableConcept":
							result.Product = new Hl7.Fhir.Model.CodeableConcept();
							Parse(result.Product as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".product"); // 460
							break;
						case "quantity":
							result.Quantity = new Hl7.Fhir.Model.SimpleQuantity();
							Parse(result.Quantity as Hl7.Fhir.Model.SimpleQuantity, reader, outcome, locationPath + ".quantity"); // 470
							break;
						case "dosage":
							var newItem_dosage = new Hl7.Fhir.Model.Dosage();
							Parse(newItem_dosage, reader, outcome, locationPath + ".dosage["+result.Dosage.Count+"]"); // 480
							result.Dosage.Add(newItem_dosage);
							break;
						case "bodySite":
							var newItem_bodySite = new Hl7.Fhir.Model.CodeableConcept();
							Parse(newItem_bodySite, reader, outcome, locationPath + ".bodySite["+result.BodySite.Count+"]"); // 490
						...
						case "specimenRequirement":
							...
							Parse(newItem_specimenRequirement, reader, outcome, locationPath + ".specimenRequirement["+result.SpecimenRequirement.Count+"]"); // 500
						...
						case "observationRequirement":
							...
							Parse(newItem_observationRequirement, reader, outcome, locationPath + ".observationRequirement["+result.ObservationRequirement.Count+"]"); // 510
						...
						case "observationResultRequirement":
							...
							Parse(newItem_observationResultRequirement, reader, outcome, locationPath + ".observationResultRequirement["+result.ObservationResultRequirement.Count+"]"); // 520
						...
						case "transform":
							...
							Parse(result.TransformElement as Hl7.Fhir.Model.Canonical, reader, outcome, locationPath + ".transform"); // 530
							break;
						case "dynamicValue":
							var newItem_dynamicValue = new Hl7.Fhir.Model.ActivityDefinition.DynamicValueComponent();
							Parse(newItem_dynamicValue, reader, outcome, locationPath + ".dynamicValue["+result.DynamicValue.Count+"]"); // 540
		...
		private async System.Threading.Tasks.Task ParseAsync(ActivityDefinition result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "kind":
							result.KindElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.ActivityDefinition.RequestResourceType>();
							await ParseAsync(result.KindElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.ActivityDefinition.RequestResourceType>, reader, outcome, locationPath + ".kind"); // 370
							break;
						case "profile":
							result.ProfileElement = new Hl7.Fhir.Model.Canonical();
							await ParseAsync(result.ProfileElement as Hl7.Fhir.Model.Canonical, reader, outcome, locationPath + ".profile"); // 380
							break;
						case "code":
							result.Code = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.Code as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".code"); // 390
							break;
						case "intent":
							result.IntentElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.RequestIntent>();
							await ParseAsync(result.IntentElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.RequestIntent>, reader, outcome, locationPath + ".intent"); // 400
							break;
						case "priority":
							result.PriorityElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.RequestPriority>();
							await ParseAsync(result.PriorityElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.RequestPriority>, reader, outcome, locationPath + ".priority"); // 410
							break;
						case "doNotPerform":
							result.DoNotPerformElement = new Hl7.Fhir.Model.FhirBoolean();
							await ParseAsync(result.DoNotPerformElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome, locationPath + ".doNotPerform"); // 420
							break;
						case "timingTiming":
							result.Timing = new Hl7.Fhir.Model.Timing();
							await ParseAsync(result.Timing as Hl7.Fhir.Model.Timing, reader, outcome, locationPath + ".timing"); // 430
							break;
						case "timingDateTime":
							result.Timing = new Hl7.Fhir.Model.FhirDateTime();
							await ParseAsync(result.Timing as Hl7.Fhir.Model.FhirDateTime, reader, outcome, locationPath + ".timing"); // 430
							break;
						case "timingAge":
							result.Timing = new Hl7.Fhir.Model.Age();
							await ParseAsync(result.Timing as Hl7.Fhir.Model.Age, reader, outcome, locationPath + ".timing"); // 430
							break;
						case "timingPeriod":
							result.Timing = new Hl7.Fhir.Model.Period();
							await ParseAsync(result.Timing as Hl7.Fhir.Model.Period, reader, outcome, locationPath + ".timing"); // 430
							break;
						case "timingRange":
							result.Timing = new Hl7.Fhir.Model.Range();
							await ParseAsync(result.Timing as Hl7.Fhir.Model.Range, reader, outcome, locationPath + ".timing"); // 430
							break;
						case "timingDuration":
							result.Timing = new Hl7.Fhir.Model.Duration();
							await ParseAsync(result.Timing as Hl7.Fhir.Model.Duration, reader, outcome, locationPath + ".timing"); // 430
							break;
						case "location":
							result.Location = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Location as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".location"); // 440
							break;
						case "participant":
							var newItem_participant = new Hl7.Fhir.Model.ActivityDefinition.ParticipantComponent();
							await ParseAsync(newItem_participant, reader, outcome, locationPath + ".participant["+result.Participant.Count+"]"); // 450
							result.Participant.Add(newItem_participant);
							break;
						case "productReference":
							result.Product = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Product as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".product"); // 460
							break;
						case "productCodeableConcept":
							result.Product = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.Product as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".product"); // 460
							break;
						case "quantity":
							result.Quantity = new Hl7.Fhir.Model.SimpleQuantity();
							await ParseAsync(result.Quantity as Hl7.Fhir.Model.SimpleQuantity, reader, outcome, locationPath + ".quantity"); // 470
							break;
						case "dosage":
							var newItem_dosage = new Hl7.Fhir.Model.Dosage();
							await ParseAsync(newItem_dosage, reader, outcome, locationPath + ".dosage["+result.Dosage.Count+"]"); // 480
							result.Dosage.Add(newItem_dosage);
							break;
						case "bodySite":
							var newItem_bodySite = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_bodySite, reader, outcome, locationPath + ".bodySite["+result.BodySite.Count+"]"); // 490
							result.BodySite.Add(newItem_bodySite);
							break;
						case "specimenRequirement":
							var newItem_specimenRequirement = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_specimenRequirement, reader, outcome, locationPath + ".specimenRequirement["+result.SpecimenRequirement.Count+"]"); // 500
							result.SpecimenRequirement.Add(newItem_specimenRequirement);
							break;
						case "observationRequirement":
							var newItem_observationRequirement = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_observationRequirement, reader, outcome, locationPath + ".observationRequirement["+result.ObservationRequirement.Count+"]"); // 510
							result.ObservationRequirement.Add(newItem_observationRequirement);
							break;
						case "observationResultRequirement":
							var newItem_observationResultRequirement = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_observationResultRequirement, reader, outcome, locationPath + ".observationResultRequirement["+result.ObservationResultRequirement.Count+"]"); // 520
							result.ObservationResultRequirement.Add(newItem_observationResultRequirement);
							break;
						case "transform":
							result.TransformElement = new Hl7.Fhir.Model.Canonical();
							await ParseAsync(result.TransformElement as Hl7.Fhir.Model.Canonical, reader, outcome, locationPath + ".transform"); // 530
							break;
						case "dynamicValue":
							var newItem_dynamicValue = new Hl7.Fhir.Model.ActivityDefinition.DynamicValueComponent();
							await ParseAsync(newItem_dynamicValue, reader, outcome, locationPath + ".dynamicValue["+result.DynamicValue.Count+"]"); // 540
							result.DynamicValue.Add(newItem_dynamicValue);
							break;
						default:
							// Property not found
