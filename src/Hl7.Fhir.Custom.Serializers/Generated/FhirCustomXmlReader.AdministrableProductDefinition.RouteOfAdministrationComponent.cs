...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		public void Parse(Hl7.Fhir.Model.AdministrableProductDefinition.RouteOfAdministrationComponent result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "maxTreatmentPeriod":
							...
							break;
						case "targetSpecies":
							var newItem_targetSpecies = new Hl7.Fhir.Model.AdministrableProductDefinition.TargetSpeciesComponent();
		...
		public async System.Threading.Tasks.Task ParseAsync(Hl7.Fhir.Model.AdministrableProductDefinition.RouteOfAdministrationComponent result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
