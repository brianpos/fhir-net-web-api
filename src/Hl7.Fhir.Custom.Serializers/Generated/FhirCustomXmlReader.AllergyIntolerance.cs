...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(AllergyIntolerance result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "type":
							...
							Parse(result.TypeElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.AllergyIntolerance.AllergyIntoleranceType>, reader, outcome, locationPath + ".type", cancellationToken); // 120
							break;
						case "category":
							var newItem_category = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.AllergyIntolerance.AllergyIntoleranceCategory>();
							Parse(newItem_category, reader, outcome, locationPath + ".category["+result.CategoryElement.Count+"]", cancellationToken); // 130
						...
						case "criticality":
							...
							Parse(result.CriticalityElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.AllergyIntolerance.AllergyIntoleranceCriticality>, reader, outcome, locationPath + ".criticality", cancellationToken); // 140
							break;
						case "code":
							result.Code = new Hl7.Fhir.Model.CodeableConcept();
							Parse(result.Code as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".code", cancellationToken); // 150
							break;
						case "patient":
							result.Patient = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Patient as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".patient", cancellationToken); // 160
							break;
						case "encounter":
						...
						case "recordedDate":
							...
							Parse(result.RecordedDateElement as Hl7.Fhir.Model.FhirDateTime, reader, outcome, locationPath + ".recordedDate", cancellationToken); // 190
							break;
						case "recorder":
							result.Recorder = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Recorder as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".recorder", cancellationToken); // 200
							break;
						case "asserter":
							result.Asserter = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Asserter as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".asserter", cancellationToken); // 210
							break;
						case "lastOccurrence":
							result.LastOccurrenceElement = new Hl7.Fhir.Model.FhirDateTime();
							Parse(result.LastOccurrenceElement as Hl7.Fhir.Model.FhirDateTime, reader, outcome, locationPath + ".lastOccurrence", cancellationToken); // 220
							break;
						case "note":
						...
						case "reaction":
							...
							Parse(newItem_reaction, reader, outcome, locationPath + ".reaction["+result.Reaction.Count+"]", cancellationToken); // 240
		...
		private async System.Threading.Tasks.Task ParseAsync(AllergyIntolerance result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "type":
							result.TypeElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.AllergyIntolerance.AllergyIntoleranceType>();
							await ParseAsync(result.TypeElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.AllergyIntolerance.AllergyIntoleranceType>, reader, outcome, locationPath + ".type", cancellationToken); // 120
							break;
						case "category":
							var newItem_category = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.AllergyIntolerance.AllergyIntoleranceCategory>();
							await ParseAsync(newItem_category, reader, outcome, locationPath + ".category["+result.CategoryElement.Count+"]", cancellationToken); // 130
							result.CategoryElement.Add(newItem_category);
							break;
						case "criticality":
							result.CriticalityElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.AllergyIntolerance.AllergyIntoleranceCriticality>();
							await ParseAsync(result.CriticalityElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.AllergyIntolerance.AllergyIntoleranceCriticality>, reader, outcome, locationPath + ".criticality", cancellationToken); // 140
							break;
						case "code":
							result.Code = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.Code as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".code", cancellationToken); // 150
							break;
						case "patient":
							result.Patient = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Patient as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".patient", cancellationToken); // 160
							break;
						case "encounter":
							result.Encounter = new Hl7.Fhir.Model.ResourceReference();
						...
						case "recordedDate":
							result.RecordedDateElement = new Hl7.Fhir.Model.FhirDateTime();
							await ParseAsync(result.RecordedDateElement as Hl7.Fhir.Model.FhirDateTime, reader, outcome, locationPath + ".recordedDate", cancellationToken); // 190
							break;
						case "recorder":
							result.Recorder = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Recorder as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".recorder", cancellationToken); // 200
							break;
						case "asserter":
							result.Asserter = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Asserter as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".asserter", cancellationToken); // 210
							break;
						case "lastOccurrence":
							result.LastOccurrenceElement = new Hl7.Fhir.Model.FhirDateTime();
							await ParseAsync(result.LastOccurrenceElement as Hl7.Fhir.Model.FhirDateTime, reader, outcome, locationPath + ".lastOccurrence", cancellationToken); // 220
							break;
						case "note":
							var newItem_note = new Hl7.Fhir.Model.Annotation();
						...
						case "reaction":
							var newItem_reaction = new Hl7.Fhir.Model.AllergyIntolerance.ReactionComponent();
							await ParseAsync(newItem_reaction, reader, outcome, locationPath + ".reaction["+result.Reaction.Count+"]", cancellationToken); // 240
							result.Reaction.Add(newItem_reaction);
							break;
						default:
							// Property not found
