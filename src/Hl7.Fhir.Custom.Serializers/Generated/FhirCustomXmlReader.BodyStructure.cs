...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(BodyStructure result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "morphology":
							...
							Parse(result.Morphology as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".morphology", cancellationToken); // 110
							break;
						case "location":
						...
						case "locationQualifier":
							...
							Parse(newItem_locationQualifier, reader, outcome, locationPath + ".locationQualifier["+result.LocationQualifier.Count+"]", cancellationToken); // 130
						...
						case "image":
							...
							Parse(newItem_image, reader, outcome, locationPath + ".image["+result.Image.Count+"]", cancellationToken); // 150
		...
		private async System.Threading.Tasks.Task ParseAsync(BodyStructure result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "morphology":
							result.Morphology = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.Morphology as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".morphology", cancellationToken); // 110
							break;
						case "location":
							result.Location = new Hl7.Fhir.Model.CodeableConcept();
						...
						case "locationQualifier":
							var newItem_locationQualifier = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_locationQualifier, reader, outcome, locationPath + ".locationQualifier["+result.LocationQualifier.Count+"]", cancellationToken); // 130
							result.LocationQualifier.Add(newItem_locationQualifier);
							break;
						case "description":
							result.DescriptionElement = new Hl7.Fhir.Model.FhirString();
						...
						case "image":
							var newItem_image = new Hl7.Fhir.Model.Attachment();
							await ParseAsync(newItem_image, reader, outcome, locationPath + ".image["+result.Image.Count+"]", cancellationToken); // 150
							result.Image.Add(newItem_image);
							break;
						case "patient":
							result.Patient = new Hl7.Fhir.Model.ResourceReference();
