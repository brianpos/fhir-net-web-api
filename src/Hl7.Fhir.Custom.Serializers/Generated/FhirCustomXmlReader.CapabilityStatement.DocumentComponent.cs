...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		public void Parse(Hl7.Fhir.Model.CapabilityStatement.DocumentComponent result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "mode":
							...
							Parse(result.ModeElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.CapabilityStatement.DocumentMode>, reader, outcome, locationPath + ".mode"); // 40
							break;
						case "documentation":
		...
		public async System.Threading.Tasks.Task ParseAsync(Hl7.Fhir.Model.CapabilityStatement.DocumentComponent result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "mode":
							result.ModeElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.CapabilityStatement.DocumentMode>();
							await ParseAsync(result.ModeElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.CapabilityStatement.DocumentMode>, reader, outcome, locationPath + ".mode"); // 40
							break;
						case "documentation":
							result.Documentation = new Hl7.Fhir.Model.Markdown();
