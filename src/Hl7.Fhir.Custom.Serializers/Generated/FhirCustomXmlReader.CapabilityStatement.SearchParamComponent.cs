...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		public void Parse(Hl7.Fhir.Model.CapabilityStatement.SearchParamComponent result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "type":
							...
							Parse(result.TypeElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.SearchParamType>, reader, outcome, locationPath + ".type"); // 60
							break;
						case "documentation":
		...
		public async System.Threading.Tasks.Task ParseAsync(Hl7.Fhir.Model.CapabilityStatement.SearchParamComponent result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "type":
							result.TypeElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.SearchParamType>();
							await ParseAsync(result.TypeElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.SearchParamType>, reader, outcome, locationPath + ".type"); // 60
							break;
						case "documentation":
							result.Documentation = new Hl7.Fhir.Model.Markdown();
