...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(CarePlan result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "intent":
							...
							Parse(result.IntentElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.CarePlan.CarePlanIntent>, reader, outcome, locationPath + ".intent"); // 160
							break;
						case "category":
						...
						case "title":
							...
							Parse(result.TitleElement as Hl7.Fhir.Model.FhirString, reader, outcome, locationPath + ".title"); // 180
							break;
						case "description":
						...
						case "created":
							...
							Parse(result.CreatedElement as Hl7.Fhir.Model.FhirDateTime, reader, outcome, locationPath + ".created"); // 230
							break;
						case "author":
							result.Author = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Author as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".author"); // 240
							break;
						case "contributor":
							var newItem_contributor = new Hl7.Fhir.Model.ResourceReference();
							Parse(newItem_contributor, reader, outcome, locationPath + ".contributor["+result.Contributor.Count+"]"); // 250
							result.Contributor.Add(newItem_contributor);
							break;
						case "careTeam":
							var newItem_careTeam = new Hl7.Fhir.Model.ResourceReference();
							Parse(newItem_careTeam, reader, outcome, locationPath + ".careTeam["+result.CareTeam.Count+"]"); // 260
							result.CareTeam.Add(newItem_careTeam);
							break;
						case "addresses":
							var newItem_addresses = new Hl7.Fhir.Model.ResourceReference();
							Parse(newItem_addresses, reader, outcome, locationPath + ".addresses["+result.Addresses.Count+"]"); // 270
							result.Addresses.Add(newItem_addresses);
							break;
						case "supportingInfo":
							var newItem_supportingInfo = new Hl7.Fhir.Model.ResourceReference();
							Parse(newItem_supportingInfo, reader, outcome, locationPath + ".supportingInfo["+result.SupportingInfo.Count+"]"); // 280
							result.SupportingInfo.Add(newItem_supportingInfo);
							break;
						case "goal":
							var newItem_goal = new Hl7.Fhir.Model.ResourceReference();
							Parse(newItem_goal, reader, outcome, locationPath + ".goal["+result.Goal.Count+"]"); // 290
							result.Goal.Add(newItem_goal);
							break;
						case "activity":
							var newItem_activity = new Hl7.Fhir.Model.CarePlan.ActivityComponent();
							Parse(newItem_activity, reader, outcome, locationPath + ".activity["+result.Activity.Count+"]"); // 300
		...
		private async System.Threading.Tasks.Task ParseAsync(CarePlan result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "intent":
							result.IntentElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.CarePlan.CarePlanIntent>();
							await ParseAsync(result.IntentElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.CarePlan.CarePlanIntent>, reader, outcome, locationPath + ".intent"); // 160
							break;
						case "category":
							var newItem_category = new Hl7.Fhir.Model.CodeableConcept();
						...
						case "title":
							result.TitleElement = new Hl7.Fhir.Model.FhirString();
							await ParseAsync(result.TitleElement as Hl7.Fhir.Model.FhirString, reader, outcome, locationPath + ".title"); // 180
							break;
						case "description":
							result.DescriptionElement = new Hl7.Fhir.Model.FhirString();
						...
						case "created":
							result.CreatedElement = new Hl7.Fhir.Model.FhirDateTime();
							await ParseAsync(result.CreatedElement as Hl7.Fhir.Model.FhirDateTime, reader, outcome, locationPath + ".created"); // 230
							break;
						case "author":
							result.Author = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Author as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".author"); // 240
							break;
						case "contributor":
							var newItem_contributor = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_contributor, reader, outcome, locationPath + ".contributor["+result.Contributor.Count+"]"); // 250
							result.Contributor.Add(newItem_contributor);
							break;
						case "careTeam":
							var newItem_careTeam = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_careTeam, reader, outcome, locationPath + ".careTeam["+result.CareTeam.Count+"]"); // 260
							result.CareTeam.Add(newItem_careTeam);
							break;
						case "addresses":
							var newItem_addresses = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_addresses, reader, outcome, locationPath + ".addresses["+result.Addresses.Count+"]"); // 270
							result.Addresses.Add(newItem_addresses);
							break;
						case "supportingInfo":
							var newItem_supportingInfo = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_supportingInfo, reader, outcome, locationPath + ".supportingInfo["+result.SupportingInfo.Count+"]"); // 280
							result.SupportingInfo.Add(newItem_supportingInfo);
							break;
						case "goal":
							var newItem_goal = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_goal, reader, outcome, locationPath + ".goal["+result.Goal.Count+"]"); // 290
							result.Goal.Add(newItem_goal);
							break;
						case "activity":
							var newItem_activity = new Hl7.Fhir.Model.CarePlan.ActivityComponent();
							await ParseAsync(newItem_activity, reader, outcome, locationPath + ".activity["+result.Activity.Count+"]"); // 300
							result.Activity.Add(newItem_activity);
							break;
						case "note":
							var newItem_note = new Hl7.Fhir.Model.Annotation();
