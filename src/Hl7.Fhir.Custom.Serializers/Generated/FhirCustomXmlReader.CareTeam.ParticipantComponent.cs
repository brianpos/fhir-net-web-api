...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		public void Parse(Hl7.Fhir.Model.CareTeam.ParticipantComponent result, XmlReader reader, OperationOutcome outcome)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "role":
							...
							Parse(newItem_role, reader, outcome); // 40
							result.Role.Add(newItem_role);
							break;
						case "member":
							result.Member = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Member as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 50
							break;
						case "onBehalfOf":
		...
		public async System.Threading.Tasks.Task ParseAsync(Hl7.Fhir.Model.CareTeam.ParticipantComponent result, XmlReader reader, OperationOutcome outcome)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "role":
							var newItem_role = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_role, reader, outcome); // 40
							result.Role.Add(newItem_role);
							break;
						case "member":
							result.Member = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Member as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 50
							break;
						case "onBehalfOf":
							result.OnBehalfOf = new Hl7.Fhir.Model.ResourceReference();
