...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(Citation result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "approvalDate":
							...
							Parse(result.ApprovalDateElement as Hl7.Fhir.Model.Date, reader, outcome, locationPath + ".approvalDate", cancellationToken); // 240
							break;
						case "lastReviewDate":
							result.LastReviewDateElement = new Hl7.Fhir.Model.Date();
							Parse(result.LastReviewDateElement as Hl7.Fhir.Model.Date, reader, outcome, locationPath + ".lastReviewDate", cancellationToken); // 250
							break;
						case "effectivePeriod":
							result.EffectivePeriod = new Hl7.Fhir.Model.Period();
							Parse(result.EffectivePeriod as Hl7.Fhir.Model.Period, reader, outcome, locationPath + ".effectivePeriod", cancellationToken); // 260
							break;
						case "author":
						...
						case "endorser":
							...
							break;
						case "summary":
							var newItem_summary = new Hl7.Fhir.Model.Citation.SummaryComponent();
							Parse(newItem_summary, reader, outcome, locationPath + ".summary["+result.Summary.Count+"]", cancellationToken); // 310
							result.Summary.Add(newItem_summary);
							break;
						case "classification":
							var newItem_classification = new Hl7.Fhir.Model.Citation.ClassificationComponent();
							Parse(newItem_classification, reader, outcome, locationPath + ".classification["+result.Classification.Count+"]", cancellationToken); // 320
						...
						case "currentState":
							...
							Parse(newItem_currentState, reader, outcome, locationPath + ".currentState["+result.CurrentState.Count+"]", cancellationToken); // 340
							result.CurrentState.Add(newItem_currentState);
							break;
						case "statusDate":
							var newItem_statusDate = new Hl7.Fhir.Model.Citation.StatusDateComponent();
							Parse(newItem_statusDate, reader, outcome, locationPath + ".statusDate["+result.StatusDate.Count+"]", cancellationToken); // 350
							result.StatusDate.Add(newItem_statusDate);
							break;
						case "relatesTo":
							var newItem_relatesTo = new Hl7.Fhir.Model.Citation.RelatesToComponent();
							Parse(newItem_relatesTo, reader, outcome, locationPath + ".relatesTo["+result.RelatesTo.Count+"]", cancellationToken); // 360
							result.RelatesTo.Add(newItem_relatesTo);
							break;
						case "citedArtifact":
							result.CitedArtifact = new Hl7.Fhir.Model.Citation.CitedArtifactComponent();
							Parse(result.CitedArtifact as Hl7.Fhir.Model.Citation.CitedArtifactComponent, reader, outcome, locationPath + ".citedArtifact", cancellationToken); // 370
							break;
						default:
							// Property not found
		...
		private async System.Threading.Tasks.Task ParseAsync(Citation result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "approvalDate":
							result.ApprovalDateElement = new Hl7.Fhir.Model.Date();
							await ParseAsync(result.ApprovalDateElement as Hl7.Fhir.Model.Date, reader, outcome, locationPath + ".approvalDate", cancellationToken); // 240
							break;
						case "lastReviewDate":
							result.LastReviewDateElement = new Hl7.Fhir.Model.Date();
							await ParseAsync(result.LastReviewDateElement as Hl7.Fhir.Model.Date, reader, outcome, locationPath + ".lastReviewDate", cancellationToken); // 250
							break;
						case "effectivePeriod":
							result.EffectivePeriod = new Hl7.Fhir.Model.Period();
							await ParseAsync(result.EffectivePeriod as Hl7.Fhir.Model.Period, reader, outcome, locationPath + ".effectivePeriod", cancellationToken); // 260
							break;
						case "author":
							var newItem_author = new Hl7.Fhir.Model.ContactDetail();
						...
						case "summary":
							var newItem_summary = new Hl7.Fhir.Model.Citation.SummaryComponent();
							await ParseAsync(newItem_summary, reader, outcome, locationPath + ".summary["+result.Summary.Count+"]", cancellationToken); // 310
							result.Summary.Add(newItem_summary);
							break;
						case "classification":
							var newItem_classification = new Hl7.Fhir.Model.Citation.ClassificationComponent();
							await ParseAsync(newItem_classification, reader, outcome, locationPath + ".classification["+result.Classification.Count+"]", cancellationToken); // 320
							result.Classification.Add(newItem_classification);
							break;
						case "note":
							var newItem_note = new Hl7.Fhir.Model.Annotation();
						...
						case "currentState":
							var newItem_currentState = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_currentState, reader, outcome, locationPath + ".currentState["+result.CurrentState.Count+"]", cancellationToken); // 340
							result.CurrentState.Add(newItem_currentState);
							break;
						case "statusDate":
							var newItem_statusDate = new Hl7.Fhir.Model.Citation.StatusDateComponent();
							await ParseAsync(newItem_statusDate, reader, outcome, locationPath + ".statusDate["+result.StatusDate.Count+"]", cancellationToken); // 350
							result.StatusDate.Add(newItem_statusDate);
							break;
						case "relatesTo":
							var newItem_relatesTo = new Hl7.Fhir.Model.Citation.RelatesToComponent();
							await ParseAsync(newItem_relatesTo, reader, outcome, locationPath + ".relatesTo["+result.RelatesTo.Count+"]", cancellationToken); // 360
							result.RelatesTo.Add(newItem_relatesTo);
							break;
						case "citedArtifact":
							result.CitedArtifact = new Hl7.Fhir.Model.Citation.CitedArtifactComponent();
							await ParseAsync(result.CitedArtifact as Hl7.Fhir.Model.Citation.CitedArtifactComponent, reader, outcome, locationPath + ".citedArtifact", cancellationToken); // 370
							break;
						default:
							// Property not found
