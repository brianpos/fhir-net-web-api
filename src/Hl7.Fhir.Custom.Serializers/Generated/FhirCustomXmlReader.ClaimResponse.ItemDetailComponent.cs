...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		public void Parse(Hl7.Fhir.Model.ClaimResponse.ItemDetailComponent result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "detailSequence":
							...
							Parse(result.DetailSequenceElement as Hl7.Fhir.Model.PositiveInt, reader, outcome, locationPath + ".detailSequence"); // 40
							break;
						case "noteNumber":
						...
						case "subDetail":
							...
							Parse(newItem_subDetail, reader, outcome, locationPath + ".subDetail["+result.SubDetail.Count+"]"); // 70
		...
		public async System.Threading.Tasks.Task ParseAsync(Hl7.Fhir.Model.ClaimResponse.ItemDetailComponent result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "detailSequence":
							result.DetailSequenceElement = new Hl7.Fhir.Model.PositiveInt();
							await ParseAsync(result.DetailSequenceElement as Hl7.Fhir.Model.PositiveInt, reader, outcome, locationPath + ".detailSequence"); // 40
							break;
						case "noteNumber":
							var newItem_noteNumber = new Hl7.Fhir.Model.PositiveInt();
						...
						case "subDetail":
							var newItem_subDetail = new Hl7.Fhir.Model.ClaimResponse.SubDetailComponent();
							await ParseAsync(newItem_subDetail, reader, outcome, locationPath + ".subDetail["+result.SubDetail.Count+"]"); // 70
							result.SubDetail.Add(newItem_subDetail);
							break;
						default:
							// Property not found
