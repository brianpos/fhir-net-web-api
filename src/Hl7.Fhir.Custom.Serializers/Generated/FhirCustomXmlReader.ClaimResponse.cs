...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(ClaimResponse result, XmlReader reader, OperationOutcome outcome)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "created":
							...
							Parse(result.CreatedElement as Hl7.Fhir.Model.FhirDateTime, reader, outcome); // 150
							break;
						case "insurer":
							result.Insurer = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Insurer as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 160
							break;
						case "requestor":
							result.Requestor = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Requestor as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 170
							break;
						case "request":
							result.Request = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Request as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 180
							break;
						case "outcome":
							result.OutcomeElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.ClaimProcessingCodes>();
							Parse(result.OutcomeElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.ClaimProcessingCodes>, reader, outcome); // 190
							break;
						case "disposition":
							result.DispositionElement = new Hl7.Fhir.Model.FhirString();
							Parse(result.DispositionElement as Hl7.Fhir.Model.FhirString, reader, outcome); // 200
							break;
						case "preAuthRef":
						...
						case "error":
							...
							Parse(newItem_error, reader, outcome); // 350
		...
		private async System.Threading.Tasks.Task ParseAsync(ClaimResponse result, XmlReader reader, OperationOutcome outcome)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "created":
							result.CreatedElement = new Hl7.Fhir.Model.FhirDateTime();
							await ParseAsync(result.CreatedElement as Hl7.Fhir.Model.FhirDateTime, reader, outcome); // 150
							break;
						case "insurer":
							result.Insurer = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Insurer as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 160
							break;
						case "requestor":
							result.Requestor = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Requestor as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 170
							break;
						case "request":
							result.Request = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Request as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 180
							break;
						case "outcome":
							result.OutcomeElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.ClaimProcessingCodes>();
							await ParseAsync(result.OutcomeElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.ClaimProcessingCodes>, reader, outcome); // 190
							break;
						case "disposition":
							result.DispositionElement = new Hl7.Fhir.Model.FhirString();
							await ParseAsync(result.DispositionElement as Hl7.Fhir.Model.FhirString, reader, outcome); // 200
							break;
						case "preAuthRef":
							result.PreAuthRefElement = new Hl7.Fhir.Model.FhirString();
						...
						case "preAuthPeriod":
							result.PreAuthPeriod = new Hl7.Fhir.Model.Period();
							await ParseAsync(result.PreAuthPeriod as Hl7.Fhir.Model.Period, reader, outcome); // 220
							break;
						case "payeeType":
							result.PayeeType = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.PayeeType as Hl7.Fhir.Model.CodeableConcept, reader, outcome); // 230
							break;
						case "item":
							var newItem_item = new Hl7.Fhir.Model.ClaimResponse.ItemComponent();
							await ParseAsync(newItem_item, reader, outcome); // 240
							result.Item.Add(newItem_item);
							break;
						case "addItem":
							var newItem_addItem = new Hl7.Fhir.Model.ClaimResponse.AddedItemComponent();
							await ParseAsync(newItem_addItem, reader, outcome); // 250
							result.AddItem.Add(newItem_addItem);
							break;
						case "adjudication":
							var newItem_adjudication = new Hl7.Fhir.Model.ClaimResponse.AdjudicationComponent();
							await ParseAsync(newItem_adjudication, reader, outcome); // 260
							result.Adjudication.Add(newItem_adjudication);
							break;
						case "total":
							var newItem_total = new Hl7.Fhir.Model.ClaimResponse.TotalComponent();
							await ParseAsync(newItem_total, reader, outcome); // 270
							result.Total.Add(newItem_total);
							break;
						case "payment":
							result.Payment = new Hl7.Fhir.Model.ClaimResponse.PaymentComponent();
							await ParseAsync(result.Payment as Hl7.Fhir.Model.ClaimResponse.PaymentComponent, reader, outcome); // 280
							break;
						case "fundsReserve":
							result.FundsReserve = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.FundsReserve as Hl7.Fhir.Model.CodeableConcept, reader, outcome); // 290
							break;
						case "formCode":
							result.FormCode = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.FormCode as Hl7.Fhir.Model.CodeableConcept, reader, outcome); // 300
							break;
						case "form":
							result.Form = new Hl7.Fhir.Model.Attachment();
							await ParseAsync(result.Form as Hl7.Fhir.Model.Attachment, reader, outcome); // 310
							break;
						case "processNote":
							var newItem_processNote = new Hl7.Fhir.Model.ClaimResponse.NoteComponent();
							await ParseAsync(newItem_processNote, reader, outcome); // 320
							result.ProcessNote.Add(newItem_processNote);
							break;
						case "communicationRequest":
							var newItem_communicationRequest = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_communicationRequest, reader, outcome); // 330
							result.CommunicationRequest.Add(newItem_communicationRequest);
							break;
						case "insurance":
							var newItem_insurance = new Hl7.Fhir.Model.ClaimResponse.InsuranceComponent();
						...
						case "error":
							var newItem_error = new Hl7.Fhir.Model.ClaimResponse.ErrorComponent();
							await ParseAsync(newItem_error, reader, outcome); // 350
							result.Error.Add(newItem_error);
							break;
						default:
							// Property not found
