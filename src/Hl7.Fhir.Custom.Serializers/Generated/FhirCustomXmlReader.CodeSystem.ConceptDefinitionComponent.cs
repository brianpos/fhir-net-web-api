...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		public void Parse(Hl7.Fhir.Model.CodeSystem.ConceptDefinitionComponent result, XmlReader reader, OperationOutcome outcome)
		{
		...
		public async System.Threading.Tasks.Task ParseAsync(Hl7.Fhir.Model.CodeSystem.ConceptDefinitionComponent result, XmlReader reader, OperationOutcome outcome)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "definition":
							result.DefinitionElement = new Hl7.Fhir.Model.FhirString();
							await ParseAsync(result.DefinitionElement as Hl7.Fhir.Model.FhirString, reader, outcome); // 60
							break;
						case "designation":
							var newItem_designation = new Hl7.Fhir.Model.CodeSystem.DesignationComponent();
							await ParseAsync(newItem_designation, reader, outcome); // 70
							result.Designation.Add(newItem_designation);
							break;
						case "property":
							var newItem_property = new Hl7.Fhir.Model.CodeSystem.ConceptPropertyComponent();
							await ParseAsync(newItem_property, reader, outcome); // 80
							result.Property.Add(newItem_property);
							break;
						case "concept":
							var newItem_concept = new Hl7.Fhir.Model.CodeSystem.ConceptDefinitionComponent();
							await ParseAsync(newItem_concept, reader, outcome); // 90
							result.Concept.Add(newItem_concept);
							break;
						default:
							// Property not found
