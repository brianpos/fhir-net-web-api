...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(CodeSystem result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "caseSensitive":
							...
							Parse(result.CaseSensitiveElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome, locationPath + ".caseSensitive"); // 240
							break;
						case "valueSet":
							result.ValueSetElement = new Hl7.Fhir.Model.Canonical();
							Parse(result.ValueSetElement as Hl7.Fhir.Model.Canonical, reader, outcome, locationPath + ".valueSet"); // 250
							break;
						case "hierarchyMeaning":
							...
							Parse(result.HierarchyMeaningElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.CodeSystem.CodeSystemHierarchyMeaning>, reader, outcome, locationPath + ".hierarchyMeaning"); // 260
							break;
						case "compositional":
							result.CompositionalElement = new Hl7.Fhir.Model.FhirBoolean();
							Parse(result.CompositionalElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome, locationPath + ".compositional"); // 270
							break;
						case "versionNeeded":
							result.VersionNeededElement = new Hl7.Fhir.Model.FhirBoolean();
							Parse(result.VersionNeededElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome, locationPath + ".versionNeeded"); // 280
							break;
						case "content":
							result.ContentElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.CodeSystem.CodeSystemContentMode>();
							Parse(result.ContentElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.CodeSystem.CodeSystemContentMode>, reader, outcome, locationPath + ".content"); // 290
							break;
						case "supplements":
							result.SupplementsElement = new Hl7.Fhir.Model.Canonical();
							Parse(result.SupplementsElement as Hl7.Fhir.Model.Canonical, reader, outcome, locationPath + ".supplements"); // 300
							break;
						case "count":
							result.CountElement = new Hl7.Fhir.Model.UnsignedInt();
							Parse(result.CountElement as Hl7.Fhir.Model.UnsignedInt, reader, outcome, locationPath + ".count"); // 310
							break;
						case "filter":
							var newItem_filter = new Hl7.Fhir.Model.CodeSystem.FilterComponent();
							Parse(newItem_filter, reader, outcome, locationPath + ".filter["+result.Filter.Count+"]"); // 320
							result.Filter.Add(newItem_filter);
							break;
						case "property":
							var newItem_property = new Hl7.Fhir.Model.CodeSystem.PropertyComponent();
							Parse(newItem_property, reader, outcome, locationPath + ".property["+result.Property.Count+"]"); // 330
							result.Property.Add(newItem_property);
							break;
						case "concept":
							var newItem_concept = new Hl7.Fhir.Model.CodeSystem.ConceptDefinitionComponent();
							Parse(newItem_concept, reader, outcome, locationPath + ".concept["+result.Concept.Count+"]"); // 340
		...
		private async System.Threading.Tasks.Task ParseAsync(CodeSystem result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "caseSensitive":
							result.CaseSensitiveElement = new Hl7.Fhir.Model.FhirBoolean();
							await ParseAsync(result.CaseSensitiveElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome, locationPath + ".caseSensitive"); // 240
							break;
						case "valueSet":
							result.ValueSetElement = new Hl7.Fhir.Model.Canonical();
							await ParseAsync(result.ValueSetElement as Hl7.Fhir.Model.Canonical, reader, outcome, locationPath + ".valueSet"); // 250
							break;
						case "hierarchyMeaning":
							result.HierarchyMeaningElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.CodeSystem.CodeSystemHierarchyMeaning>();
							await ParseAsync(result.HierarchyMeaningElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.CodeSystem.CodeSystemHierarchyMeaning>, reader, outcome, locationPath + ".hierarchyMeaning"); // 260
							break;
						case "compositional":
							result.CompositionalElement = new Hl7.Fhir.Model.FhirBoolean();
							await ParseAsync(result.CompositionalElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome, locationPath + ".compositional"); // 270
							break;
						case "versionNeeded":
							result.VersionNeededElement = new Hl7.Fhir.Model.FhirBoolean();
							await ParseAsync(result.VersionNeededElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome, locationPath + ".versionNeeded"); // 280
							break;
						case "content":
							result.ContentElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.CodeSystem.CodeSystemContentMode>();
							await ParseAsync(result.ContentElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.CodeSystem.CodeSystemContentMode>, reader, outcome, locationPath + ".content"); // 290
							break;
						case "supplements":
							result.SupplementsElement = new Hl7.Fhir.Model.Canonical();
							await ParseAsync(result.SupplementsElement as Hl7.Fhir.Model.Canonical, reader, outcome, locationPath + ".supplements"); // 300
							break;
						case "count":
							result.CountElement = new Hl7.Fhir.Model.UnsignedInt();
							await ParseAsync(result.CountElement as Hl7.Fhir.Model.UnsignedInt, reader, outcome, locationPath + ".count"); // 310
							break;
						case "filter":
							var newItem_filter = new Hl7.Fhir.Model.CodeSystem.FilterComponent();
							await ParseAsync(newItem_filter, reader, outcome, locationPath + ".filter["+result.Filter.Count+"]"); // 320
							result.Filter.Add(newItem_filter);
							break;
						case "property":
							var newItem_property = new Hl7.Fhir.Model.CodeSystem.PropertyComponent();
							await ParseAsync(newItem_property, reader, outcome, locationPath + ".property["+result.Property.Count+"]"); // 330
							result.Property.Add(newItem_property);
							break;
						case "concept":
							var newItem_concept = new Hl7.Fhir.Model.CodeSystem.ConceptDefinitionComponent();
							await ParseAsync(newItem_concept, reader, outcome, locationPath + ".concept["+result.Concept.Count+"]"); // 340
							result.Concept.Add(newItem_concept);
							break;
						default:
							// Property not found
