...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(Communication result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "inResponseTo":
							...
							Parse(newItem_inResponseTo, reader, outcome, locationPath + ".inResponseTo["+result.InResponseTo.Count+"]", cancellationToken); // 140
							result.InResponseTo.Add(newItem_inResponseTo);
							break;
						case "status":
							result.StatusElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.EventStatus>();
							Parse(result.StatusElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.EventStatus>, reader, outcome, locationPath + ".status", cancellationToken); // 150
							break;
						case "statusReason":
						...
						case "medium":
							...
							Parse(newItem_medium, reader, outcome, locationPath + ".medium["+result.Medium.Count+"]", cancellationToken); // 190
						...
						case "topic":
							...
							Parse(result.Topic as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".topic", cancellationToken); // 210
							break;
						case "about":
							var newItem_about = new Hl7.Fhir.Model.ResourceReference();
							Parse(newItem_about, reader, outcome, locationPath + ".about["+result.About.Count+"]", cancellationToken); // 220
							result.About.Add(newItem_about);
							break;
						case "encounter":
							result.Encounter = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Encounter as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".encounter", cancellationToken); // 230
							break;
						case "sent":
							result.SentElement = new Hl7.Fhir.Model.FhirDateTime();
							Parse(result.SentElement as Hl7.Fhir.Model.FhirDateTime, reader, outcome, locationPath + ".sent", cancellationToken); // 240
							break;
						case "received":
							result.ReceivedElement = new Hl7.Fhir.Model.FhirDateTime();
							Parse(result.ReceivedElement as Hl7.Fhir.Model.FhirDateTime, reader, outcome, locationPath + ".received", cancellationToken); // 250
							break;
						case "recipient":
						...
						case "payload":
							...
							Parse(newItem_payload, reader, outcome, locationPath + ".payload["+result.Payload.Count+"]", cancellationToken); // 300
		...
		private async System.Threading.Tasks.Task ParseAsync(Communication result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "inResponseTo":
							var newItem_inResponseTo = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_inResponseTo, reader, outcome, locationPath + ".inResponseTo["+result.InResponseTo.Count+"]", cancellationToken); // 140
							result.InResponseTo.Add(newItem_inResponseTo);
							break;
						case "status":
							result.StatusElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.EventStatus>();
							await ParseAsync(result.StatusElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.EventStatus>, reader, outcome, locationPath + ".status", cancellationToken); // 150
							break;
						case "statusReason":
							result.StatusReason = new Hl7.Fhir.Model.CodeableConcept();
						...
						case "medium":
							var newItem_medium = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_medium, reader, outcome, locationPath + ".medium["+result.Medium.Count+"]", cancellationToken); // 190
							result.Medium.Add(newItem_medium);
							break;
						case "subject":
							result.Subject = new Hl7.Fhir.Model.ResourceReference();
						...
						case "topic":
							result.Topic = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.Topic as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".topic", cancellationToken); // 210
							break;
						case "about":
							var newItem_about = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_about, reader, outcome, locationPath + ".about["+result.About.Count+"]", cancellationToken); // 220
							result.About.Add(newItem_about);
							break;
						case "encounter":
							result.Encounter = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Encounter as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".encounter", cancellationToken); // 230
							break;
						case "sent":
							result.SentElement = new Hl7.Fhir.Model.FhirDateTime();
							await ParseAsync(result.SentElement as Hl7.Fhir.Model.FhirDateTime, reader, outcome, locationPath + ".sent", cancellationToken); // 240
							break;
						case "received":
							result.ReceivedElement = new Hl7.Fhir.Model.FhirDateTime();
							await ParseAsync(result.ReceivedElement as Hl7.Fhir.Model.FhirDateTime, reader, outcome, locationPath + ".received", cancellationToken); // 250
							break;
						case "recipient":
							var newItem_recipient = new Hl7.Fhir.Model.ResourceReference();
						...
						case "payload":
							var newItem_payload = new Hl7.Fhir.Model.Communication.PayloadComponent();
							await ParseAsync(newItem_payload, reader, outcome, locationPath + ".payload["+result.Payload.Count+"]", cancellationToken); // 300
							result.Payload.Add(newItem_payload);
							break;
						case "note":
							var newItem_note = new Hl7.Fhir.Model.Annotation();
