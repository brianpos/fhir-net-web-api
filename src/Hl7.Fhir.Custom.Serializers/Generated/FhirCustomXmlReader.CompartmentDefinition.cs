...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(CompartmentDefinition result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "status":
							...
							Parse(result.StatusElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.PublicationStatus>, reader, outcome, locationPath + ".status"); // 120
							break;
						case "experimental":
							result.ExperimentalElement = new Hl7.Fhir.Model.FhirBoolean();
							Parse(result.ExperimentalElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome, locationPath + ".experimental"); // 130
							break;
						case "date":
							result.DateElement = new Hl7.Fhir.Model.FhirDateTime();
							Parse(result.DateElement as Hl7.Fhir.Model.FhirDateTime, reader, outcome, locationPath + ".date"); // 140
							break;
						case "publisher":
							result.PublisherElement = new Hl7.Fhir.Model.FhirString();
							Parse(result.PublisherElement as Hl7.Fhir.Model.FhirString, reader, outcome, locationPath + ".publisher"); // 150
							break;
						case "contact":
							var newItem_contact = new Hl7.Fhir.Model.ContactDetail();
							Parse(newItem_contact, reader, outcome, locationPath + ".contact["+result.Contact.Count+"]"); // 160
						...
						case "purpose":
							...
							Parse(result.Purpose as Hl7.Fhir.Model.Markdown, reader, outcome, locationPath + ".purpose"); // 190
							break;
						case "code":
							result.CodeElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.CompartmentType>();
							Parse(result.CodeElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.CompartmentType>, reader, outcome, locationPath + ".code"); // 200
							break;
						case "search":
							result.SearchElement = new Hl7.Fhir.Model.FhirBoolean();
							Parse(result.SearchElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome, locationPath + ".search"); // 210
							break;
						case "resource":
							var newItem_resource = new Hl7.Fhir.Model.CompartmentDefinition.ResourceComponent();
							Parse(newItem_resource, reader, outcome, locationPath + ".resource["+result.Resource.Count+"]"); // 220
		...
		private async System.Threading.Tasks.Task ParseAsync(CompartmentDefinition result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "status":
							result.StatusElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.PublicationStatus>();
							await ParseAsync(result.StatusElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.PublicationStatus>, reader, outcome, locationPath + ".status"); // 120
							break;
						case "experimental":
							result.ExperimentalElement = new Hl7.Fhir.Model.FhirBoolean();
							await ParseAsync(result.ExperimentalElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome, locationPath + ".experimental"); // 130
							break;
						case "date":
							result.DateElement = new Hl7.Fhir.Model.FhirDateTime();
							await ParseAsync(result.DateElement as Hl7.Fhir.Model.FhirDateTime, reader, outcome, locationPath + ".date"); // 140
							break;
						case "publisher":
							result.PublisherElement = new Hl7.Fhir.Model.FhirString();
							await ParseAsync(result.PublisherElement as Hl7.Fhir.Model.FhirString, reader, outcome, locationPath + ".publisher"); // 150
							break;
						case "contact":
							var newItem_contact = new Hl7.Fhir.Model.ContactDetail();
							await ParseAsync(newItem_contact, reader, outcome, locationPath + ".contact["+result.Contact.Count+"]"); // 160
							result.Contact.Add(newItem_contact);
							break;
						case "description":
							result.Description = new Hl7.Fhir.Model.Markdown();
						...
						case "purpose":
							result.Purpose = new Hl7.Fhir.Model.Markdown();
							await ParseAsync(result.Purpose as Hl7.Fhir.Model.Markdown, reader, outcome, locationPath + ".purpose"); // 190
							break;
						case "code":
							result.CodeElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.CompartmentType>();
							await ParseAsync(result.CodeElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.CompartmentType>, reader, outcome, locationPath + ".code"); // 200
							break;
						case "search":
							result.SearchElement = new Hl7.Fhir.Model.FhirBoolean();
							await ParseAsync(result.SearchElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome, locationPath + ".search"); // 210
							break;
						case "resource":
							var newItem_resource = new Hl7.Fhir.Model.CompartmentDefinition.ResourceComponent();
							await ParseAsync(newItem_resource, reader, outcome, locationPath + ".resource["+result.Resource.Count+"]"); // 220
							result.Resource.Add(newItem_resource);
							break;
						default:
							// Property not found
