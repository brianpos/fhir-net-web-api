...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(Composition result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "status":
							...
							Parse(result.StatusElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.CompositionStatus>, reader, outcome, locationPath + ".status"); // 100
							break;
						case "type":
						...
						case "author":
							...
							Parse(newItem_author, reader, outcome, locationPath + ".author["+result.Author.Count+"]"); // 160
							result.Author.Add(newItem_author);
							break;
						case "title":
							result.TitleElement = new Hl7.Fhir.Model.FhirString();
							Parse(result.TitleElement as Hl7.Fhir.Model.FhirString, reader, outcome, locationPath + ".title"); // 170
							break;
						case "confidentiality":
							result.ConfidentialityElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.Composition.v3_ConfidentialityClassification>();
							Parse(result.ConfidentialityElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.Composition.v3_ConfidentialityClassification>, reader, outcome, locationPath + ".confidentiality"); // 180
							break;
						case "attester":
							var newItem_attester = new Hl7.Fhir.Model.Composition.AttesterComponent();
							Parse(newItem_attester, reader, outcome, locationPath + ".attester["+result.Attester.Count+"]"); // 190
							result.Attester.Add(newItem_attester);
							break;
						case "custodian":
							result.Custodian = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Custodian as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".custodian"); // 200
							break;
						case "relatesTo":
							var newItem_relatesTo = new Hl7.Fhir.Model.Composition.RelatesToComponent();
							Parse(newItem_relatesTo, reader, outcome, locationPath + ".relatesTo["+result.RelatesTo.Count+"]"); // 210
							result.RelatesTo.Add(newItem_relatesTo);
							break;
						case "event":
							var newItem_event = new Hl7.Fhir.Model.Composition.EventComponent();
							Parse(newItem_event, reader, outcome, locationPath + ".event["+result.Event.Count+"]"); // 220
							result.Event.Add(newItem_event);
							break;
						case "section":
							var newItem_section = new Hl7.Fhir.Model.Composition.SectionComponent();
							Parse(newItem_section, reader, outcome, locationPath + ".section["+result.Section.Count+"]"); // 230
		...
		private async System.Threading.Tasks.Task ParseAsync(Composition result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "status":
							result.StatusElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.CompositionStatus>();
							await ParseAsync(result.StatusElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.CompositionStatus>, reader, outcome, locationPath + ".status"); // 100
							break;
						case "type":
							result.Type = new Hl7.Fhir.Model.CodeableConcept();
						...
						case "author":
							var newItem_author = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_author, reader, outcome, locationPath + ".author["+result.Author.Count+"]"); // 160
							result.Author.Add(newItem_author);
							break;
						case "title":
							result.TitleElement = new Hl7.Fhir.Model.FhirString();
							await ParseAsync(result.TitleElement as Hl7.Fhir.Model.FhirString, reader, outcome, locationPath + ".title"); // 170
							break;
						case "confidentiality":
							result.ConfidentialityElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.Composition.v3_ConfidentialityClassification>();
							await ParseAsync(result.ConfidentialityElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.Composition.v3_ConfidentialityClassification>, reader, outcome, locationPath + ".confidentiality"); // 180
							break;
						case "attester":
							var newItem_attester = new Hl7.Fhir.Model.Composition.AttesterComponent();
							await ParseAsync(newItem_attester, reader, outcome, locationPath + ".attester["+result.Attester.Count+"]"); // 190
							result.Attester.Add(newItem_attester);
							break;
						case "custodian":
							result.Custodian = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Custodian as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".custodian"); // 200
							break;
						case "relatesTo":
							var newItem_relatesTo = new Hl7.Fhir.Model.Composition.RelatesToComponent();
							await ParseAsync(newItem_relatesTo, reader, outcome, locationPath + ".relatesTo["+result.RelatesTo.Count+"]"); // 210
							result.RelatesTo.Add(newItem_relatesTo);
							break;
						case "event":
							var newItem_event = new Hl7.Fhir.Model.Composition.EventComponent();
							await ParseAsync(newItem_event, reader, outcome, locationPath + ".event["+result.Event.Count+"]"); // 220
							result.Event.Add(newItem_event);
							break;
						case "section":
							var newItem_section = new Hl7.Fhir.Model.Composition.SectionComponent();
							await ParseAsync(newItem_section, reader, outcome, locationPath + ".section["+result.Section.Count+"]"); // 230
							result.Section.Add(newItem_section);
							break;
						default:
							// Property not found
