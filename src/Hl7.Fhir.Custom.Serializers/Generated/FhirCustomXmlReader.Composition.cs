...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(Composition result, XmlReader reader, OperationOutcome outcome)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "status":
							...
							Parse(result.StatusElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.CompositionStatus>, reader, outcome); // 100
							break;
						case "type":
		...
		private async System.Threading.Tasks.Task ParseAsync(Composition result, XmlReader reader, OperationOutcome outcome)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "status":
							result.StatusElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.CompositionStatus>();
							await ParseAsync(result.StatusElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.CompositionStatus>, reader, outcome); // 100
							break;
						case "type":
							result.Type = new Hl7.Fhir.Model.CodeableConcept();
						...
						case "author":
							var newItem_author = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_author, reader, outcome); // 160
							result.Author.Add(newItem_author);
							break;
						case "title":
							result.TitleElement = new Hl7.Fhir.Model.FhirString();
							await ParseAsync(result.TitleElement as Hl7.Fhir.Model.FhirString, reader, outcome); // 170
							break;
						case "confidentiality":
							result.ConfidentialityElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.Composition.v3_ConfidentialityClassification>();
							await ParseAsync(result.ConfidentialityElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.Composition.v3_ConfidentialityClassification>, reader, outcome); // 180
							break;
						case "attester":
							var newItem_attester = new Hl7.Fhir.Model.Composition.AttesterComponent();
							await ParseAsync(newItem_attester, reader, outcome); // 190
							result.Attester.Add(newItem_attester);
							break;
						case "custodian":
							result.Custodian = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Custodian as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 200
							break;
						case "relatesTo":
							var newItem_relatesTo = new Hl7.Fhir.Model.Composition.RelatesToComponent();
							await ParseAsync(newItem_relatesTo, reader, outcome); // 210
							result.RelatesTo.Add(newItem_relatesTo);
							break;
						case "event":
							var newItem_event = new Hl7.Fhir.Model.Composition.EventComponent();
							await ParseAsync(newItem_event, reader, outcome); // 220
							result.Event.Add(newItem_event);
							break;
						case "section":
							var newItem_section = new Hl7.Fhir.Model.Composition.SectionComponent();
							await ParseAsync(newItem_section, reader, outcome); // 230
							result.Section.Add(newItem_section);
							break;
						default:
							// Property not found
