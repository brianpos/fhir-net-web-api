...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(ConceptMap result, XmlReader reader, OperationOutcome outcome)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "sourceUri":
							...
							Parse(result.Source as Hl7.Fhir.Model.FhirUri, reader, outcome); // 240
							break;
						case "sourceCanonical":
							result.Source = new Hl7.Fhir.Model.Canonical();
							Parse(result.Source as Hl7.Fhir.Model.Canonical, reader, outcome); // 240
							break;
						case "targetUri":
							result.Target = new Hl7.Fhir.Model.FhirUri();
							Parse(result.Target as Hl7.Fhir.Model.FhirUri, reader, outcome); // 250
							break;
						case "targetCanonical":
							result.Target = new Hl7.Fhir.Model.Canonical();
							Parse(result.Target as Hl7.Fhir.Model.Canonical, reader, outcome); // 250
							break;
						case "group":
							var newItem_group = new Hl7.Fhir.Model.ConceptMap.GroupComponent();
							Parse(newItem_group, reader, outcome); // 260
		...
		private async System.Threading.Tasks.Task ParseAsync(ConceptMap result, XmlReader reader, OperationOutcome outcome)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "sourceUri":
							result.Source = new Hl7.Fhir.Model.FhirUri();
							await ParseAsync(result.Source as Hl7.Fhir.Model.FhirUri, reader, outcome); // 240
							break;
						case "sourceCanonical":
							result.Source = new Hl7.Fhir.Model.Canonical();
							await ParseAsync(result.Source as Hl7.Fhir.Model.Canonical, reader, outcome); // 240
							break;
						case "targetUri":
							result.Target = new Hl7.Fhir.Model.FhirUri();
							await ParseAsync(result.Target as Hl7.Fhir.Model.FhirUri, reader, outcome); // 250
							break;
						case "targetCanonical":
							result.Target = new Hl7.Fhir.Model.Canonical();
							await ParseAsync(result.Target as Hl7.Fhir.Model.Canonical, reader, outcome); // 250
							break;
						case "group":
							var newItem_group = new Hl7.Fhir.Model.ConceptMap.GroupComponent();
							await ParseAsync(newItem_group, reader, outcome); // 260
							result.Group.Add(newItem_group);
							break;
						default:
							// Property not found
