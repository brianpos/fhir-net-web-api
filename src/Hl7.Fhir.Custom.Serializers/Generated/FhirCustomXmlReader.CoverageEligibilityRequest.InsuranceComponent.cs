...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		public void Parse(Hl7.Fhir.Model.CoverageEligibilityRequest.InsuranceComponent result, XmlReader reader, OperationOutcome outcome)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "businessArrangement":
							...
							Parse(result.BusinessArrangementElement as Hl7.Fhir.Model.FhirString, reader, outcome); // 60
							break;
						default:
							// Property not found
		...
		public async System.Threading.Tasks.Task ParseAsync(Hl7.Fhir.Model.CoverageEligibilityRequest.InsuranceComponent result, XmlReader reader, OperationOutcome outcome)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "businessArrangement":
							result.BusinessArrangementElement = new Hl7.Fhir.Model.FhirString();
							await ParseAsync(result.BusinessArrangementElement as Hl7.Fhir.Model.FhirString, reader, outcome); // 60
							break;
						default:
							// Property not found
