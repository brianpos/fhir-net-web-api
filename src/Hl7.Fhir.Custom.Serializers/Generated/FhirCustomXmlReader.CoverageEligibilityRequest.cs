...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(CoverageEligibilityRequest result, XmlReader reader, OperationOutcome outcome)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "priority":
							...
							Parse(result.Priority as Hl7.Fhir.Model.CodeableConcept, reader, outcome); // 110
							break;
						case "purpose":
							var newItem_purpose = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.CoverageEligibilityRequest.EligibilityRequestPurpose>();
							Parse(newItem_purpose, reader, outcome); // 120
						...
						case "enterer":
							...
							Parse(result.Enterer as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 160
							break;
						case "provider":
							result.Provider = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Provider as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 170
							break;
						case "insurer":
						...
						case "facility":
							...
							Parse(result.Facility as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 190
							break;
						case "supportingInfo":
							var newItem_supportingInfo = new Hl7.Fhir.Model.CoverageEligibilityRequest.SupportingInformationComponent();
							Parse(newItem_supportingInfo, reader, outcome); // 200
		...
		private async System.Threading.Tasks.Task ParseAsync(CoverageEligibilityRequest result, XmlReader reader, OperationOutcome outcome)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "priority":
							result.Priority = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.Priority as Hl7.Fhir.Model.CodeableConcept, reader, outcome); // 110
							break;
						case "purpose":
							var newItem_purpose = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.CoverageEligibilityRequest.EligibilityRequestPurpose>();
							await ParseAsync(newItem_purpose, reader, outcome); // 120
							result.PurposeElement.Add(newItem_purpose);
							break;
						case "patient":
							result.Patient = new Hl7.Fhir.Model.ResourceReference();
						...
						case "enterer":
							result.Enterer = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Enterer as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 160
							break;
						case "provider":
							result.Provider = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Provider as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 170
							break;
						case "insurer":
							result.Insurer = new Hl7.Fhir.Model.ResourceReference();
						...
						case "facility":
							result.Facility = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Facility as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 190
							break;
						case "supportingInfo":
							var newItem_supportingInfo = new Hl7.Fhir.Model.CoverageEligibilityRequest.SupportingInformationComponent();
							await ParseAsync(newItem_supportingInfo, reader, outcome); // 200
							result.SupportingInfo.Add(newItem_supportingInfo);
							break;
						case "insurance":
							var newItem_insurance = new Hl7.Fhir.Model.CoverageEligibilityRequest.InsuranceComponent();
							await ParseAsync(newItem_insurance, reader, outcome); // 210
							result.Insurance.Add(newItem_insurance);
							break;
						case "item":
							var newItem_item = new Hl7.Fhir.Model.CoverageEligibilityRequest.DetailsComponent();
							await ParseAsync(newItem_item, reader, outcome); // 220
							result.Item.Add(newItem_item);
							break;
						default:
							// Property not found
