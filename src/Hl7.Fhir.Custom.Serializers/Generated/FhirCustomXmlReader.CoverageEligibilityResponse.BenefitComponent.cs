...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		public void Parse(Hl7.Fhir.Model.CoverageEligibilityResponse.BenefitComponent result, XmlReader reader, OperationOutcome outcome)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "usedString":
							...
							Parse(result.Used as Hl7.Fhir.Model.FhirString, reader, outcome); // 60
							break;
						case "usedMoney":
		...
		public async System.Threading.Tasks.Task ParseAsync(Hl7.Fhir.Model.CoverageEligibilityResponse.BenefitComponent result, XmlReader reader, OperationOutcome outcome)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "usedString":
							result.Used = new Hl7.Fhir.Model.FhirString();
							await ParseAsync(result.Used as Hl7.Fhir.Model.FhirString, reader, outcome); // 60
							break;
						case "usedMoney":
							result.Used = new Hl7.Fhir.Model.Money();
