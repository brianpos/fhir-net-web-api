...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		public void Parse(Hl7.Fhir.Model.Device.VersionComponent result, XmlReader reader, OperationOutcome outcome)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "component":
							...
							Parse(result.Component as Hl7.Fhir.Model.Identifier, reader, outcome); // 50
							break;
						case "value":
		...
		public async System.Threading.Tasks.Task ParseAsync(Hl7.Fhir.Model.Device.VersionComponent result, XmlReader reader, OperationOutcome outcome)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "component":
							result.Component = new Hl7.Fhir.Model.Identifier();
							await ParseAsync(result.Component as Hl7.Fhir.Model.Identifier, reader, outcome); // 50
							break;
						case "value":
							result.ValueElement = new Hl7.Fhir.Model.FhirString();
