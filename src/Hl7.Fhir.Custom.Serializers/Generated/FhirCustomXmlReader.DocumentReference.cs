...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(DocumentReference result, XmlReader reader, OperationOutcome outcome)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "docStatus":
							...
							Parse(result.DocStatusElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.CompositionStatus>, reader, outcome); // 120
							break;
						case "type":
						...
						case "category":
							...
							Parse(newItem_category, reader, outcome); // 140
						...
						case "date":
							...
							Parse(result.DateElement as Hl7.Fhir.Model.Instant, reader, outcome); // 160
							break;
						case "author":
							var newItem_author = new Hl7.Fhir.Model.ResourceReference();
							Parse(newItem_author, reader, outcome); // 170
							result.Author.Add(newItem_author);
							break;
						case "authenticator":
							result.Authenticator = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Authenticator as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 180
							break;
						case "custodian":
							result.Custodian = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Custodian as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 190
							break;
						case "relatesTo":
							var newItem_relatesTo = new Hl7.Fhir.Model.DocumentReference.RelatesToComponent();
							Parse(newItem_relatesTo, reader, outcome); // 200
		...
		private async System.Threading.Tasks.Task ParseAsync(DocumentReference result, XmlReader reader, OperationOutcome outcome)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "docStatus":
							result.DocStatusElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.CompositionStatus>();
							await ParseAsync(result.DocStatusElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.CompositionStatus>, reader, outcome); // 120
							break;
						case "type":
							result.Type = new Hl7.Fhir.Model.CodeableConcept();
						...
						case "category":
							var newItem_category = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_category, reader, outcome); // 140
							result.Category.Add(newItem_category);
							break;
						case "subject":
							result.Subject = new Hl7.Fhir.Model.ResourceReference();
						...
						case "date":
							result.DateElement = new Hl7.Fhir.Model.Instant();
							await ParseAsync(result.DateElement as Hl7.Fhir.Model.Instant, reader, outcome); // 160
							break;
						case "author":
							var newItem_author = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_author, reader, outcome); // 170
							result.Author.Add(newItem_author);
							break;
						case "authenticator":
							result.Authenticator = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Authenticator as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 180
							break;
						case "custodian":
							result.Custodian = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Custodian as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 190
							break;
						case "relatesTo":
							var newItem_relatesTo = new Hl7.Fhir.Model.DocumentReference.RelatesToComponent();
							await ParseAsync(newItem_relatesTo, reader, outcome); // 200
							result.RelatesTo.Add(newItem_relatesTo);
							break;
						case "description":
							result.DescriptionElement = new Hl7.Fhir.Model.FhirString();
						...
						case "securityLabel":
							var newItem_securityLabel = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_securityLabel, reader, outcome); // 220
							result.SecurityLabel.Add(newItem_securityLabel);
							break;
						case "content":
							var newItem_content = new Hl7.Fhir.Model.DocumentReference.ContentComponent();
							await ParseAsync(newItem_content, reader, outcome); // 230
							result.Content.Add(newItem_content);
							break;
						case "context":
							result.Context = new Hl7.Fhir.Model.DocumentReference.ContextComponent();
							await ParseAsync(result.Context as Hl7.Fhir.Model.DocumentReference.ContextComponent, reader, outcome); // 240
							break;
						default:
							// Property not found
