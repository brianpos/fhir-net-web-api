...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(EffectEvidenceSynthesis result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "exposureAlternative":
							...
							Parse(result.ExposureAlternative as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".exposureAlternative"); // 360
							break;
						case "outcome":
							result.Outcome = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Outcome as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".outcome"); // 370
							break;
						case "sampleSize":
							result.SampleSize = new Hl7.Fhir.Model.EffectEvidenceSynthesis.SampleSizeComponent();
							Parse(result.SampleSize as Hl7.Fhir.Model.EffectEvidenceSynthesis.SampleSizeComponent, reader, outcome, locationPath + ".sampleSize"); // 380
							break;
						case "resultsByExposure":
							...
							Parse(newItem_resultsByExposure, reader, outcome, locationPath + ".resultsByExposure["+result.ResultsByExposure.Count+"]"); // 390
						...
						case "effectEstimate":
							...
							Parse(newItem_effectEstimate, reader, outcome, locationPath + ".effectEstimate["+result.EffectEstimate.Count+"]"); // 400
						...
						case "certainty":
							...
							Parse(newItem_certainty, reader, outcome, locationPath + ".certainty["+result.Certainty.Count+"]"); // 410
		...
		private async System.Threading.Tasks.Task ParseAsync(EffectEvidenceSynthesis result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "exposureAlternative":
							result.ExposureAlternative = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.ExposureAlternative as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".exposureAlternative"); // 360
							break;
						case "outcome":
							result.Outcome = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Outcome as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".outcome"); // 370
							break;
						case "sampleSize":
							result.SampleSize = new Hl7.Fhir.Model.EffectEvidenceSynthesis.SampleSizeComponent();
							await ParseAsync(result.SampleSize as Hl7.Fhir.Model.EffectEvidenceSynthesis.SampleSizeComponent, reader, outcome, locationPath + ".sampleSize"); // 380
							break;
						case "resultsByExposure":
							var newItem_resultsByExposure = new Hl7.Fhir.Model.EffectEvidenceSynthesis.ResultsByExposureComponent();
							await ParseAsync(newItem_resultsByExposure, reader, outcome, locationPath + ".resultsByExposure["+result.ResultsByExposure.Count+"]"); // 390
							result.ResultsByExposure.Add(newItem_resultsByExposure);
							break;
						case "effectEstimate":
							var newItem_effectEstimate = new Hl7.Fhir.Model.EffectEvidenceSynthesis.EffectEstimateComponent();
							await ParseAsync(newItem_effectEstimate, reader, outcome, locationPath + ".effectEstimate["+result.EffectEstimate.Count+"]"); // 400
							result.EffectEstimate.Add(newItem_effectEstimate);
							break;
						case "certainty":
							var newItem_certainty = new Hl7.Fhir.Model.EffectEvidenceSynthesis.CertaintyComponent();
							await ParseAsync(newItem_certainty, reader, outcome, locationPath + ".certainty["+result.Certainty.Count+"]"); // 410
							result.Certainty.Add(newItem_certainty);
							break;
						default:
							// Property not found
