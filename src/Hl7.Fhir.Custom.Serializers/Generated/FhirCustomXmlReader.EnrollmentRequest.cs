...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(EnrollmentRequest result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "insurer":
							...
							Parse(result.Insurer as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".insurer"); // 120
							break;
						case "provider":
							result.Provider = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Provider as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".provider"); // 130
							break;
						case "candidate":
							result.Candidate = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Candidate as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".candidate"); // 140
							break;
						case "coverage":
							result.Coverage = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Coverage as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".coverage"); // 150
							break;
						default:
							// Property not found
		...
		private async System.Threading.Tasks.Task ParseAsync(EnrollmentRequest result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "insurer":
							result.Insurer = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Insurer as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".insurer"); // 120
							break;
						case "provider":
							result.Provider = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Provider as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".provider"); // 130
							break;
						case "candidate":
							result.Candidate = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Candidate as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".candidate"); // 140
							break;
						case "coverage":
							result.Coverage = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Coverage as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".coverage"); // 150
							break;
						default:
							// Property not found
