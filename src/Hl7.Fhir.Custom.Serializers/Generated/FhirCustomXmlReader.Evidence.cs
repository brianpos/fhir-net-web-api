...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(Evidence result, XmlReader reader, OperationOutcome outcome)
		{
		...
		private async System.Threading.Tasks.Task ParseAsync(Evidence result, XmlReader reader, OperationOutcome outcome)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "approvalDate":
							result.ApprovalDateElement = new Hl7.Fhir.Model.Date();
							await ParseAsync(result.ApprovalDateElement as Hl7.Fhir.Model.Date, reader, outcome); // 250
							break;
						case "lastReviewDate":
							result.LastReviewDateElement = new Hl7.Fhir.Model.Date();
							await ParseAsync(result.LastReviewDateElement as Hl7.Fhir.Model.Date, reader, outcome); // 260
							break;
						case "effectivePeriod":
							result.EffectivePeriod = new Hl7.Fhir.Model.Period();
							await ParseAsync(result.EffectivePeriod as Hl7.Fhir.Model.Period, reader, outcome); // 270
							break;
						case "topic":
							var newItem_topic = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_topic, reader, outcome); // 280
							result.Topic.Add(newItem_topic);
							break;
						case "author":
							var newItem_author = new Hl7.Fhir.Model.ContactDetail();
							await ParseAsync(newItem_author, reader, outcome); // 290
							result.Author.Add(newItem_author);
							break;
						case "editor":
							var newItem_editor = new Hl7.Fhir.Model.ContactDetail();
							await ParseAsync(newItem_editor, reader, outcome); // 300
							result.Editor.Add(newItem_editor);
							break;
						case "reviewer":
							var newItem_reviewer = new Hl7.Fhir.Model.ContactDetail();
							await ParseAsync(newItem_reviewer, reader, outcome); // 310
							result.Reviewer.Add(newItem_reviewer);
							break;
						case "endorser":
							var newItem_endorser = new Hl7.Fhir.Model.ContactDetail();
							await ParseAsync(newItem_endorser, reader, outcome); // 320
							result.Endorser.Add(newItem_endorser);
							break;
						case "relatedArtifact":
							var newItem_relatedArtifact = new Hl7.Fhir.Model.RelatedArtifact();
							await ParseAsync(newItem_relatedArtifact, reader, outcome); // 330
							result.RelatedArtifact.Add(newItem_relatedArtifact);
							break;
						case "exposureBackground":
							result.ExposureBackground = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.ExposureBackground as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 340
							break;
						case "exposureVariant":
							var newItem_exposureVariant = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_exposureVariant, reader, outcome); // 350
							result.ExposureVariant.Add(newItem_exposureVariant);
							break;
						case "outcome":
							var newItem_outcome = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_outcome, reader, outcome); // 360
							result.Outcome.Add(newItem_outcome);
							break;
						default:
							// Property not found
