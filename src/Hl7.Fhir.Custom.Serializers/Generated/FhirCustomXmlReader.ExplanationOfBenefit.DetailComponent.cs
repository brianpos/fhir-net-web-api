...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		public void Parse(Hl7.Fhir.Model.ExplanationOfBenefit.DetailComponent result, XmlReader reader, OperationOutcome outcome)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "noteNumber":
							...
							Parse(newItem_noteNumber, reader, outcome); // 150
						...
						case "adjudication":
							...
							Parse(newItem_adjudication, reader, outcome); // 160
						...
						case "subDetail":
							...
							Parse(newItem_subDetail, reader, outcome); // 170
		...
		public async System.Threading.Tasks.Task ParseAsync(Hl7.Fhir.Model.ExplanationOfBenefit.DetailComponent result, XmlReader reader, OperationOutcome outcome)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "noteNumber":
							var newItem_noteNumber = new Hl7.Fhir.Model.PositiveInt();
							await ParseAsync(newItem_noteNumber, reader, outcome); // 150
							result.NoteNumberElement.Add(newItem_noteNumber);
							break;
						case "adjudication":
							var newItem_adjudication = new Hl7.Fhir.Model.ExplanationOfBenefit.AdjudicationComponent();
							await ParseAsync(newItem_adjudication, reader, outcome); // 160
							result.Adjudication.Add(newItem_adjudication);
							break;
						case "subDetail":
							var newItem_subDetail = new Hl7.Fhir.Model.ExplanationOfBenefit.SubDetailComponent();
							await ParseAsync(newItem_subDetail, reader, outcome); // 170
							result.SubDetail.Add(newItem_subDetail);
							break;
						default:
							// Property not found
