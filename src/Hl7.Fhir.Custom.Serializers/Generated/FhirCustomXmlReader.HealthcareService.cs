...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(HealthcareService result, XmlReader reader, OperationOutcome outcome)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "providedBy":
							...
							Parse(result.ProvidedBy as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 110
							break;
						case "category":
						...
						case "type":
							...
							Parse(newItem_type, reader, outcome); // 130
						...
						case "location":
							...
							Parse(newItem_location, reader, outcome); // 150
						...
						case "comment":
							...
							Parse(result.CommentElement as Hl7.Fhir.Model.FhirString, reader, outcome); // 170
							break;
						case "extraDetails":
							result.ExtraDetails = new Hl7.Fhir.Model.Markdown();
							Parse(result.ExtraDetails as Hl7.Fhir.Model.Markdown, reader, outcome); // 180
							break;
						case "photo":
							result.Photo = new Hl7.Fhir.Model.Attachment();
							Parse(result.Photo as Hl7.Fhir.Model.Attachment, reader, outcome); // 190
							break;
						case "telecom":
							var newItem_telecom = new Hl7.Fhir.Model.ContactPoint();
							Parse(newItem_telecom, reader, outcome); // 200
							result.Telecom.Add(newItem_telecom);
							break;
						case "coverageArea":
							var newItem_coverageArea = new Hl7.Fhir.Model.ResourceReference();
							Parse(newItem_coverageArea, reader, outcome); // 210
						...
						case "serviceProvisionCode":
							...
							Parse(newItem_serviceProvisionCode, reader, outcome); // 220
						...
						case "appointmentRequired":
							...
							Parse(result.AppointmentRequiredElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome); // 280
							break;
						case "availableTime":
							var newItem_availableTime = new Hl7.Fhir.Model.HealthcareService.AvailableTimeComponent();
							Parse(newItem_availableTime, reader, outcome); // 290
						...
						case "notAvailable":
							...
							Parse(newItem_notAvailable, reader, outcome); // 300
							result.NotAvailable.Add(newItem_notAvailable);
							break;
						case "availabilityExceptions":
							result.AvailabilityExceptionsElement = new Hl7.Fhir.Model.FhirString();
							Parse(result.AvailabilityExceptionsElement as Hl7.Fhir.Model.FhirString, reader, outcome); // 310
							break;
						case "endpoint":
							var newItem_endpoint = new Hl7.Fhir.Model.ResourceReference();
							Parse(newItem_endpoint, reader, outcome); // 320
		...
		private async System.Threading.Tasks.Task ParseAsync(HealthcareService result, XmlReader reader, OperationOutcome outcome)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "providedBy":
							result.ProvidedBy = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.ProvidedBy as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 110
							break;
						case "category":
							var newItem_category = new Hl7.Fhir.Model.CodeableConcept();
						...
						case "type":
							var newItem_type = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_type, reader, outcome); // 130
							result.Type.Add(newItem_type);
							break;
						case "specialty":
							var newItem_specialty = new Hl7.Fhir.Model.CodeableConcept();
						...
						case "location":
							var newItem_location = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_location, reader, outcome); // 150
							result.Location.Add(newItem_location);
							break;
						case "name":
							result.NameElement = new Hl7.Fhir.Model.FhirString();
						...
						case "comment":
							result.CommentElement = new Hl7.Fhir.Model.FhirString();
							await ParseAsync(result.CommentElement as Hl7.Fhir.Model.FhirString, reader, outcome); // 170
							break;
						case "extraDetails":
							result.ExtraDetails = new Hl7.Fhir.Model.Markdown();
							await ParseAsync(result.ExtraDetails as Hl7.Fhir.Model.Markdown, reader, outcome); // 180
							break;
						case "photo":
							result.Photo = new Hl7.Fhir.Model.Attachment();
							await ParseAsync(result.Photo as Hl7.Fhir.Model.Attachment, reader, outcome); // 190
							break;
						case "telecom":
							var newItem_telecom = new Hl7.Fhir.Model.ContactPoint();
							await ParseAsync(newItem_telecom, reader, outcome); // 200
							result.Telecom.Add(newItem_telecom);
							break;
						case "coverageArea":
							var newItem_coverageArea = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_coverageArea, reader, outcome); // 210
							result.CoverageArea.Add(newItem_coverageArea);
							break;
						case "serviceProvisionCode":
							var newItem_serviceProvisionCode = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_serviceProvisionCode, reader, outcome); // 220
							result.ServiceProvisionCode.Add(newItem_serviceProvisionCode);
							break;
						case "eligibility":
							var newItem_eligibility = new Hl7.Fhir.Model.HealthcareService.EligibilityComponent();
							await ParseAsync(newItem_eligibility, reader, outcome); // 230
							result.Eligibility.Add(newItem_eligibility);
							break;
						case "program":
							var newItem_program = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_program, reader, outcome); // 240
							result.Program.Add(newItem_program);
							break;
						case "characteristic":
							var newItem_characteristic = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_characteristic, reader, outcome); // 250
							result.Characteristic.Add(newItem_characteristic);
							break;
						case "communication":
							var newItem_communication = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_communication, reader, outcome); // 260
							result.Communication.Add(newItem_communication);
							break;
						case "referralMethod":
							var newItem_referralMethod = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_referralMethod, reader, outcome); // 270
							result.ReferralMethod.Add(newItem_referralMethod);
							break;
						case "appointmentRequired":
							result.AppointmentRequiredElement = new Hl7.Fhir.Model.FhirBoolean();
							await ParseAsync(result.AppointmentRequiredElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome); // 280
							break;
						case "availableTime":
							var newItem_availableTime = new Hl7.Fhir.Model.HealthcareService.AvailableTimeComponent();
							await ParseAsync(newItem_availableTime, reader, outcome); // 290
							result.AvailableTime.Add(newItem_availableTime);
							break;
						case "notAvailable":
							var newItem_notAvailable = new Hl7.Fhir.Model.HealthcareService.NotAvailableComponent();
							await ParseAsync(newItem_notAvailable, reader, outcome); // 300
							result.NotAvailable.Add(newItem_notAvailable);
							break;
						case "availabilityExceptions":
							result.AvailabilityExceptionsElement = new Hl7.Fhir.Model.FhirString();
							await ParseAsync(result.AvailabilityExceptionsElement as Hl7.Fhir.Model.FhirString, reader, outcome); // 310
							break;
						case "endpoint":
							var newItem_endpoint = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_endpoint, reader, outcome); // 320
							result.Endpoint.Add(newItem_endpoint);
							break;
						default:
							// Property not found
