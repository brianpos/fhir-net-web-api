...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(ImmunizationRecommendation result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "patient":
							...
							Parse(result.Patient as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".patient"); // 100
							break;
						case "date":
							result.DateElement = new Hl7.Fhir.Model.FhirDateTime();
							Parse(result.DateElement as Hl7.Fhir.Model.FhirDateTime, reader, outcome, locationPath + ".date"); // 110
							break;
						case "authority":
							result.Authority = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Authority as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".authority"); // 120
							break;
						case "recommendation":
							var newItem_recommendation = new Hl7.Fhir.Model.ImmunizationRecommendation.RecommendationComponent();
							Parse(newItem_recommendation, reader, outcome, locationPath + ".recommendation["+result.Recommendation.Count+"]"); // 130
		...
		private async System.Threading.Tasks.Task ParseAsync(ImmunizationRecommendation result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "patient":
							result.Patient = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Patient as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".patient"); // 100
							break;
						case "date":
							result.DateElement = new Hl7.Fhir.Model.FhirDateTime();
							await ParseAsync(result.DateElement as Hl7.Fhir.Model.FhirDateTime, reader, outcome, locationPath + ".date"); // 110
							break;
						case "authority":
							result.Authority = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Authority as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".authority"); // 120
							break;
						case "recommendation":
							var newItem_recommendation = new Hl7.Fhir.Model.ImmunizationRecommendation.RecommendationComponent();
							await ParseAsync(newItem_recommendation, reader, outcome, locationPath + ".recommendation["+result.Recommendation.Count+"]"); // 130
							result.Recommendation.Add(newItem_recommendation);
							break;
						default:
							// Property not found
