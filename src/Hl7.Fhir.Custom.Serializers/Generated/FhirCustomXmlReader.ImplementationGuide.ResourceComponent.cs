...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		public void Parse(Hl7.Fhir.Model.ImplementationGuide.ResourceComponent result, XmlReader reader, OperationOutcome outcome)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "fhirVersion":
							...
							Parse(newItem_fhirVersion, reader, outcome); // 50
						...
						case "exampleBoolean":
							...
							Parse(result.Example as Hl7.Fhir.Model.FhirBoolean, reader, outcome); // 80
							break;
						case "exampleCanonical":
							result.Example = new Hl7.Fhir.Model.Canonical();
							Parse(result.Example as Hl7.Fhir.Model.Canonical, reader, outcome); // 80
							break;
						case "groupingId":
							result.GroupingIdElement = new Hl7.Fhir.Model.Id();
							Parse(result.GroupingIdElement as Hl7.Fhir.Model.Id, reader, outcome); // 90
							break;
						default:
							// Property not found
		...
		public async System.Threading.Tasks.Task ParseAsync(Hl7.Fhir.Model.ImplementationGuide.ResourceComponent result, XmlReader reader, OperationOutcome outcome)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "fhirVersion":
							var newItem_fhirVersion = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.FHIRVersion>();
							await ParseAsync(newItem_fhirVersion, reader, outcome); // 50
							result.FhirVersionElement.Add(newItem_fhirVersion);
							break;
						case "name":
							result.NameElement = new Hl7.Fhir.Model.FhirString();
						...
						case "exampleBoolean":
							result.Example = new Hl7.Fhir.Model.FhirBoolean();
							await ParseAsync(result.Example as Hl7.Fhir.Model.FhirBoolean, reader, outcome); // 80
							break;
						case "exampleCanonical":
							result.Example = new Hl7.Fhir.Model.Canonical();
							await ParseAsync(result.Example as Hl7.Fhir.Model.Canonical, reader, outcome); // 80
							break;
						case "groupingId":
							result.GroupingIdElement = new Hl7.Fhir.Model.Id();
							await ParseAsync(result.GroupingIdElement as Hl7.Fhir.Model.Id, reader, outcome); // 90
							break;
						default:
							// Property not found
