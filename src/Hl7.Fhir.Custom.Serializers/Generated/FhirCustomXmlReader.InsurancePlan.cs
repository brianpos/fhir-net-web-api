...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(InsurancePlan result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "period":
							...
							Parse(result.Period as Hl7.Fhir.Model.Period, reader, outcome, locationPath + ".period"); // 140
							break;
						case "ownedBy":
							result.OwnedBy = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.OwnedBy as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".ownedBy"); // 150
							break;
						case "administeredBy":
							result.AdministeredBy = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.AdministeredBy as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".administeredBy"); // 160
							break;
						case "coverageArea":
							var newItem_coverageArea = new Hl7.Fhir.Model.ResourceReference();
							Parse(newItem_coverageArea, reader, outcome, locationPath + ".coverageArea["+result.CoverageArea.Count+"]"); // 170
						...
						case "endpoint":
							...
							Parse(newItem_endpoint, reader, outcome, locationPath + ".endpoint["+result.Endpoint.Count+"]"); // 190
							result.Endpoint.Add(newItem_endpoint);
							break;
						case "network":
							var newItem_network = new Hl7.Fhir.Model.ResourceReference();
							Parse(newItem_network, reader, outcome, locationPath + ".network["+result.Network.Count+"]"); // 200
							result.Network.Add(newItem_network);
							break;
						case "coverage":
							var newItem_coverage = new Hl7.Fhir.Model.InsurancePlan.CoverageComponent();
							Parse(newItem_coverage, reader, outcome, locationPath + ".coverage["+result.Coverage.Count+"]"); // 210
							result.Coverage.Add(newItem_coverage);
							break;
						case "plan":
							var newItem_plan = new Hl7.Fhir.Model.InsurancePlan.PlanComponent();
							Parse(newItem_plan, reader, outcome, locationPath + ".plan["+result.Plan.Count+"]"); // 220
		...
		private async System.Threading.Tasks.Task ParseAsync(InsurancePlan result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "period":
							result.Period = new Hl7.Fhir.Model.Period();
							await ParseAsync(result.Period as Hl7.Fhir.Model.Period, reader, outcome, locationPath + ".period"); // 140
							break;
						case "ownedBy":
							result.OwnedBy = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.OwnedBy as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".ownedBy"); // 150
							break;
						case "administeredBy":
							result.AdministeredBy = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.AdministeredBy as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".administeredBy"); // 160
							break;
						case "coverageArea":
							var newItem_coverageArea = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_coverageArea, reader, outcome, locationPath + ".coverageArea["+result.CoverageArea.Count+"]"); // 170
							result.CoverageArea.Add(newItem_coverageArea);
							break;
						case "contact":
							var newItem_contact = new Hl7.Fhir.Model.InsurancePlan.ContactComponent();
						...
						case "endpoint":
							var newItem_endpoint = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_endpoint, reader, outcome, locationPath + ".endpoint["+result.Endpoint.Count+"]"); // 190
							result.Endpoint.Add(newItem_endpoint);
							break;
						case "network":
							var newItem_network = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_network, reader, outcome, locationPath + ".network["+result.Network.Count+"]"); // 200
							result.Network.Add(newItem_network);
							break;
						case "coverage":
							var newItem_coverage = new Hl7.Fhir.Model.InsurancePlan.CoverageComponent();
							await ParseAsync(newItem_coverage, reader, outcome, locationPath + ".coverage["+result.Coverage.Count+"]"); // 210
							result.Coverage.Add(newItem_coverage);
							break;
						case "plan":
							var newItem_plan = new Hl7.Fhir.Model.InsurancePlan.PlanComponent();
							await ParseAsync(newItem_plan, reader, outcome, locationPath + ".plan["+result.Plan.Count+"]"); // 220
							result.Plan.Add(newItem_plan);
							break;
						default:
							// Property not found
