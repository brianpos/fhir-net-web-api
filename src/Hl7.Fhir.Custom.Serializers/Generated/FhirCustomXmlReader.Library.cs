...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(Library result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "type":
							...
							Parse(result.Type as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".type", cancellationToken); // 170
							break;
						...
						case "parameter":
							...
							Parse(newItem_parameter, reader, outcome, locationPath + ".parameter["+result.Parameter.Count+"]", cancellationToken); // 370
							result.Parameter.Add(newItem_parameter);
							break;
						case "dataRequirement":
							var newItem_dataRequirement = new Hl7.Fhir.Model.DataRequirement();
							Parse(newItem_dataRequirement, reader, outcome, locationPath + ".dataRequirement["+result.DataRequirement.Count+"]", cancellationToken); // 380
							result.DataRequirement.Add(newItem_dataRequirement);
							break;
						case "content":
							var newItem_content = new Hl7.Fhir.Model.Attachment();
							Parse(newItem_content, reader, outcome, locationPath + ".content["+result.Content.Count+"]", cancellationToken); // 390
		...
		private async System.Threading.Tasks.Task ParseAsync(Library result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "type":
							result.Type = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.Type as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".type", cancellationToken); // 170
							break;
						case "subjectCodeableConcept":
							result.Subject = new Hl7.Fhir.Model.CodeableConcept();
						...
						case "parameter":
							var newItem_parameter = new Hl7.Fhir.Model.ParameterDefinition();
							await ParseAsync(newItem_parameter, reader, outcome, locationPath + ".parameter["+result.Parameter.Count+"]", cancellationToken); // 370
							result.Parameter.Add(newItem_parameter);
							break;
						case "dataRequirement":
							var newItem_dataRequirement = new Hl7.Fhir.Model.DataRequirement();
							await ParseAsync(newItem_dataRequirement, reader, outcome, locationPath + ".dataRequirement["+result.DataRequirement.Count+"]", cancellationToken); // 380
							result.DataRequirement.Add(newItem_dataRequirement);
							break;
						case "content":
							var newItem_content = new Hl7.Fhir.Model.Attachment();
							await ParseAsync(newItem_content, reader, outcome, locationPath + ".content["+result.Content.Count+"]", cancellationToken); // 390
							result.Content.Add(newItem_content);
							break;
						default:
							// Property not found
