...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(List result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "status":
							...
							Parse(result.StatusElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.List.ListStatus>, reader, outcome, locationPath + ".status", cancellationToken); // 100
							break;
						case "mode":
							result.ModeElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.ListMode>();
							Parse(result.ModeElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.ListMode>, reader, outcome, locationPath + ".mode", cancellationToken); // 110
							break;
						case "title":
						...
						case "orderedBy":
							...
							Parse(result.OrderedBy as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".orderedBy", cancellationToken); // 180
							break;
						case "note":
						...
						case "entry":
							...
							Parse(newItem_entry, reader, outcome, locationPath + ".entry["+result.Entry.Count+"]", cancellationToken); // 200
							result.Entry.Add(newItem_entry);
							break;
						case "emptyReason":
							result.EmptyReason = new Hl7.Fhir.Model.CodeableConcept();
							Parse(result.EmptyReason as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".emptyReason", cancellationToken); // 210
							break;
						default:
							// Property not found
		...
		private async System.Threading.Tasks.Task ParseAsync(List result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "status":
							result.StatusElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.List.ListStatus>();
							await ParseAsync(result.StatusElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.List.ListStatus>, reader, outcome, locationPath + ".status", cancellationToken); // 100
							break;
						case "mode":
							result.ModeElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.ListMode>();
							await ParseAsync(result.ModeElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.ListMode>, reader, outcome, locationPath + ".mode", cancellationToken); // 110
							break;
						case "title":
							result.TitleElement = new Hl7.Fhir.Model.FhirString();
						...
						case "orderedBy":
							result.OrderedBy = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.OrderedBy as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".orderedBy", cancellationToken); // 180
							break;
						case "note":
							var newItem_note = new Hl7.Fhir.Model.Annotation();
						...
						case "entry":
							var newItem_entry = new Hl7.Fhir.Model.List.EntryComponent();
							await ParseAsync(newItem_entry, reader, outcome, locationPath + ".entry["+result.Entry.Count+"]", cancellationToken); // 200
							result.Entry.Add(newItem_entry);
							break;
						case "emptyReason":
							result.EmptyReason = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.EmptyReason as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".emptyReason", cancellationToken); // 210
							break;
						default:
							// Property not found
