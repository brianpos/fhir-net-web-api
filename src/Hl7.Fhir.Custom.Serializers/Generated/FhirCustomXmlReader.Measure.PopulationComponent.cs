...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		public void Parse(Hl7.Fhir.Model.Measure.PopulationComponent result, XmlReader reader, OperationOutcome outcome)
		{
		...
		public async System.Threading.Tasks.Task ParseAsync(Hl7.Fhir.Model.Measure.PopulationComponent result, XmlReader reader, OperationOutcome outcome)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
