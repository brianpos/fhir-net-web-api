...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(Measure result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "disclaimer":
							...
							Parse(result.Disclaimer as Hl7.Fhir.Model.Markdown, reader, outcome, locationPath + ".disclaimer", cancellationToken); // 370
							break;
						case "scoring":
							result.Scoring = new Hl7.Fhir.Model.CodeableConcept();
							Parse(result.Scoring as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".scoring", cancellationToken); // 380
							break;
						case "compositeScoring":
							result.CompositeScoring = new Hl7.Fhir.Model.CodeableConcept();
							Parse(result.CompositeScoring as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".compositeScoring", cancellationToken); // 390
							break;
						case "type":
							var newItem_type = new Hl7.Fhir.Model.CodeableConcept();
							Parse(newItem_type, reader, outcome, locationPath + ".type["+result.Type.Count+"]", cancellationToken); // 400
							result.Type.Add(newItem_type);
							break;
						case "riskAdjustment":
							result.RiskAdjustmentElement = new Hl7.Fhir.Model.FhirString();
							Parse(result.RiskAdjustmentElement as Hl7.Fhir.Model.FhirString, reader, outcome, locationPath + ".riskAdjustment", cancellationToken); // 410
							break;
						case "rateAggregation":
							result.RateAggregationElement = new Hl7.Fhir.Model.FhirString();
							Parse(result.RateAggregationElement as Hl7.Fhir.Model.FhirString, reader, outcome, locationPath + ".rateAggregation", cancellationToken); // 420
							break;
						case "rationale":
							result.Rationale = new Hl7.Fhir.Model.Markdown();
							Parse(result.Rationale as Hl7.Fhir.Model.Markdown, reader, outcome, locationPath + ".rationale", cancellationToken); // 430
							break;
						case "clinicalRecommendationStatement":
							result.ClinicalRecommendationStatement = new Hl7.Fhir.Model.Markdown();
							Parse(result.ClinicalRecommendationStatement as Hl7.Fhir.Model.Markdown, reader, outcome, locationPath + ".clinicalRecommendationStatement", cancellationToken); // 440
							break;
						case "improvementNotation":
							result.ImprovementNotation = new Hl7.Fhir.Model.CodeableConcept();
							Parse(result.ImprovementNotation as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".improvementNotation", cancellationToken); // 450
							break;
						case "definition":
							var newItem_definition = new Hl7.Fhir.Model.Markdown();
							Parse(newItem_definition, reader, outcome, locationPath + ".definition["+result.Definition.Count+"]", cancellationToken); // 460
							result.Definition.Add(newItem_definition);
							break;
						case "guidance":
							result.Guidance = new Hl7.Fhir.Model.Markdown();
							Parse(result.Guidance as Hl7.Fhir.Model.Markdown, reader, outcome, locationPath + ".guidance", cancellationToken); // 470
							break;
						case "group":
							var newItem_group = new Hl7.Fhir.Model.Measure.GroupComponent();
							Parse(newItem_group, reader, outcome, locationPath + ".group["+result.Group.Count+"]", cancellationToken); // 480
							result.Group.Add(newItem_group);
							break;
						case "supplementalData":
							var newItem_supplementalData = new Hl7.Fhir.Model.Measure.SupplementalDataComponent();
							Parse(newItem_supplementalData, reader, outcome, locationPath + ".supplementalData["+result.SupplementalData.Count+"]", cancellationToken); // 490
		...
		private async System.Threading.Tasks.Task ParseAsync(Measure result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "disclaimer":
							result.Disclaimer = new Hl7.Fhir.Model.Markdown();
							await ParseAsync(result.Disclaimer as Hl7.Fhir.Model.Markdown, reader, outcome, locationPath + ".disclaimer", cancellationToken); // 370
							break;
						case "scoring":
							result.Scoring = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.Scoring as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".scoring", cancellationToken); // 380
							break;
						case "compositeScoring":
							result.CompositeScoring = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.CompositeScoring as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".compositeScoring", cancellationToken); // 390
							break;
						case "type":
							var newItem_type = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_type, reader, outcome, locationPath + ".type["+result.Type.Count+"]", cancellationToken); // 400
							result.Type.Add(newItem_type);
							break;
						case "riskAdjustment":
							result.RiskAdjustmentElement = new Hl7.Fhir.Model.FhirString();
							await ParseAsync(result.RiskAdjustmentElement as Hl7.Fhir.Model.FhirString, reader, outcome, locationPath + ".riskAdjustment", cancellationToken); // 410
							break;
						case "rateAggregation":
							result.RateAggregationElement = new Hl7.Fhir.Model.FhirString();
							await ParseAsync(result.RateAggregationElement as Hl7.Fhir.Model.FhirString, reader, outcome, locationPath + ".rateAggregation", cancellationToken); // 420
							break;
						case "rationale":
							result.Rationale = new Hl7.Fhir.Model.Markdown();
							await ParseAsync(result.Rationale as Hl7.Fhir.Model.Markdown, reader, outcome, locationPath + ".rationale", cancellationToken); // 430
							break;
						case "clinicalRecommendationStatement":
							result.ClinicalRecommendationStatement = new Hl7.Fhir.Model.Markdown();
							await ParseAsync(result.ClinicalRecommendationStatement as Hl7.Fhir.Model.Markdown, reader, outcome, locationPath + ".clinicalRecommendationStatement", cancellationToken); // 440
							break;
						case "improvementNotation":
							result.ImprovementNotation = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.ImprovementNotation as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".improvementNotation", cancellationToken); // 450
							break;
						case "definition":
							var newItem_definition = new Hl7.Fhir.Model.Markdown();
							await ParseAsync(newItem_definition, reader, outcome, locationPath + ".definition["+result.Definition.Count+"]", cancellationToken); // 460
							result.Definition.Add(newItem_definition);
							break;
						case "guidance":
							result.Guidance = new Hl7.Fhir.Model.Markdown();
							await ParseAsync(result.Guidance as Hl7.Fhir.Model.Markdown, reader, outcome, locationPath + ".guidance", cancellationToken); // 470
							break;
						case "group":
							var newItem_group = new Hl7.Fhir.Model.Measure.GroupComponent();
							await ParseAsync(newItem_group, reader, outcome, locationPath + ".group["+result.Group.Count+"]", cancellationToken); // 480
							result.Group.Add(newItem_group);
							break;
						case "supplementalData":
							var newItem_supplementalData = new Hl7.Fhir.Model.Measure.SupplementalDataComponent();
							await ParseAsync(newItem_supplementalData, reader, outcome, locationPath + ".supplementalData["+result.SupplementalData.Count+"]", cancellationToken); // 490
							result.SupplementalData.Add(newItem_supplementalData);
							break;
						default:
							// Property not found
