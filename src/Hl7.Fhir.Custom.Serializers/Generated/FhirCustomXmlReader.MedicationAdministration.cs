...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(MedicationAdministration result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "instantiates":
							...
							Parse(newItem_instantiates, reader, outcome, locationPath + ".instantiates["+result.InstantiatesElement.Count+"]", cancellationToken); // 100
						...
						case "status":
							...
							Parse(result.StatusElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.MedicationAdministration.MedicationAdministrationStatusCodes>, reader, outcome, locationPath + ".status", cancellationToken); // 120
							break;
						case "statusReason":
						...
						case "supportingInformation":
							...
							Parse(newItem_supportingInformation, reader, outcome, locationPath + ".supportingInformation["+result.SupportingInformation.Count+"]", cancellationToken); // 180
							result.SupportingInformation.Add(newItem_supportingInformation);
							break;
						case "effectiveDateTime":
							result.Effective = new Hl7.Fhir.Model.FhirDateTime();
							Parse(result.Effective as Hl7.Fhir.Model.FhirDateTime, reader, outcome, locationPath + ".effective", cancellationToken); // 190
							break;
						case "effectivePeriod":
							result.Effective = new Hl7.Fhir.Model.Period();
							Parse(result.Effective as Hl7.Fhir.Model.Period, reader, outcome, locationPath + ".effective", cancellationToken); // 190
							break;
						case "performer":
						...
						case "reasonReference":
							...
							Parse(newItem_reasonReference, reader, outcome, locationPath + ".reasonReference["+result.ReasonReference.Count+"]", cancellationToken); // 220
							result.ReasonReference.Add(newItem_reasonReference);
							break;
						case "request":
							result.Request = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Request as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".request", cancellationToken); // 230
							break;
						case "device":
							var newItem_device = new Hl7.Fhir.Model.ResourceReference();
							Parse(newItem_device, reader, outcome, locationPath + ".device["+result.Device.Count+"]", cancellationToken); // 240
						...
						case "dosage":
							...
							Parse(result.Dosage as Hl7.Fhir.Model.MedicationAdministration.DosageComponent, reader, outcome, locationPath + ".dosage", cancellationToken); // 260
							break;
						case "eventHistory":
							var newItem_eventHistory = new Hl7.Fhir.Model.ResourceReference();
							Parse(newItem_eventHistory, reader, outcome, locationPath + ".eventHistory["+result.EventHistory.Count+"]", cancellationToken); // 270
		...
		private async System.Threading.Tasks.Task ParseAsync(MedicationAdministration result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "instantiates":
							var newItem_instantiates = new Hl7.Fhir.Model.FhirUri();
							await ParseAsync(newItem_instantiates, reader, outcome, locationPath + ".instantiates["+result.InstantiatesElement.Count+"]", cancellationToken); // 100
							result.InstantiatesElement.Add(newItem_instantiates);
							break;
						case "partOf":
							var newItem_partOf = new Hl7.Fhir.Model.ResourceReference();
						...
						case "status":
							result.StatusElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.MedicationAdministration.MedicationAdministrationStatusCodes>();
							await ParseAsync(result.StatusElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.MedicationAdministration.MedicationAdministrationStatusCodes>, reader, outcome, locationPath + ".status", cancellationToken); // 120
							break;
						case "statusReason":
							var newItem_statusReason = new Hl7.Fhir.Model.CodeableConcept();
						...
						case "supportingInformation":
							var newItem_supportingInformation = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_supportingInformation, reader, outcome, locationPath + ".supportingInformation["+result.SupportingInformation.Count+"]", cancellationToken); // 180
							result.SupportingInformation.Add(newItem_supportingInformation);
							break;
						case "effectiveDateTime":
							result.Effective = new Hl7.Fhir.Model.FhirDateTime();
							await ParseAsync(result.Effective as Hl7.Fhir.Model.FhirDateTime, reader, outcome, locationPath + ".effective", cancellationToken); // 190
							break;
						case "effectivePeriod":
							result.Effective = new Hl7.Fhir.Model.Period();
							await ParseAsync(result.Effective as Hl7.Fhir.Model.Period, reader, outcome, locationPath + ".effective", cancellationToken); // 190
							break;
						case "performer":
							var newItem_performer = new Hl7.Fhir.Model.MedicationAdministration.PerformerComponent();
						...
						case "reasonReference":
							var newItem_reasonReference = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_reasonReference, reader, outcome, locationPath + ".reasonReference["+result.ReasonReference.Count+"]", cancellationToken); // 220
							result.ReasonReference.Add(newItem_reasonReference);
							break;
						case "request":
							result.Request = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Request as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".request", cancellationToken); // 230
							break;
						case "device":
							var newItem_device = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_device, reader, outcome, locationPath + ".device["+result.Device.Count+"]", cancellationToken); // 240
							result.Device.Add(newItem_device);
							break;
						case "note":
							var newItem_note = new Hl7.Fhir.Model.Annotation();
						...
						case "dosage":
							result.Dosage = new Hl7.Fhir.Model.MedicationAdministration.DosageComponent();
							await ParseAsync(result.Dosage as Hl7.Fhir.Model.MedicationAdministration.DosageComponent, reader, outcome, locationPath + ".dosage", cancellationToken); // 260
							break;
						case "eventHistory":
							var newItem_eventHistory = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_eventHistory, reader, outcome, locationPath + ".eventHistory["+result.EventHistory.Count+"]", cancellationToken); // 270
							result.EventHistory.Add(newItem_eventHistory);
							break;
						default:
							// Property not found
