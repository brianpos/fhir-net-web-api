...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(MedicinalProductIndication result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "diseaseSymptomProcedure":
							...
							Parse(result.DiseaseSymptomProcedure as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".diseaseSymptomProcedure"); // 100
							break;
						case "diseaseStatus":
						...
						case "intendedEffect":
							...
							Parse(result.IntendedEffect as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".intendedEffect"); // 130
							break;
						case "duration":
							result.Duration = new Hl7.Fhir.Model.Quantity();
							Parse(result.Duration as Hl7.Fhir.Model.Quantity, reader, outcome, locationPath + ".duration"); // 140
							break;
						case "otherTherapy":
							var newItem_otherTherapy = new Hl7.Fhir.Model.MedicinalProductIndication.OtherTherapyComponent();
							Parse(newItem_otherTherapy, reader, outcome, locationPath + ".otherTherapy["+result.OtherTherapy.Count+"]"); // 150
						...
						case "undesirableEffect":
							...
							Parse(newItem_undesirableEffect, reader, outcome, locationPath + ".undesirableEffect["+result.UndesirableEffect.Count+"]"); // 160
							result.UndesirableEffect.Add(newItem_undesirableEffect);
							break;
						case "population":
							var newItem_population = new Hl7.Fhir.Model.Population();
							Parse(newItem_population, reader, outcome, locationPath + ".population["+result.Population.Count+"]"); // 170
		...
		private async System.Threading.Tasks.Task ParseAsync(MedicinalProductIndication result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "diseaseSymptomProcedure":
							result.DiseaseSymptomProcedure = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.DiseaseSymptomProcedure as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".diseaseSymptomProcedure"); // 100
							break;
						case "diseaseStatus":
							result.DiseaseStatus = new Hl7.Fhir.Model.CodeableConcept();
						...
						case "intendedEffect":
							result.IntendedEffect = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.IntendedEffect as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".intendedEffect"); // 130
							break;
						case "duration":
							result.Duration = new Hl7.Fhir.Model.Quantity();
							await ParseAsync(result.Duration as Hl7.Fhir.Model.Quantity, reader, outcome, locationPath + ".duration"); // 140
							break;
						case "otherTherapy":
							var newItem_otherTherapy = new Hl7.Fhir.Model.MedicinalProductIndication.OtherTherapyComponent();
							await ParseAsync(newItem_otherTherapy, reader, outcome, locationPath + ".otherTherapy["+result.OtherTherapy.Count+"]"); // 150
							result.OtherTherapy.Add(newItem_otherTherapy);
							break;
						case "undesirableEffect":
							var newItem_undesirableEffect = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_undesirableEffect, reader, outcome, locationPath + ".undesirableEffect["+result.UndesirableEffect.Count+"]"); // 160
							result.UndesirableEffect.Add(newItem_undesirableEffect);
							break;
						case "population":
							var newItem_population = new Hl7.Fhir.Model.Population();
							await ParseAsync(newItem_population, reader, outcome, locationPath + ".population["+result.Population.Count+"]"); // 170
							result.Population.Add(newItem_population);
							break;
						default:
							// Property not found
