...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(MedicinalProductIngredient result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "role":
							...
							Parse(result.Role as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".role"); // 100
							break;
						case "allergenicIndicator":
							result.AllergenicIndicatorElement = new Hl7.Fhir.Model.FhirBoolean();
							Parse(result.AllergenicIndicatorElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome, locationPath + ".allergenicIndicator"); // 110
							break;
						case "manufacturer":
						...
						case "specifiedSubstance":
							...
							Parse(newItem_specifiedSubstance, reader, outcome, locationPath + ".specifiedSubstance["+result.SpecifiedSubstance.Count+"]"); // 130
						...
						case "substance":
							...
							Parse(result.Substance as Hl7.Fhir.Model.MedicinalProductIngredient.SubstanceComponent, reader, outcome, locationPath + ".substance"); // 140
							break;
						default:
							// Property not found
		...
		private async System.Threading.Tasks.Task ParseAsync(MedicinalProductIngredient result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "role":
							result.Role = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.Role as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".role"); // 100
							break;
						case "allergenicIndicator":
							result.AllergenicIndicatorElement = new Hl7.Fhir.Model.FhirBoolean();
							await ParseAsync(result.AllergenicIndicatorElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome, locationPath + ".allergenicIndicator"); // 110
							break;
						case "manufacturer":
							var newItem_manufacturer = new Hl7.Fhir.Model.ResourceReference();
						...
						case "specifiedSubstance":
							var newItem_specifiedSubstance = new Hl7.Fhir.Model.MedicinalProductIngredient.SpecifiedSubstanceComponent();
							await ParseAsync(newItem_specifiedSubstance, reader, outcome, locationPath + ".specifiedSubstance["+result.SpecifiedSubstance.Count+"]"); // 130
							result.SpecifiedSubstance.Add(newItem_specifiedSubstance);
							break;
						case "substance":
							result.Substance = new Hl7.Fhir.Model.MedicinalProductIngredient.SubstanceComponent();
							await ParseAsync(result.Substance as Hl7.Fhir.Model.MedicinalProductIngredient.SubstanceComponent, reader, outcome, locationPath + ".substance"); // 140
							break;
						default:
							// Property not found
