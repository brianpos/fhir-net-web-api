...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(MedicinalProductInteraction result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "interactant":
							...
							Parse(newItem_interactant, reader, outcome, locationPath + ".interactant["+result.Interactant.Count+"]"); // 110
						...
						case "effect":
							...
							Parse(result.Effect as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".effect"); // 130
							break;
						case "incidence":
							result.Incidence = new Hl7.Fhir.Model.CodeableConcept();
							Parse(result.Incidence as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".incidence"); // 140
							break;
						case "management":
							result.Management = new Hl7.Fhir.Model.CodeableConcept();
							Parse(result.Management as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".management"); // 150
							break;
						default:
							// Property not found
		...
		private async System.Threading.Tasks.Task ParseAsync(MedicinalProductInteraction result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "interactant":
							var newItem_interactant = new Hl7.Fhir.Model.MedicinalProductInteraction.InteractantComponent();
							await ParseAsync(newItem_interactant, reader, outcome, locationPath + ".interactant["+result.Interactant.Count+"]"); // 110
							result.Interactant.Add(newItem_interactant);
							break;
						case "type":
							result.Type = new Hl7.Fhir.Model.CodeableConcept();
						...
						case "effect":
							result.Effect = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.Effect as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".effect"); // 130
							break;
						case "incidence":
							result.Incidence = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.Incidence as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".incidence"); // 140
							break;
						case "management":
							result.Management = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.Management as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".management"); // 150
							break;
						default:
							// Property not found
