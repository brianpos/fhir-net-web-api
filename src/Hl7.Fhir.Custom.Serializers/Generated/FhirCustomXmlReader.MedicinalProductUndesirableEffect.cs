...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(MedicinalProductUndesirableEffect result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "symptomConditionEffect":
							...
							Parse(result.SymptomConditionEffect as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".symptomConditionEffect"); // 100
							break;
						case "classification":
							result.Classification = new Hl7.Fhir.Model.CodeableConcept();
							Parse(result.Classification as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".classification"); // 110
							break;
						case "frequencyOfOccurrence":
							result.FrequencyOfOccurrence = new Hl7.Fhir.Model.CodeableConcept();
							Parse(result.FrequencyOfOccurrence as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".frequencyOfOccurrence"); // 120
							break;
						case "population":
							var newItem_population = new Hl7.Fhir.Model.Population();
							Parse(newItem_population, reader, outcome, locationPath + ".population["+result.Population.Count+"]"); // 130
		...
		private async System.Threading.Tasks.Task ParseAsync(MedicinalProductUndesirableEffect result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "symptomConditionEffect":
							result.SymptomConditionEffect = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.SymptomConditionEffect as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".symptomConditionEffect"); // 100
							break;
						case "classification":
							result.Classification = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.Classification as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".classification"); // 110
							break;
						case "frequencyOfOccurrence":
							result.FrequencyOfOccurrence = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.FrequencyOfOccurrence as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".frequencyOfOccurrence"); // 120
							break;
						case "population":
							var newItem_population = new Hl7.Fhir.Model.Population();
							await ParseAsync(newItem_population, reader, outcome, locationPath + ".population["+result.Population.Count+"]"); // 130
							result.Population.Add(newItem_population);
							break;
						default:
							// Property not found
