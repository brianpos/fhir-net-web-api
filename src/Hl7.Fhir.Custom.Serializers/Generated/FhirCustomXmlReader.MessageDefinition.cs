...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(MessageDefinition result, XmlReader reader, OperationOutcome outcome)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "replaces":
							...
							Parse(newItem_replaces, reader, outcome); // 140
						...
						case "publisher":
							...
							Parse(result.PublisherElement as Hl7.Fhir.Model.FhirString, reader, outcome); // 180
							break;
						case "contact":
						...
						case "description":
							...
							Parse(result.Description as Hl7.Fhir.Model.Markdown, reader, outcome); // 200
							break;
						case "useContext":
							var newItem_useContext = new Hl7.Fhir.Model.UsageContext();
							Parse(newItem_useContext, reader, outcome); // 210
							result.UseContext.Add(newItem_useContext);
							break;
						case "jurisdiction":
							var newItem_jurisdiction = new Hl7.Fhir.Model.CodeableConcept();
							Parse(newItem_jurisdiction, reader, outcome); // 220
							result.Jurisdiction.Add(newItem_jurisdiction);
							break;
						case "purpose":
							result.Purpose = new Hl7.Fhir.Model.Markdown();
							Parse(result.Purpose as Hl7.Fhir.Model.Markdown, reader, outcome); // 230
							break;
						case "copyright":
							result.Copyright = new Hl7.Fhir.Model.Markdown();
							Parse(result.Copyright as Hl7.Fhir.Model.Markdown, reader, outcome); // 240
							break;
						case "base":
							result.BaseElement = new Hl7.Fhir.Model.Canonical();
							Parse(result.BaseElement as Hl7.Fhir.Model.Canonical, reader, outcome); // 250
							break;
						case "parent":
							var newItem_parent = new Hl7.Fhir.Model.Canonical();
							Parse(newItem_parent, reader, outcome); // 260
							result.ParentElement.Add(newItem_parent);
							break;
						case "eventCoding":
							result.Event = new Hl7.Fhir.Model.Coding();
							Parse(result.Event as Hl7.Fhir.Model.Coding, reader, outcome); // 270
							break;
						case "eventUri":
							result.Event = new Hl7.Fhir.Model.FhirUri();
							Parse(result.Event as Hl7.Fhir.Model.FhirUri, reader, outcome); // 270
							break;
						case "category":
							result.CategoryElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.MessageDefinition.MessageSignificanceCategory>();
							Parse(result.CategoryElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.MessageDefinition.MessageSignificanceCategory>, reader, outcome); // 280
							break;
						case "focus":
							var newItem_focus = new Hl7.Fhir.Model.MessageDefinition.FocusComponent();
							Parse(newItem_focus, reader, outcome); // 290
						...
						case "responseRequired":
							...
							Parse(result.ResponseRequiredElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.MessageDefinition.messageheader_response_request>, reader, outcome); // 300
							break;
						case "allowedResponse":
							var newItem_allowedResponse = new Hl7.Fhir.Model.MessageDefinition.AllowedResponseComponent();
							Parse(newItem_allowedResponse, reader, outcome); // 310
							result.AllowedResponse.Add(newItem_allowedResponse);
							break;
						case "graph":
							var newItem_graph = new Hl7.Fhir.Model.Canonical();
							Parse(newItem_graph, reader, outcome); // 320
		...
		private async System.Threading.Tasks.Task ParseAsync(MessageDefinition result, XmlReader reader, OperationOutcome outcome)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "replaces":
							var newItem_replaces = new Hl7.Fhir.Model.Canonical();
							await ParseAsync(newItem_replaces, reader, outcome); // 140
							result.ReplacesElement.Add(newItem_replaces);
							break;
						case "status":
							result.StatusElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.PublicationStatus>();
						...
						case "publisher":
							result.PublisherElement = new Hl7.Fhir.Model.FhirString();
							await ParseAsync(result.PublisherElement as Hl7.Fhir.Model.FhirString, reader, outcome); // 180
							break;
						case "contact":
							var newItem_contact = new Hl7.Fhir.Model.ContactDetail();
						...
						case "description":
							result.Description = new Hl7.Fhir.Model.Markdown();
							await ParseAsync(result.Description as Hl7.Fhir.Model.Markdown, reader, outcome); // 200
							break;
						case "useContext":
							var newItem_useContext = new Hl7.Fhir.Model.UsageContext();
							await ParseAsync(newItem_useContext, reader, outcome); // 210
							result.UseContext.Add(newItem_useContext);
							break;
						case "jurisdiction":
							var newItem_jurisdiction = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_jurisdiction, reader, outcome); // 220
							result.Jurisdiction.Add(newItem_jurisdiction);
							break;
						case "purpose":
							result.Purpose = new Hl7.Fhir.Model.Markdown();
							await ParseAsync(result.Purpose as Hl7.Fhir.Model.Markdown, reader, outcome); // 230
							break;
						case "copyright":
							result.Copyright = new Hl7.Fhir.Model.Markdown();
							await ParseAsync(result.Copyright as Hl7.Fhir.Model.Markdown, reader, outcome); // 240
							break;
						case "base":
							result.BaseElement = new Hl7.Fhir.Model.Canonical();
							await ParseAsync(result.BaseElement as Hl7.Fhir.Model.Canonical, reader, outcome); // 250
							break;
						case "parent":
							var newItem_parent = new Hl7.Fhir.Model.Canonical();
							await ParseAsync(newItem_parent, reader, outcome); // 260
							result.ParentElement.Add(newItem_parent);
							break;
						case "eventCoding":
							result.Event = new Hl7.Fhir.Model.Coding();
							await ParseAsync(result.Event as Hl7.Fhir.Model.Coding, reader, outcome); // 270
							break;
						case "eventUri":
							result.Event = new Hl7.Fhir.Model.FhirUri();
							await ParseAsync(result.Event as Hl7.Fhir.Model.FhirUri, reader, outcome); // 270
							break;
						case "category":
							result.CategoryElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.MessageDefinition.MessageSignificanceCategory>();
							await ParseAsync(result.CategoryElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.MessageDefinition.MessageSignificanceCategory>, reader, outcome); // 280
							break;
						case "focus":
							var newItem_focus = new Hl7.Fhir.Model.MessageDefinition.FocusComponent();
							await ParseAsync(newItem_focus, reader, outcome); // 290
							result.Focus.Add(newItem_focus);
							break;
						case "responseRequired":
							result.ResponseRequiredElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.MessageDefinition.messageheader_response_request>();
							await ParseAsync(result.ResponseRequiredElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.MessageDefinition.messageheader_response_request>, reader, outcome); // 300
							break;
						case "allowedResponse":
							var newItem_allowedResponse = new Hl7.Fhir.Model.MessageDefinition.AllowedResponseComponent();
							await ParseAsync(newItem_allowedResponse, reader, outcome); // 310
							result.AllowedResponse.Add(newItem_allowedResponse);
							break;
						case "graph":
							var newItem_graph = new Hl7.Fhir.Model.Canonical();
							await ParseAsync(newItem_graph, reader, outcome); // 320
							result.GraphElement.Add(newItem_graph);
							break;
						default:
							// Property not found
