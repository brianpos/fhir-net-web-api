...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(NutritionOrder result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "instantiates":
							...
							Parse(newItem_instantiates, reader, outcome, locationPath + ".instantiates["+result.InstantiatesElement.Count+"]"); // 120
						...
						case "intent":
							...
							Parse(result.IntentElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.RequestIntent>, reader, outcome, locationPath + ".intent"); // 140
							break;
						case "patient":
							result.Patient = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Patient as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".patient"); // 150
							break;
						case "encounter":
						...
						case "dateTime":
							...
							Parse(result.DateTimeElement as Hl7.Fhir.Model.FhirDateTime, reader, outcome, locationPath + ".dateTime"); // 170
							break;
						case "orderer":
							result.Orderer = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Orderer as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".orderer"); // 180
							break;
						case "allergyIntolerance":
							var newItem_allergyIntolerance = new Hl7.Fhir.Model.ResourceReference();
							Parse(newItem_allergyIntolerance, reader, outcome, locationPath + ".allergyIntolerance["+result.AllergyIntolerance.Count+"]"); // 190
						...
						case "foodPreferenceModifier":
							...
							Parse(newItem_foodPreferenceModifier, reader, outcome, locationPath + ".foodPreferenceModifier["+result.FoodPreferenceModifier.Count+"]"); // 200
						...
						case "excludeFoodModifier":
							...
							Parse(newItem_excludeFoodModifier, reader, outcome, locationPath + ".excludeFoodModifier["+result.ExcludeFoodModifier.Count+"]"); // 210
						...
						case "oralDiet":
							...
							Parse(result.OralDiet as Hl7.Fhir.Model.NutritionOrder.OralDietComponent, reader, outcome, locationPath + ".oralDiet"); // 220
							break;
						case "supplement":
							var newItem_supplement = new Hl7.Fhir.Model.NutritionOrder.SupplementComponent();
							Parse(newItem_supplement, reader, outcome, locationPath + ".supplement["+result.Supplement.Count+"]"); // 230
							result.Supplement.Add(newItem_supplement);
							break;
						case "enteralFormula":
							result.EnteralFormula = new Hl7.Fhir.Model.NutritionOrder.EnteralFormulaComponent();
							Parse(result.EnteralFormula as Hl7.Fhir.Model.NutritionOrder.EnteralFormulaComponent, reader, outcome, locationPath + ".enteralFormula"); // 240
							break;
						case "note":
		...
		private async System.Threading.Tasks.Task ParseAsync(NutritionOrder result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "instantiates":
							var newItem_instantiates = new Hl7.Fhir.Model.FhirUri();
							await ParseAsync(newItem_instantiates, reader, outcome, locationPath + ".instantiates["+result.InstantiatesElement.Count+"]"); // 120
							result.InstantiatesElement.Add(newItem_instantiates);
							break;
						case "status":
							result.StatusElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.RequestStatus>();
						...
						case "intent":
							result.IntentElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.RequestIntent>();
							await ParseAsync(result.IntentElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.RequestIntent>, reader, outcome, locationPath + ".intent"); // 140
							break;
						case "patient":
							result.Patient = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Patient as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".patient"); // 150
							break;
						case "encounter":
							result.Encounter = new Hl7.Fhir.Model.ResourceReference();
						...
						case "dateTime":
							result.DateTimeElement = new Hl7.Fhir.Model.FhirDateTime();
							await ParseAsync(result.DateTimeElement as Hl7.Fhir.Model.FhirDateTime, reader, outcome, locationPath + ".dateTime"); // 170
							break;
						case "orderer":
							result.Orderer = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Orderer as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".orderer"); // 180
							break;
						case "allergyIntolerance":
							var newItem_allergyIntolerance = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_allergyIntolerance, reader, outcome, locationPath + ".allergyIntolerance["+result.AllergyIntolerance.Count+"]"); // 190
							result.AllergyIntolerance.Add(newItem_allergyIntolerance);
							break;
						case "foodPreferenceModifier":
							var newItem_foodPreferenceModifier = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_foodPreferenceModifier, reader, outcome, locationPath + ".foodPreferenceModifier["+result.FoodPreferenceModifier.Count+"]"); // 200
							result.FoodPreferenceModifier.Add(newItem_foodPreferenceModifier);
							break;
						case "excludeFoodModifier":
							var newItem_excludeFoodModifier = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_excludeFoodModifier, reader, outcome, locationPath + ".excludeFoodModifier["+result.ExcludeFoodModifier.Count+"]"); // 210
							result.ExcludeFoodModifier.Add(newItem_excludeFoodModifier);
							break;
						case "oralDiet":
							result.OralDiet = new Hl7.Fhir.Model.NutritionOrder.OralDietComponent();
							await ParseAsync(result.OralDiet as Hl7.Fhir.Model.NutritionOrder.OralDietComponent, reader, outcome, locationPath + ".oralDiet"); // 220
							break;
						case "supplement":
							var newItem_supplement = new Hl7.Fhir.Model.NutritionOrder.SupplementComponent();
							await ParseAsync(newItem_supplement, reader, outcome, locationPath + ".supplement["+result.Supplement.Count+"]"); // 230
							result.Supplement.Add(newItem_supplement);
							break;
						case "enteralFormula":
							result.EnteralFormula = new Hl7.Fhir.Model.NutritionOrder.EnteralFormulaComponent();
							await ParseAsync(result.EnteralFormula as Hl7.Fhir.Model.NutritionOrder.EnteralFormulaComponent, reader, outcome, locationPath + ".enteralFormula"); // 240
							break;
						case "note":
							var newItem_note = new Hl7.Fhir.Model.Annotation();
