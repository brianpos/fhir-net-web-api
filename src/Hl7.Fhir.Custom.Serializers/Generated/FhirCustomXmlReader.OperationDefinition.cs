...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(OperationDefinition result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "kind":
							...
							Parse(result.KindElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.OperationDefinition.OperationKind>, reader, outcome, locationPath + ".kind"); // 140
							break;
						case "experimental":
						...
						case "affectsState":
							...
							Parse(result.AffectsStateElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome, locationPath + ".affectsState"); // 230
							break;
						case "code":
							result.CodeElement = new Hl7.Fhir.Model.Code();
							Parse(result.CodeElement as Hl7.Fhir.Model.Code, reader, outcome, locationPath + ".code"); // 240
							break;
						case "comment":
							result.Comment = new Hl7.Fhir.Model.Markdown();
							Parse(result.Comment as Hl7.Fhir.Model.Markdown, reader, outcome, locationPath + ".comment"); // 250
							break;
						case "base":
							result.BaseElement = new Hl7.Fhir.Model.Canonical();
							Parse(result.BaseElement as Hl7.Fhir.Model.Canonical, reader, outcome, locationPath + ".base"); // 260
							break;
						case "resource":
							var newItem_resource = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.ResourceType>();
							Parse(newItem_resource, reader, outcome, locationPath + ".resource["+result.ResourceElement.Count+"]"); // 270
							result.ResourceElement.Add(newItem_resource);
							break;
						case "system":
							result.SystemElement = new Hl7.Fhir.Model.FhirBoolean();
							Parse(result.SystemElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome, locationPath + ".system"); // 280
							break;
						case "type":
							result.TypeElement = new Hl7.Fhir.Model.FhirBoolean();
							Parse(result.TypeElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome, locationPath + ".type"); // 290
							break;
						case "instance":
							result.InstanceElement = new Hl7.Fhir.Model.FhirBoolean();
							Parse(result.InstanceElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome, locationPath + ".instance"); // 300
							break;
						case "inputProfile":
							result.InputProfileElement = new Hl7.Fhir.Model.Canonical();
							Parse(result.InputProfileElement as Hl7.Fhir.Model.Canonical, reader, outcome, locationPath + ".inputProfile"); // 310
							break;
						case "outputProfile":
							result.OutputProfileElement = new Hl7.Fhir.Model.Canonical();
							Parse(result.OutputProfileElement as Hl7.Fhir.Model.Canonical, reader, outcome, locationPath + ".outputProfile"); // 320
							break;
						case "parameter":
							var newItem_parameter = new Hl7.Fhir.Model.OperationDefinition.ParameterComponent();
							Parse(newItem_parameter, reader, outcome, locationPath + ".parameter["+result.Parameter.Count+"]"); // 330
							result.Parameter.Add(newItem_parameter);
							break;
						case "overload":
							var newItem_overload = new Hl7.Fhir.Model.OperationDefinition.OverloadComponent();
							Parse(newItem_overload, reader, outcome, locationPath + ".overload["+result.Overload.Count+"]"); // 340
		...
		private async System.Threading.Tasks.Task ParseAsync(OperationDefinition result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "kind":
							result.KindElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.OperationDefinition.OperationKind>();
							await ParseAsync(result.KindElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.OperationDefinition.OperationKind>, reader, outcome, locationPath + ".kind"); // 140
							break;
						case "experimental":
							result.ExperimentalElement = new Hl7.Fhir.Model.FhirBoolean();
						...
						case "affectsState":
							result.AffectsStateElement = new Hl7.Fhir.Model.FhirBoolean();
							await ParseAsync(result.AffectsStateElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome, locationPath + ".affectsState"); // 230
							break;
						case "code":
							result.CodeElement = new Hl7.Fhir.Model.Code();
							await ParseAsync(result.CodeElement as Hl7.Fhir.Model.Code, reader, outcome, locationPath + ".code"); // 240
							break;
						case "comment":
							result.Comment = new Hl7.Fhir.Model.Markdown();
							await ParseAsync(result.Comment as Hl7.Fhir.Model.Markdown, reader, outcome, locationPath + ".comment"); // 250
							break;
						case "base":
							result.BaseElement = new Hl7.Fhir.Model.Canonical();
							await ParseAsync(result.BaseElement as Hl7.Fhir.Model.Canonical, reader, outcome, locationPath + ".base"); // 260
							break;
						case "resource":
							var newItem_resource = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.ResourceType>();
							await ParseAsync(newItem_resource, reader, outcome, locationPath + ".resource["+result.ResourceElement.Count+"]"); // 270
							result.ResourceElement.Add(newItem_resource);
							break;
						case "system":
							result.SystemElement = new Hl7.Fhir.Model.FhirBoolean();
							await ParseAsync(result.SystemElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome, locationPath + ".system"); // 280
							break;
						case "type":
							result.TypeElement = new Hl7.Fhir.Model.FhirBoolean();
							await ParseAsync(result.TypeElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome, locationPath + ".type"); // 290
							break;
						case "instance":
							result.InstanceElement = new Hl7.Fhir.Model.FhirBoolean();
							await ParseAsync(result.InstanceElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome, locationPath + ".instance"); // 300
							break;
						case "inputProfile":
							result.InputProfileElement = new Hl7.Fhir.Model.Canonical();
							await ParseAsync(result.InputProfileElement as Hl7.Fhir.Model.Canonical, reader, outcome, locationPath + ".inputProfile"); // 310
							break;
						case "outputProfile":
							result.OutputProfileElement = new Hl7.Fhir.Model.Canonical();
							await ParseAsync(result.OutputProfileElement as Hl7.Fhir.Model.Canonical, reader, outcome, locationPath + ".outputProfile"); // 320
							break;
						case "parameter":
							var newItem_parameter = new Hl7.Fhir.Model.OperationDefinition.ParameterComponent();
							await ParseAsync(newItem_parameter, reader, outcome, locationPath + ".parameter["+result.Parameter.Count+"]"); // 330
							result.Parameter.Add(newItem_parameter);
							break;
						case "overload":
							var newItem_overload = new Hl7.Fhir.Model.OperationDefinition.OverloadComponent();
							await ParseAsync(newItem_overload, reader, outcome, locationPath + ".overload["+result.Overload.Count+"]"); // 340
							result.Overload.Add(newItem_overload);
							break;
						default:
							// Property not found
