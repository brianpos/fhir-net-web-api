...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(OrganizationAffiliation result, XmlReader reader, OperationOutcome outcome)
		{
		...
		private async System.Threading.Tasks.Task ParseAsync(OrganizationAffiliation result, XmlReader reader, OperationOutcome outcome)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "organization":
							result.Organization = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Organization as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 120
							break;
						case "participatingOrganization":
							result.ParticipatingOrganization = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.ParticipatingOrganization as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 130
							break;
						case "network":
							var newItem_network = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_network, reader, outcome); // 140
							result.Network.Add(newItem_network);
							break;
						case "code":
							var newItem_code = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_code, reader, outcome); // 150
							result.Code.Add(newItem_code);
							break;
						case "specialty":
							var newItem_specialty = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_specialty, reader, outcome); // 160
							result.Specialty.Add(newItem_specialty);
							break;
						case "location":
							var newItem_location = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_location, reader, outcome); // 170
							result.Location.Add(newItem_location);
							break;
						case "healthcareService":
							var newItem_healthcareService = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_healthcareService, reader, outcome); // 180
							result.HealthcareService.Add(newItem_healthcareService);
							break;
						case "telecom":
							var newItem_telecom = new Hl7.Fhir.Model.ContactPoint();
							await ParseAsync(newItem_telecom, reader, outcome); // 190
							result.Telecom.Add(newItem_telecom);
							break;
						case "endpoint":
							var newItem_endpoint = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_endpoint, reader, outcome); // 200
							result.Endpoint.Add(newItem_endpoint);
							break;
						default:
							// Property not found
