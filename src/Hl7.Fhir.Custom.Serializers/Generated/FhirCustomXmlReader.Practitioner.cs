...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(Practitioner result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "address":
							...
							Parse(newItem_address, reader, outcome, locationPath + ".address["+result.Address.Count+"]"); // 130
							result.Address.Add(newItem_address);
							break;
						case "gender":
							result.GenderElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.AdministrativeGender>();
							Parse(result.GenderElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.AdministrativeGender>, reader, outcome, locationPath + ".gender"); // 140
							break;
						case "birthDate":
							result.BirthDateElement = new Hl7.Fhir.Model.Date();
							Parse(result.BirthDateElement as Hl7.Fhir.Model.Date, reader, outcome, locationPath + ".birthDate"); // 150
							break;
						case "photo":
							var newItem_photo = new Hl7.Fhir.Model.Attachment();
							Parse(newItem_photo, reader, outcome, locationPath + ".photo["+result.Photo.Count+"]"); // 160
							result.Photo.Add(newItem_photo);
							break;
						case "qualification":
							var newItem_qualification = new Hl7.Fhir.Model.Practitioner.QualificationComponent();
							Parse(newItem_qualification, reader, outcome, locationPath + ".qualification["+result.Qualification.Count+"]"); // 170
							result.Qualification.Add(newItem_qualification);
							break;
						case "communication":
							var newItem_communication = new Hl7.Fhir.Model.CodeableConcept();
							Parse(newItem_communication, reader, outcome, locationPath + ".communication["+result.Communication.Count+"]"); // 180
		...
		private async System.Threading.Tasks.Task ParseAsync(Practitioner result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "address":
							var newItem_address = new Hl7.Fhir.Model.Address();
							await ParseAsync(newItem_address, reader, outcome, locationPath + ".address["+result.Address.Count+"]"); // 130
							result.Address.Add(newItem_address);
							break;
						case "gender":
							result.GenderElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.AdministrativeGender>();
							await ParseAsync(result.GenderElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.AdministrativeGender>, reader, outcome, locationPath + ".gender"); // 140
							break;
						case "birthDate":
							result.BirthDateElement = new Hl7.Fhir.Model.Date();
							await ParseAsync(result.BirthDateElement as Hl7.Fhir.Model.Date, reader, outcome, locationPath + ".birthDate"); // 150
							break;
						case "photo":
							var newItem_photo = new Hl7.Fhir.Model.Attachment();
							await ParseAsync(newItem_photo, reader, outcome, locationPath + ".photo["+result.Photo.Count+"]"); // 160
							result.Photo.Add(newItem_photo);
							break;
						case "qualification":
							var newItem_qualification = new Hl7.Fhir.Model.Practitioner.QualificationComponent();
							await ParseAsync(newItem_qualification, reader, outcome, locationPath + ".qualification["+result.Qualification.Count+"]"); // 170
							result.Qualification.Add(newItem_qualification);
							break;
						case "communication":
							var newItem_communication = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_communication, reader, outcome, locationPath + ".communication["+result.Communication.Count+"]"); // 180
							result.Communication.Add(newItem_communication);
							break;
						default:
							// Property not found
