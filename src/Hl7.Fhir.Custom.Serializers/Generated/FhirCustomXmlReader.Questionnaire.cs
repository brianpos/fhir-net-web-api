...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(Questionnaire result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "derivedFrom":
							...
							Parse(newItem_derivedFrom, reader, outcome, locationPath + ".derivedFrom["+result.DerivedFromElement.Count+"]", cancellationToken); // 140
						...
						case "subjectType":
							...
							Parse(newItem_subjectType, reader, outcome, locationPath + ".subjectType["+result.SubjectTypeElement.Count+"]", cancellationToken); // 170
						...
						case "copyright":
							...
							Parse(result.Copyright as Hl7.Fhir.Model.Markdown, reader, outcome, locationPath + ".copyright", cancellationToken); // 250
							break;
						case "approvalDate":
							result.ApprovalDateElement = new Hl7.Fhir.Model.Date();
							Parse(result.ApprovalDateElement as Hl7.Fhir.Model.Date, reader, outcome, locationPath + ".approvalDate", cancellationToken); // 260
							break;
						case "lastReviewDate":
							result.LastReviewDateElement = new Hl7.Fhir.Model.Date();
							Parse(result.LastReviewDateElement as Hl7.Fhir.Model.Date, reader, outcome, locationPath + ".lastReviewDate", cancellationToken); // 270
							break;
						case "effectivePeriod":
							result.EffectivePeriod = new Hl7.Fhir.Model.Period();
							Parse(result.EffectivePeriod as Hl7.Fhir.Model.Period, reader, outcome, locationPath + ".effectivePeriod", cancellationToken); // 280
							break;
						case "code":
							var newItem_code = new Hl7.Fhir.Model.Coding();
							Parse(newItem_code, reader, outcome, locationPath + ".code["+result.Code.Count+"]", cancellationToken); // 290
							result.Code.Add(newItem_code);
							break;
						case "item":
							var newItem_item = new Hl7.Fhir.Model.Questionnaire.ItemComponent();
							Parse(newItem_item, reader, outcome, locationPath + ".item["+result.Item.Count+"]", cancellationToken); // 300
		...
		private async System.Threading.Tasks.Task ParseAsync(Questionnaire result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "derivedFrom":
							var newItem_derivedFrom = new Hl7.Fhir.Model.Canonical();
							await ParseAsync(newItem_derivedFrom, reader, outcome, locationPath + ".derivedFrom["+result.DerivedFromElement.Count+"]", cancellationToken); // 140
							result.DerivedFromElement.Add(newItem_derivedFrom);
							break;
						case "status":
							result.StatusElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.PublicationStatus>();
						...
						case "subjectType":
							var newItem_subjectType = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.ResourceType>();
							await ParseAsync(newItem_subjectType, reader, outcome, locationPath + ".subjectType["+result.SubjectTypeElement.Count+"]", cancellationToken); // 170
							result.SubjectTypeElement.Add(newItem_subjectType);
							break;
						case "date":
							result.DateElement = new Hl7.Fhir.Model.FhirDateTime();
						...
						case "copyright":
							result.Copyright = new Hl7.Fhir.Model.Markdown();
							await ParseAsync(result.Copyright as Hl7.Fhir.Model.Markdown, reader, outcome, locationPath + ".copyright", cancellationToken); // 250
							break;
						case "approvalDate":
							result.ApprovalDateElement = new Hl7.Fhir.Model.Date();
							await ParseAsync(result.ApprovalDateElement as Hl7.Fhir.Model.Date, reader, outcome, locationPath + ".approvalDate", cancellationToken); // 260
							break;
						case "lastReviewDate":
							result.LastReviewDateElement = new Hl7.Fhir.Model.Date();
							await ParseAsync(result.LastReviewDateElement as Hl7.Fhir.Model.Date, reader, outcome, locationPath + ".lastReviewDate", cancellationToken); // 270
							break;
						case "effectivePeriod":
							result.EffectivePeriod = new Hl7.Fhir.Model.Period();
							await ParseAsync(result.EffectivePeriod as Hl7.Fhir.Model.Period, reader, outcome, locationPath + ".effectivePeriod", cancellationToken); // 280
							break;
						case "code":
							var newItem_code = new Hl7.Fhir.Model.Coding();
							await ParseAsync(newItem_code, reader, outcome, locationPath + ".code["+result.Code.Count+"]", cancellationToken); // 290
							result.Code.Add(newItem_code);
							break;
						case "item":
							var newItem_item = new Hl7.Fhir.Model.Questionnaire.ItemComponent();
							await ParseAsync(newItem_item, reader, outcome, locationPath + ".item["+result.Item.Count+"]", cancellationToken); // 300
							result.Item.Add(newItem_item);
							break;
						default:
							// Property not found
