...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(QuestionnaireResponse result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "questionnaire":
							...
							Parse(result.QuestionnaireElement as Hl7.Fhir.Model.Canonical, reader, outcome, locationPath + ".questionnaire", cancellationToken); // 120
							break;
						case "status":
							result.StatusElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.QuestionnaireResponse.QuestionnaireResponseStatus>();
							Parse(result.StatusElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.QuestionnaireResponse.QuestionnaireResponseStatus>, reader, outcome, locationPath + ".status", cancellationToken); // 130
							break;
						case "subject":
						...
						case "authored":
							...
							Parse(result.AuthoredElement as Hl7.Fhir.Model.FhirDateTime, reader, outcome, locationPath + ".authored", cancellationToken); // 160
							break;
						case "author":
							result.Author = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Author as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".author", cancellationToken); // 170
							break;
						case "source":
							result.Source = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Source as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".source", cancellationToken); // 180
							break;
						case "item":
		...
		private async System.Threading.Tasks.Task ParseAsync(QuestionnaireResponse result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "questionnaire":
							result.QuestionnaireElement = new Hl7.Fhir.Model.Canonical();
							await ParseAsync(result.QuestionnaireElement as Hl7.Fhir.Model.Canonical, reader, outcome, locationPath + ".questionnaire", cancellationToken); // 120
							break;
						case "status":
							result.StatusElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.QuestionnaireResponse.QuestionnaireResponseStatus>();
							await ParseAsync(result.StatusElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.QuestionnaireResponse.QuestionnaireResponseStatus>, reader, outcome, locationPath + ".status", cancellationToken); // 130
							break;
						case "subject":
							result.Subject = new Hl7.Fhir.Model.ResourceReference();
						...
						case "authored":
							result.AuthoredElement = new Hl7.Fhir.Model.FhirDateTime();
							await ParseAsync(result.AuthoredElement as Hl7.Fhir.Model.FhirDateTime, reader, outcome, locationPath + ".authored", cancellationToken); // 160
							break;
						case "author":
							result.Author = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Author as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".author", cancellationToken); // 170
							break;
						case "source":
							result.Source = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Source as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".source", cancellationToken); // 180
							break;
						case "item":
							var newItem_item = new Hl7.Fhir.Model.QuestionnaireResponse.ItemComponent();
