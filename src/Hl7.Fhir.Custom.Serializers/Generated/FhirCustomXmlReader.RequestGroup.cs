...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(RequestGroup result, XmlReader reader, OperationOutcome outcome)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "encounter":
							...
							Parse(result.Encounter as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 200
							break;
						case "authoredOn":
						...
						case "author":
							...
							Parse(result.Author as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 220
							break;
						case "reasonCode":
						...
						case "action":
							...
							Parse(newItem_action, reader, outcome); // 260
		...
		private async System.Threading.Tasks.Task ParseAsync(RequestGroup result, XmlReader reader, OperationOutcome outcome)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "encounter":
							result.Encounter = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Encounter as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 200
							break;
						case "authoredOn":
							result.AuthoredOnElement = new Hl7.Fhir.Model.FhirDateTime();
						...
						case "author":
							result.Author = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Author as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 220
							break;
						case "reasonCode":
							var newItem_reasonCode = new Hl7.Fhir.Model.CodeableConcept();
						...
						case "action":
							var newItem_action = new Hl7.Fhir.Model.RequestGroup.ActionComponent();
							await ParseAsync(newItem_action, reader, outcome); // 260
							result.Action.Add(newItem_action);
							break;
						default:
							// Property not found
