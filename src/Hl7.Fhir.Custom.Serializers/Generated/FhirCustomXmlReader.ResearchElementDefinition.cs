...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(ResearchElementDefinition result, XmlReader reader, OperationOutcome outcome)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "type":
							...
							Parse(result.TypeElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.ResearchElementDefinition.ResearchElementType>, reader, outcome); // 390
							break;
						case "variableType":
							result.VariableTypeElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.EvidenceVariableType>();
							Parse(result.VariableTypeElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.EvidenceVariableType>, reader, outcome); // 400
							break;
						case "characteristic":
							var newItem_characteristic = new Hl7.Fhir.Model.ResearchElementDefinition.CharacteristicComponent();
							Parse(newItem_characteristic, reader, outcome); // 410
		...
		private async System.Threading.Tasks.Task ParseAsync(ResearchElementDefinition result, XmlReader reader, OperationOutcome outcome)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "type":
							result.TypeElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.ResearchElementDefinition.ResearchElementType>();
							await ParseAsync(result.TypeElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.ResearchElementDefinition.ResearchElementType>, reader, outcome); // 390
							break;
						case "variableType":
							result.VariableTypeElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.EvidenceVariableType>();
							await ParseAsync(result.VariableTypeElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.EvidenceVariableType>, reader, outcome); // 400
							break;
						case "characteristic":
							var newItem_characteristic = new Hl7.Fhir.Model.ResearchElementDefinition.CharacteristicComponent();
							await ParseAsync(newItem_characteristic, reader, outcome); // 410
							result.Characteristic.Add(newItem_characteristic);
							break;
						default:
							// Property not found
