...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(RiskAssessment result, XmlReader reader, OperationOutcome outcome)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "basedOn":
							...
							Parse(result.BasedOn as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 100
							break;
						case "parent":
							result.Parent = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Parent as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 110
							break;
						case "status":
						...
						case "method":
							...
							Parse(result.Method as Hl7.Fhir.Model.CodeableConcept, reader, outcome); // 130
							break;
						case "code":
						...
						case "condition":
							...
							Parse(result.Condition as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 180
							break;
						case "performer":
							result.Performer = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Performer as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 190
							break;
						case "reasonCode":
		...
		private async System.Threading.Tasks.Task ParseAsync(RiskAssessment result, XmlReader reader, OperationOutcome outcome)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "basedOn":
							result.BasedOn = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.BasedOn as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 100
							break;
						case "parent":
							result.Parent = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Parent as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 110
							break;
						case "status":
							result.StatusElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.ObservationStatus>();
						...
						case "method":
							result.Method = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.Method as Hl7.Fhir.Model.CodeableConcept, reader, outcome); // 130
							break;
						case "code":
							result.Code = new Hl7.Fhir.Model.CodeableConcept();
						...
						case "condition":
							result.Condition = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Condition as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 180
							break;
						case "performer":
							result.Performer = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Performer as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 190
							break;
						case "reasonCode":
							var newItem_reasonCode = new Hl7.Fhir.Model.CodeableConcept();
						...
						case "basis":
							var newItem_basis = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_basis, reader, outcome); // 220
							result.Basis.Add(newItem_basis);
							break;
						case "prediction":
							var newItem_prediction = new Hl7.Fhir.Model.RiskAssessment.PredictionComponent();
							await ParseAsync(newItem_prediction, reader, outcome); // 230
							result.Prediction.Add(newItem_prediction);
							break;
						case "mitigation":
							result.MitigationElement = new Hl7.Fhir.Model.FhirString();
							await ParseAsync(result.MitigationElement as Hl7.Fhir.Model.FhirString, reader, outcome); // 240
							break;
						case "note":
							var newItem_note = new Hl7.Fhir.Model.Annotation();
