...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		public void Parse(Hl7.Fhir.Model.RiskEvidenceSynthesis.RiskEstimateComponent result, XmlReader reader, OperationOutcome outcome)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "value":
							...
							Parse(result.ValueElement as Hl7.Fhir.Model.FhirDecimal, reader, outcome); // 60
							break;
						case "unitOfMeasure":
						...
						case "denominatorCount":
							...
							Parse(result.DenominatorCountElement as Hl7.Fhir.Model.Integer, reader, outcome); // 80
							break;
						case "numeratorCount":
							result.NumeratorCountElement = new Hl7.Fhir.Model.Integer();
							Parse(result.NumeratorCountElement as Hl7.Fhir.Model.Integer, reader, outcome); // 90
							break;
						case "precisionEstimate":
							var newItem_precisionEstimate = new Hl7.Fhir.Model.RiskEvidenceSynthesis.PrecisionEstimateComponent();
							Parse(newItem_precisionEstimate, reader, outcome); // 100
		...
		public async System.Threading.Tasks.Task ParseAsync(Hl7.Fhir.Model.RiskEvidenceSynthesis.RiskEstimateComponent result, XmlReader reader, OperationOutcome outcome)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "value":
							result.ValueElement = new Hl7.Fhir.Model.FhirDecimal();
							await ParseAsync(result.ValueElement as Hl7.Fhir.Model.FhirDecimal, reader, outcome); // 60
							break;
						case "unitOfMeasure":
							result.UnitOfMeasure = new Hl7.Fhir.Model.CodeableConcept();
						...
						case "denominatorCount":
							result.DenominatorCountElement = new Hl7.Fhir.Model.Integer();
							await ParseAsync(result.DenominatorCountElement as Hl7.Fhir.Model.Integer, reader, outcome); // 80
							break;
						case "numeratorCount":
							result.NumeratorCountElement = new Hl7.Fhir.Model.Integer();
							await ParseAsync(result.NumeratorCountElement as Hl7.Fhir.Model.Integer, reader, outcome); // 90
							break;
						case "precisionEstimate":
							var newItem_precisionEstimate = new Hl7.Fhir.Model.RiskEvidenceSynthesis.PrecisionEstimateComponent();
							await ParseAsync(newItem_precisionEstimate, reader, outcome); // 100
							result.PrecisionEstimate.Add(newItem_precisionEstimate);
							break;
						default:
							// Property not found
