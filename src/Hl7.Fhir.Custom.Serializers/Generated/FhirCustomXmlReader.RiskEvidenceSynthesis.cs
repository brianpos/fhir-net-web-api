...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(RiskEvidenceSynthesis result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "outcome":
							...
							Parse(result.Outcome as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".outcome", cancellationToken); // 360
							break;
						case "sampleSize":
							result.SampleSize = new Hl7.Fhir.Model.RiskEvidenceSynthesis.SampleSizeComponent();
							Parse(result.SampleSize as Hl7.Fhir.Model.RiskEvidenceSynthesis.SampleSizeComponent, reader, outcome, locationPath + ".sampleSize", cancellationToken); // 370
							break;
						case "riskEstimate":
							result.RiskEstimate = new Hl7.Fhir.Model.RiskEvidenceSynthesis.RiskEstimateComponent();
							Parse(result.RiskEstimate as Hl7.Fhir.Model.RiskEvidenceSynthesis.RiskEstimateComponent, reader, outcome, locationPath + ".riskEstimate", cancellationToken); // 380
							break;
						case "certainty":
							var newItem_certainty = new Hl7.Fhir.Model.RiskEvidenceSynthesis.CertaintyComponent();
							Parse(newItem_certainty, reader, outcome, locationPath + ".certainty["+result.Certainty.Count+"]", cancellationToken); // 390
		...
		private async System.Threading.Tasks.Task ParseAsync(RiskEvidenceSynthesis result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "outcome":
							result.Outcome = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Outcome as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".outcome", cancellationToken); // 360
							break;
						case "sampleSize":
							result.SampleSize = new Hl7.Fhir.Model.RiskEvidenceSynthesis.SampleSizeComponent();
							await ParseAsync(result.SampleSize as Hl7.Fhir.Model.RiskEvidenceSynthesis.SampleSizeComponent, reader, outcome, locationPath + ".sampleSize", cancellationToken); // 370
							break;
						case "riskEstimate":
							result.RiskEstimate = new Hl7.Fhir.Model.RiskEvidenceSynthesis.RiskEstimateComponent();
							await ParseAsync(result.RiskEstimate as Hl7.Fhir.Model.RiskEvidenceSynthesis.RiskEstimateComponent, reader, outcome, locationPath + ".riskEstimate", cancellationToken); // 380
							break;
						case "certainty":
							var newItem_certainty = new Hl7.Fhir.Model.RiskEvidenceSynthesis.CertaintyComponent();
							await ParseAsync(newItem_certainty, reader, outcome, locationPath + ".certainty["+result.Certainty.Count+"]", cancellationToken); // 390
							result.Certainty.Add(newItem_certainty);
							break;
						default:
							// Property not found
