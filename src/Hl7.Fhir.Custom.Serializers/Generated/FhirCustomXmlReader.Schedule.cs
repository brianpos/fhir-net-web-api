...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(Schedule result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "serviceCategory":
							...
							Parse(newItem_serviceCategory, reader, outcome, locationPath + ".serviceCategory["+result.ServiceCategory.Count+"]"); // 110
							result.ServiceCategory.Add(newItem_serviceCategory);
							break;
						case "serviceType":
							var newItem_serviceType = new Hl7.Fhir.Model.CodeableConcept();
							Parse(newItem_serviceType, reader, outcome, locationPath + ".serviceType["+result.ServiceType.Count+"]"); // 120
							result.ServiceType.Add(newItem_serviceType);
							break;
						case "specialty":
							var newItem_specialty = new Hl7.Fhir.Model.CodeableConcept();
							Parse(newItem_specialty, reader, outcome, locationPath + ".specialty["+result.Specialty.Count+"]"); // 130
							result.Specialty.Add(newItem_specialty);
							break;
						case "actor":
							var newItem_actor = new Hl7.Fhir.Model.ResourceReference();
							Parse(newItem_actor, reader, outcome, locationPath + ".actor["+result.Actor.Count+"]"); // 140
							result.Actor.Add(newItem_actor);
							break;
						case "planningHorizon":
							result.PlanningHorizon = new Hl7.Fhir.Model.Period();
							Parse(result.PlanningHorizon as Hl7.Fhir.Model.Period, reader, outcome, locationPath + ".planningHorizon"); // 150
							break;
						case "comment":
		...
		private async System.Threading.Tasks.Task ParseAsync(Schedule result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "serviceCategory":
							var newItem_serviceCategory = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_serviceCategory, reader, outcome, locationPath + ".serviceCategory["+result.ServiceCategory.Count+"]"); // 110
							result.ServiceCategory.Add(newItem_serviceCategory);
							break;
						case "serviceType":
							var newItem_serviceType = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_serviceType, reader, outcome, locationPath + ".serviceType["+result.ServiceType.Count+"]"); // 120
							result.ServiceType.Add(newItem_serviceType);
							break;
						case "specialty":
							var newItem_specialty = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_specialty, reader, outcome, locationPath + ".specialty["+result.Specialty.Count+"]"); // 130
							result.Specialty.Add(newItem_specialty);
							break;
						case "actor":
							var newItem_actor = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_actor, reader, outcome, locationPath + ".actor["+result.Actor.Count+"]"); // 140
							result.Actor.Add(newItem_actor);
							break;
						case "planningHorizon":
							result.PlanningHorizon = new Hl7.Fhir.Model.Period();
							await ParseAsync(result.PlanningHorizon as Hl7.Fhir.Model.Period, reader, outcome, locationPath + ".planningHorizon"); // 150
							break;
						case "comment":
							result.CommentElement = new Hl7.Fhir.Model.FhirString();
