...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(SearchParameter result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "derivedFrom":
							...
							Parse(result.DerivedFromElement as Hl7.Fhir.Model.Canonical, reader, outcome, locationPath + ".derivedFrom"); // 120
							break;
						case "status":
						...
						case "code":
							...
							Parse(result.CodeElement as Hl7.Fhir.Model.Code, reader, outcome, locationPath + ".code"); // 220
							break;
						case "base":
							var newItem_base = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.ResourceType>();
							Parse(newItem_base, reader, outcome, locationPath + ".base["+result.BaseElement.Count+"]"); // 230
							result.BaseElement.Add(newItem_base);
							break;
						case "type":
							result.TypeElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.SearchParamType>();
							Parse(result.TypeElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.SearchParamType>, reader, outcome, locationPath + ".type"); // 240
							break;
						case "expression":
							result.ExpressionElement = new Hl7.Fhir.Model.FhirString();
							Parse(result.ExpressionElement as Hl7.Fhir.Model.FhirString, reader, outcome, locationPath + ".expression"); // 250
							break;
						case "xpath":
							result.XpathElement = new Hl7.Fhir.Model.FhirString();
							Parse(result.XpathElement as Hl7.Fhir.Model.FhirString, reader, outcome, locationPath + ".xpath"); // 260
							break;
						case "xpathUsage":
							result.XpathUsageElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.SearchParameter.XPathUsageType>();
							Parse(result.XpathUsageElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.SearchParameter.XPathUsageType>, reader, outcome, locationPath + ".xpathUsage"); // 270
							break;
						case "target":
							var newItem_target = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.ResourceType>();
							Parse(newItem_target, reader, outcome, locationPath + ".target["+result.TargetElement.Count+"]"); // 280
							result.TargetElement.Add(newItem_target);
							break;
						case "multipleOr":
							result.MultipleOrElement = new Hl7.Fhir.Model.FhirBoolean();
							Parse(result.MultipleOrElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome, locationPath + ".multipleOr"); // 290
							break;
						case "multipleAnd":
							result.MultipleAndElement = new Hl7.Fhir.Model.FhirBoolean();
							Parse(result.MultipleAndElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome, locationPath + ".multipleAnd"); // 300
							break;
						case "comparator":
							var newItem_comparator = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.SearchParameter.SearchComparator>();
							Parse(newItem_comparator, reader, outcome, locationPath + ".comparator["+result.ComparatorElement.Count+"]"); // 310
						...
						case "modifier":
							...
							Parse(newItem_modifier, reader, outcome, locationPath + ".modifier["+result.ModifierElement.Count+"]"); // 320
							result.ModifierElement.Add(newItem_modifier);
							break;
						case "chain":
							var newItem_chain = new Hl7.Fhir.Model.FhirString();
							Parse(newItem_chain, reader, outcome, locationPath + ".chain["+result.ChainElement.Count+"]"); // 330
							result.ChainElement.Add(newItem_chain);
							break;
						case "component":
							var newItem_component = new Hl7.Fhir.Model.SearchParameter.ComponentComponent();
							Parse(newItem_component, reader, outcome, locationPath + ".component["+result.Component.Count+"]"); // 340
		...
		private async System.Threading.Tasks.Task ParseAsync(SearchParameter result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "derivedFrom":
							result.DerivedFromElement = new Hl7.Fhir.Model.Canonical();
							await ParseAsync(result.DerivedFromElement as Hl7.Fhir.Model.Canonical, reader, outcome, locationPath + ".derivedFrom"); // 120
							break;
						case "status":
							result.StatusElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.PublicationStatus>();
						...
						case "code":
							result.CodeElement = new Hl7.Fhir.Model.Code();
							await ParseAsync(result.CodeElement as Hl7.Fhir.Model.Code, reader, outcome, locationPath + ".code"); // 220
							break;
						case "base":
							var newItem_base = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.ResourceType>();
							await ParseAsync(newItem_base, reader, outcome, locationPath + ".base["+result.BaseElement.Count+"]"); // 230
							result.BaseElement.Add(newItem_base);
							break;
						case "type":
							result.TypeElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.SearchParamType>();
							await ParseAsync(result.TypeElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.SearchParamType>, reader, outcome, locationPath + ".type"); // 240
							break;
						case "expression":
							result.ExpressionElement = new Hl7.Fhir.Model.FhirString();
							await ParseAsync(result.ExpressionElement as Hl7.Fhir.Model.FhirString, reader, outcome, locationPath + ".expression"); // 250
							break;
						case "xpath":
							result.XpathElement = new Hl7.Fhir.Model.FhirString();
							await ParseAsync(result.XpathElement as Hl7.Fhir.Model.FhirString, reader, outcome, locationPath + ".xpath"); // 260
							break;
						case "xpathUsage":
							result.XpathUsageElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.SearchParameter.XPathUsageType>();
							await ParseAsync(result.XpathUsageElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.SearchParameter.XPathUsageType>, reader, outcome, locationPath + ".xpathUsage"); // 270
							break;
						case "target":
							var newItem_target = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.ResourceType>();
							await ParseAsync(newItem_target, reader, outcome, locationPath + ".target["+result.TargetElement.Count+"]"); // 280
							result.TargetElement.Add(newItem_target);
							break;
						case "multipleOr":
							result.MultipleOrElement = new Hl7.Fhir.Model.FhirBoolean();
							await ParseAsync(result.MultipleOrElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome, locationPath + ".multipleOr"); // 290
							break;
						case "multipleAnd":
							result.MultipleAndElement = new Hl7.Fhir.Model.FhirBoolean();
							await ParseAsync(result.MultipleAndElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome, locationPath + ".multipleAnd"); // 300
							break;
						case "comparator":
							var newItem_comparator = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.SearchParameter.SearchComparator>();
							await ParseAsync(newItem_comparator, reader, outcome, locationPath + ".comparator["+result.ComparatorElement.Count+"]"); // 310
							result.ComparatorElement.Add(newItem_comparator);
							break;
						case "modifier":
							var newItem_modifier = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.SearchParameter.SearchModifierCode>();
							await ParseAsync(newItem_modifier, reader, outcome, locationPath + ".modifier["+result.ModifierElement.Count+"]"); // 320
							result.ModifierElement.Add(newItem_modifier);
							break;
						case "chain":
							var newItem_chain = new Hl7.Fhir.Model.FhirString();
							await ParseAsync(newItem_chain, reader, outcome, locationPath + ".chain["+result.ChainElement.Count+"]"); // 330
							result.ChainElement.Add(newItem_chain);
							break;
						case "component":
							var newItem_component = new Hl7.Fhir.Model.SearchParameter.ComponentComponent();
							await ParseAsync(newItem_component, reader, outcome, locationPath + ".component["+result.Component.Count+"]"); // 340
							result.Component.Add(newItem_component);
							break;
						default:
							// Property not found
