...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(SearchParameter result, XmlReader reader, OperationOutcome outcome)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "derivedFrom":
							...
							Parse(result.DerivedFromElement as Hl7.Fhir.Model.Canonical, reader, outcome); // 120
							break;
						case "status":
						...
						case "code":
							...
							Parse(result.CodeElement as Hl7.Fhir.Model.Code, reader, outcome); // 220
							break;
						case "base":
							var newItem_base = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.ResourceType>();
							Parse(newItem_base, reader, outcome); // 230
							result.BaseElement.Add(newItem_base);
							break;
						case "type":
							result.TypeElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.SearchParamType>();
							Parse(result.TypeElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.SearchParamType>, reader, outcome); // 240
							break;
						case "expression":
							result.ExpressionElement = new Hl7.Fhir.Model.FhirString();
							Parse(result.ExpressionElement as Hl7.Fhir.Model.FhirString, reader, outcome); // 250
							break;
						case "xpath":
							result.XpathElement = new Hl7.Fhir.Model.FhirString();
							Parse(result.XpathElement as Hl7.Fhir.Model.FhirString, reader, outcome); // 260
							break;
						case "xpathUsage":
							result.XpathUsageElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.SearchParameter.XPathUsageType>();
							Parse(result.XpathUsageElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.SearchParameter.XPathUsageType>, reader, outcome); // 270
							break;
						case "target":
							var newItem_target = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.ResourceType>();
							Parse(newItem_target, reader, outcome); // 280
							result.TargetElement.Add(newItem_target);
							break;
						case "multipleOr":
							result.MultipleOrElement = new Hl7.Fhir.Model.FhirBoolean();
							Parse(result.MultipleOrElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome); // 290
							break;
						case "multipleAnd":
							result.MultipleAndElement = new Hl7.Fhir.Model.FhirBoolean();
							Parse(result.MultipleAndElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome); // 300
							break;
						case "comparator":
							var newItem_comparator = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.SearchParameter.SearchComparator>();
							Parse(newItem_comparator, reader, outcome); // 310
		...
		private async System.Threading.Tasks.Task ParseAsync(SearchParameter result, XmlReader reader, OperationOutcome outcome)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "derivedFrom":
							result.DerivedFromElement = new Hl7.Fhir.Model.Canonical();
							await ParseAsync(result.DerivedFromElement as Hl7.Fhir.Model.Canonical, reader, outcome); // 120
							break;
						case "status":
							result.StatusElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.PublicationStatus>();
						...
						case "code":
							result.CodeElement = new Hl7.Fhir.Model.Code();
							await ParseAsync(result.CodeElement as Hl7.Fhir.Model.Code, reader, outcome); // 220
							break;
						case "base":
							var newItem_base = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.ResourceType>();
							await ParseAsync(newItem_base, reader, outcome); // 230
							result.BaseElement.Add(newItem_base);
							break;
						case "type":
							result.TypeElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.SearchParamType>();
							await ParseAsync(result.TypeElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.SearchParamType>, reader, outcome); // 240
							break;
						case "expression":
							result.ExpressionElement = new Hl7.Fhir.Model.FhirString();
							await ParseAsync(result.ExpressionElement as Hl7.Fhir.Model.FhirString, reader, outcome); // 250
							break;
						case "xpath":
							result.XpathElement = new Hl7.Fhir.Model.FhirString();
							await ParseAsync(result.XpathElement as Hl7.Fhir.Model.FhirString, reader, outcome); // 260
							break;
						case "xpathUsage":
							result.XpathUsageElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.SearchParameter.XPathUsageType>();
							await ParseAsync(result.XpathUsageElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.SearchParameter.XPathUsageType>, reader, outcome); // 270
							break;
						case "target":
							var newItem_target = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.ResourceType>();
							await ParseAsync(newItem_target, reader, outcome); // 280
							result.TargetElement.Add(newItem_target);
							break;
						case "multipleOr":
							result.MultipleOrElement = new Hl7.Fhir.Model.FhirBoolean();
							await ParseAsync(result.MultipleOrElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome); // 290
							break;
						case "multipleAnd":
							result.MultipleAndElement = new Hl7.Fhir.Model.FhirBoolean();
							await ParseAsync(result.MultipleAndElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome); // 300
							break;
						case "comparator":
							var newItem_comparator = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.SearchParameter.SearchComparator>();
							await ParseAsync(newItem_comparator, reader, outcome); // 310
							result.ComparatorElement.Add(newItem_comparator);
							break;
						case "modifier":
							var newItem_modifier = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.SearchParameter.SearchModifierCode>();
							await ParseAsync(newItem_modifier, reader, outcome); // 320
							result.ModifierElement.Add(newItem_modifier);
							break;
						case "chain":
							var newItem_chain = new Hl7.Fhir.Model.FhirString();
							await ParseAsync(newItem_chain, reader, outcome); // 330
							result.ChainElement.Add(newItem_chain);
							break;
						case "component":
							var newItem_component = new Hl7.Fhir.Model.SearchParameter.ComponentComponent();
							await ParseAsync(newItem_component, reader, outcome); // 340
							result.Component.Add(newItem_component);
							break;
						default:
							// Property not found
