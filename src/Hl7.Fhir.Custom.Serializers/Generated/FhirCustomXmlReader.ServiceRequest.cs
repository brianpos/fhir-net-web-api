...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(ServiceRequest result, XmlReader reader, OperationOutcome outcome)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "requisition":
							...
							Parse(result.Requisition as Hl7.Fhir.Model.Identifier, reader, outcome); // 140
							break;
						case "status":
						...
						case "intent":
							...
							Parse(result.IntentElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.RequestIntent>, reader, outcome); // 160
							break;
						case "category":
						...
						case "priority":
							...
							Parse(result.PriorityElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.RequestPriority>, reader, outcome); // 180
							break;
						case "doNotPerform":
							result.DoNotPerformElement = new Hl7.Fhir.Model.FhirBoolean();
							Parse(result.DoNotPerformElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome); // 190
							break;
						case "code":
						...
						case "orderDetail":
							...
							Parse(newItem_orderDetail, reader, outcome); // 210
						...
						case "quantityRatio":
							...
							Parse(result.Quantity as Hl7.Fhir.Model.Ratio, reader, outcome); // 220
							break;
						case "quantityRange":
							result.Quantity = new Hl7.Fhir.Model.Range();
							Parse(result.Quantity as Hl7.Fhir.Model.Range, reader, outcome); // 220
							break;
						case "subject":
							result.Subject = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Subject as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 230
							break;
						case "encounter":
						...
						case "occurrenceDateTime":
							...
							Parse(result.Occurrence as Hl7.Fhir.Model.FhirDateTime, reader, outcome); // 250
							break;
						case "occurrencePeriod":
							result.Occurrence = new Hl7.Fhir.Model.Period();
							Parse(result.Occurrence as Hl7.Fhir.Model.Period, reader, outcome); // 250
							break;
						case "occurrenceTiming":
							result.Occurrence = new Hl7.Fhir.Model.Timing();
							Parse(result.Occurrence as Hl7.Fhir.Model.Timing, reader, outcome); // 250
							break;
						case "asNeededBoolean":
							result.AsNeeded = new Hl7.Fhir.Model.FhirBoolean();
							Parse(result.AsNeeded as Hl7.Fhir.Model.FhirBoolean, reader, outcome); // 260
							break;
						case "asNeededCodeableConcept":
							result.AsNeeded = new Hl7.Fhir.Model.CodeableConcept();
							Parse(result.AsNeeded as Hl7.Fhir.Model.CodeableConcept, reader, outcome); // 260
							break;
						case "authoredOn":
							result.AuthoredOnElement = new Hl7.Fhir.Model.FhirDateTime();
							Parse(result.AuthoredOnElement as Hl7.Fhir.Model.FhirDateTime, reader, outcome); // 270
							break;
						case "requester":
		...
		private async System.Threading.Tasks.Task ParseAsync(ServiceRequest result, XmlReader reader, OperationOutcome outcome)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "requisition":
							result.Requisition = new Hl7.Fhir.Model.Identifier();
							await ParseAsync(result.Requisition as Hl7.Fhir.Model.Identifier, reader, outcome); // 140
							break;
						case "status":
							result.StatusElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.RequestStatus>();
						...
						case "intent":
							result.IntentElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.RequestIntent>();
							await ParseAsync(result.IntentElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.RequestIntent>, reader, outcome); // 160
							break;
						case "category":
							var newItem_category = new Hl7.Fhir.Model.CodeableConcept();
						...
						case "priority":
							result.PriorityElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.RequestPriority>();
							await ParseAsync(result.PriorityElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.RequestPriority>, reader, outcome); // 180
							break;
						case "doNotPerform":
							result.DoNotPerformElement = new Hl7.Fhir.Model.FhirBoolean();
							await ParseAsync(result.DoNotPerformElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome); // 190
							break;
						case "code":
							result.Code = new Hl7.Fhir.Model.CodeableConcept();
						...
						case "orderDetail":
							var newItem_orderDetail = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_orderDetail, reader, outcome); // 210
							result.OrderDetail.Add(newItem_orderDetail);
							break;
						case "quantityQuantity":
							result.Quantity = new Hl7.Fhir.Model.Quantity();
						...
						case "quantityRatio":
							result.Quantity = new Hl7.Fhir.Model.Ratio();
							await ParseAsync(result.Quantity as Hl7.Fhir.Model.Ratio, reader, outcome); // 220
							break;
						case "quantityRange":
							result.Quantity = new Hl7.Fhir.Model.Range();
							await ParseAsync(result.Quantity as Hl7.Fhir.Model.Range, reader, outcome); // 220
							break;
						case "subject":
							result.Subject = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Subject as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 230
							break;
						case "encounter":
							result.Encounter = new Hl7.Fhir.Model.ResourceReference();
						...
						case "occurrenceDateTime":
							result.Occurrence = new Hl7.Fhir.Model.FhirDateTime();
							await ParseAsync(result.Occurrence as Hl7.Fhir.Model.FhirDateTime, reader, outcome); // 250
							break;
						case "occurrencePeriod":
							result.Occurrence = new Hl7.Fhir.Model.Period();
							await ParseAsync(result.Occurrence as Hl7.Fhir.Model.Period, reader, outcome); // 250
							break;
						case "occurrenceTiming":
							result.Occurrence = new Hl7.Fhir.Model.Timing();
							await ParseAsync(result.Occurrence as Hl7.Fhir.Model.Timing, reader, outcome); // 250
							break;
						case "asNeededBoolean":
							result.AsNeeded = new Hl7.Fhir.Model.FhirBoolean();
							await ParseAsync(result.AsNeeded as Hl7.Fhir.Model.FhirBoolean, reader, outcome); // 260
							break;
						case "asNeededCodeableConcept":
							result.AsNeeded = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.AsNeeded as Hl7.Fhir.Model.CodeableConcept, reader, outcome); // 260
							break;
						case "authoredOn":
							result.AuthoredOnElement = new Hl7.Fhir.Model.FhirDateTime();
							await ParseAsync(result.AuthoredOnElement as Hl7.Fhir.Model.FhirDateTime, reader, outcome); // 270
							break;
						case "requester":
							result.Requester = new Hl7.Fhir.Model.ResourceReference();
						...
						case "performerType":
							result.PerformerType = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.PerformerType as Hl7.Fhir.Model.CodeableConcept, reader, outcome); // 290
							break;
						case "performer":
							var newItem_performer = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_performer, reader, outcome); // 300
							result.Performer.Add(newItem_performer);
							break;
						case "locationCode":
							var newItem_locationCode = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_locationCode, reader, outcome); // 310
							result.LocationCode.Add(newItem_locationCode);
							break;
						case "locationReference":
							var newItem_locationReference = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_locationReference, reader, outcome); // 320
							result.LocationReference.Add(newItem_locationReference);
							break;
						case "reasonCode":
							var newItem_reasonCode = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_reasonCode, reader, outcome); // 330
							result.ReasonCode.Add(newItem_reasonCode);
							break;
						case "reasonReference":
							var newItem_reasonReference = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_reasonReference, reader, outcome); // 340
							result.ReasonReference.Add(newItem_reasonReference);
							break;
						case "insurance":
							var newItem_insurance = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_insurance, reader, outcome); // 350
							result.Insurance.Add(newItem_insurance);
							break;
						case "supportingInfo":
							var newItem_supportingInfo = new Hl7.Fhir.Model.ResourceReference();
						...
						case "specimen":
							var newItem_specimen = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_specimen, reader, outcome); // 370
							result.Specimen.Add(newItem_specimen);
							break;
						case "bodySite":
							var newItem_bodySite = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_bodySite, reader, outcome); // 380
							result.BodySite.Add(newItem_bodySite);
							break;
						case "note":
							var newItem_note = new Hl7.Fhir.Model.Annotation();
							await ParseAsync(newItem_note, reader, outcome); // 390
							result.Note.Add(newItem_note);
							break;
						case "patientInstruction":
							result.PatientInstructionElement = new Hl7.Fhir.Model.FhirString();
							await ParseAsync(result.PatientInstructionElement as Hl7.Fhir.Model.FhirString, reader, outcome); // 400
							break;
						case "relevantHistory":
							var newItem_relevantHistory = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_relevantHistory, reader, outcome); // 410
							result.RelevantHistory.Add(newItem_relevantHistory);
							break;
						default:
							// Property not found
