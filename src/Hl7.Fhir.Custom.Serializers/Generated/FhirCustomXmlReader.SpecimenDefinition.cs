...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(SpecimenDefinition result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "typeCollected":
							...
							Parse(result.TypeCollected as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".typeCollected"); // 100
							break;
						case "patientPreparation":
							var newItem_patientPreparation = new Hl7.Fhir.Model.CodeableConcept();
							Parse(newItem_patientPreparation, reader, outcome, locationPath + ".patientPreparation["+result.PatientPreparation.Count+"]"); // 110
							result.PatientPreparation.Add(newItem_patientPreparation);
							break;
						case "timeAspect":
							result.TimeAspectElement = new Hl7.Fhir.Model.FhirString();
							Parse(result.TimeAspectElement as Hl7.Fhir.Model.FhirString, reader, outcome, locationPath + ".timeAspect"); // 120
							break;
						case "collection":
							var newItem_collection = new Hl7.Fhir.Model.CodeableConcept();
							Parse(newItem_collection, reader, outcome, locationPath + ".collection["+result.Collection.Count+"]"); // 130
							result.Collection.Add(newItem_collection);
							break;
						case "typeTested":
							var newItem_typeTested = new Hl7.Fhir.Model.SpecimenDefinition.TypeTestedComponent();
							Parse(newItem_typeTested, reader, outcome, locationPath + ".typeTested["+result.TypeTested.Count+"]"); // 140
		...
		private async System.Threading.Tasks.Task ParseAsync(SpecimenDefinition result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "typeCollected":
							result.TypeCollected = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.TypeCollected as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".typeCollected"); // 100
							break;
						case "patientPreparation":
							var newItem_patientPreparation = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_patientPreparation, reader, outcome, locationPath + ".patientPreparation["+result.PatientPreparation.Count+"]"); // 110
							result.PatientPreparation.Add(newItem_patientPreparation);
							break;
						case "timeAspect":
							result.TimeAspectElement = new Hl7.Fhir.Model.FhirString();
							await ParseAsync(result.TimeAspectElement as Hl7.Fhir.Model.FhirString, reader, outcome, locationPath + ".timeAspect"); // 120
							break;
						case "collection":
							var newItem_collection = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_collection, reader, outcome, locationPath + ".collection["+result.Collection.Count+"]"); // 130
							result.Collection.Add(newItem_collection);
							break;
						case "typeTested":
							var newItem_typeTested = new Hl7.Fhir.Model.SpecimenDefinition.TypeTestedComponent();
							await ParseAsync(newItem_typeTested, reader, outcome, locationPath + ".typeTested["+result.TypeTested.Count+"]"); // 140
							result.TypeTested.Add(newItem_typeTested);
							break;
						default:
							// Property not found
