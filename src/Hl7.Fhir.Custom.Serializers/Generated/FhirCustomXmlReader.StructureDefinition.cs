...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(StructureDefinition result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "keyword":
							...
							Parse(newItem_keyword, reader, outcome, locationPath + ".keyword["+result.Keyword.Count+"]"); // 240
							result.Keyword.Add(newItem_keyword);
							break;
						case "fhirVersion":
							result.FhirVersionElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.FHIRVersion>();
							Parse(result.FhirVersionElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.FHIRVersion>, reader, outcome, locationPath + ".fhirVersion"); // 250
							break;
						case "mapping":
							var newItem_mapping = new Hl7.Fhir.Model.StructureDefinition.MappingComponent();
							Parse(newItem_mapping, reader, outcome, locationPath + ".mapping["+result.Mapping.Count+"]"); // 260
						...
						case "kind":
							...
							Parse(result.KindElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.StructureDefinition.StructureDefinitionKind>, reader, outcome, locationPath + ".kind"); // 270
							break;
						case "abstract":
							result.AbstractElement = new Hl7.Fhir.Model.FhirBoolean();
							Parse(result.AbstractElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome, locationPath + ".abstract"); // 280
							break;
						case "context":
							var newItem_context = new Hl7.Fhir.Model.StructureDefinition.ContextComponent();
							Parse(newItem_context, reader, outcome, locationPath + ".context["+result.Context.Count+"]"); // 290
							result.Context.Add(newItem_context);
							break;
						case "contextInvariant":
							var newItem_contextInvariant = new Hl7.Fhir.Model.FhirString();
							Parse(newItem_contextInvariant, reader, outcome, locationPath + ".contextInvariant["+result.ContextInvariantElement.Count+"]"); // 300
							result.ContextInvariantElement.Add(newItem_contextInvariant);
							break;
						case "type":
							result.TypeElement = new Hl7.Fhir.Model.FhirUri();
							Parse(result.TypeElement as Hl7.Fhir.Model.FhirUri, reader, outcome, locationPath + ".type"); // 310
							break;
						case "baseDefinition":
							result.BaseDefinitionElement = new Hl7.Fhir.Model.Canonical();
							Parse(result.BaseDefinitionElement as Hl7.Fhir.Model.Canonical, reader, outcome, locationPath + ".baseDefinition"); // 320
							break;
						case "derivation":
							result.DerivationElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.StructureDefinition.TypeDerivationRule>();
							Parse(result.DerivationElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.StructureDefinition.TypeDerivationRule>, reader, outcome, locationPath + ".derivation"); // 330
							break;
						case "snapshot":
							result.Snapshot = new Hl7.Fhir.Model.StructureDefinition.SnapshotComponent();
							Parse(result.Snapshot as Hl7.Fhir.Model.StructureDefinition.SnapshotComponent, reader, outcome, locationPath + ".snapshot"); // 340
							break;
						case "differential":
							result.Differential = new Hl7.Fhir.Model.StructureDefinition.DifferentialComponent();
							Parse(result.Differential as Hl7.Fhir.Model.StructureDefinition.DifferentialComponent, reader, outcome, locationPath + ".differential"); // 350
							break;
						default:
							// Property not found
		...
		private async System.Threading.Tasks.Task ParseAsync(StructureDefinition result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "keyword":
							var newItem_keyword = new Hl7.Fhir.Model.Coding();
							await ParseAsync(newItem_keyword, reader, outcome, locationPath + ".keyword["+result.Keyword.Count+"]"); // 240
							result.Keyword.Add(newItem_keyword);
							break;
						case "fhirVersion":
							result.FhirVersionElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.FHIRVersion>();
							await ParseAsync(result.FhirVersionElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.FHIRVersion>, reader, outcome, locationPath + ".fhirVersion"); // 250
							break;
						case "mapping":
							var newItem_mapping = new Hl7.Fhir.Model.StructureDefinition.MappingComponent();
							await ParseAsync(newItem_mapping, reader, outcome, locationPath + ".mapping["+result.Mapping.Count+"]"); // 260
							result.Mapping.Add(newItem_mapping);
							break;
						case "kind":
							result.KindElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.StructureDefinition.StructureDefinitionKind>();
							await ParseAsync(result.KindElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.StructureDefinition.StructureDefinitionKind>, reader, outcome, locationPath + ".kind"); // 270
							break;
						case "abstract":
							result.AbstractElement = new Hl7.Fhir.Model.FhirBoolean();
							await ParseAsync(result.AbstractElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome, locationPath + ".abstract"); // 280
							break;
						case "context":
							var newItem_context = new Hl7.Fhir.Model.StructureDefinition.ContextComponent();
							await ParseAsync(newItem_context, reader, outcome, locationPath + ".context["+result.Context.Count+"]"); // 290
							result.Context.Add(newItem_context);
							break;
						case "contextInvariant":
							var newItem_contextInvariant = new Hl7.Fhir.Model.FhirString();
							await ParseAsync(newItem_contextInvariant, reader, outcome, locationPath + ".contextInvariant["+result.ContextInvariantElement.Count+"]"); // 300
							result.ContextInvariantElement.Add(newItem_contextInvariant);
							break;
						case "type":
							result.TypeElement = new Hl7.Fhir.Model.FhirUri();
							await ParseAsync(result.TypeElement as Hl7.Fhir.Model.FhirUri, reader, outcome, locationPath + ".type"); // 310
							break;
						case "baseDefinition":
							result.BaseDefinitionElement = new Hl7.Fhir.Model.Canonical();
							await ParseAsync(result.BaseDefinitionElement as Hl7.Fhir.Model.Canonical, reader, outcome, locationPath + ".baseDefinition"); // 320
							break;
						case "derivation":
							result.DerivationElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.StructureDefinition.TypeDerivationRule>();
							await ParseAsync(result.DerivationElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.StructureDefinition.TypeDerivationRule>, reader, outcome, locationPath + ".derivation"); // 330
							break;
						case "snapshot":
							result.Snapshot = new Hl7.Fhir.Model.StructureDefinition.SnapshotComponent();
							await ParseAsync(result.Snapshot as Hl7.Fhir.Model.StructureDefinition.SnapshotComponent, reader, outcome, locationPath + ".snapshot"); // 340
							break;
						case "differential":
							result.Differential = new Hl7.Fhir.Model.StructureDefinition.DifferentialComponent();
							await ParseAsync(result.Differential as Hl7.Fhir.Model.StructureDefinition.DifferentialComponent, reader, outcome, locationPath + ".differential"); // 350
							break;
						default:
							// Property not found
