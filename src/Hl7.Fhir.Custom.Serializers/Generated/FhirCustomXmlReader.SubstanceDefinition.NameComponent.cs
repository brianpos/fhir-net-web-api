...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		public void Parse(Hl7.Fhir.Model.SubstanceDefinition.NameComponent result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "jurisdiction":
							...
							break;
						case "synonym":
							var newItem_synonym = new Hl7.Fhir.Model.SubstanceDefinition.NameComponent();
							...
							break;
						case "translation":
							var newItem_translation = new Hl7.Fhir.Model.SubstanceDefinition.NameComponent();
							...
							break;
						case "official":
							var newItem_official = new Hl7.Fhir.Model.SubstanceDefinition.OfficialComponent();
		...
		public async System.Threading.Tasks.Task ParseAsync(Hl7.Fhir.Model.SubstanceDefinition.NameComponent result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
