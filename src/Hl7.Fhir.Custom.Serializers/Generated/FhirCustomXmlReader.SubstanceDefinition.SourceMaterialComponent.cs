...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		public void Parse(Hl7.Fhir.Model.SubstanceDefinition.SourceMaterialComponent result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "part":
							...
							Parse(result.Part as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".part", cancellationToken); // 70
							break;
						case "countryOfOrigin":
							var newItem_countryOfOrigin = new Hl7.Fhir.Model.CodeableConcept();
							Parse(newItem_countryOfOrigin, reader, outcome, locationPath + ".countryOfOrigin["+result.CountryOfOrigin.Count+"]", cancellationToken); // 80
		...
		public async System.Threading.Tasks.Task ParseAsync(Hl7.Fhir.Model.SubstanceDefinition.SourceMaterialComponent result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "part":
							result.Part = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.Part as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".part", cancellationToken); // 70
							break;
						case "countryOfOrigin":
							var newItem_countryOfOrigin = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(newItem_countryOfOrigin, reader, outcome, locationPath + ".countryOfOrigin["+result.CountryOfOrigin.Count+"]", cancellationToken); // 80
							result.CountryOfOrigin.Add(newItem_countryOfOrigin);
							break;
						default:
							// Property not found
