...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		public void Parse(Hl7.Fhir.Model.SubstanceNucleicAcid.SubunitComponent result, XmlReader reader, OperationOutcome outcome)
		{
		...
		public async System.Threading.Tasks.Task ParseAsync(Hl7.Fhir.Model.SubstanceNucleicAcid.SubunitComponent result, XmlReader reader, OperationOutcome outcome)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "fivePrime":
							result.FivePrime = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.FivePrime as Hl7.Fhir.Model.CodeableConcept, reader, outcome); // 80
							break;
						case "threePrime":
							result.ThreePrime = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.ThreePrime as Hl7.Fhir.Model.CodeableConcept, reader, outcome); // 90
							break;
						case "linkage":
							var newItem_linkage = new Hl7.Fhir.Model.SubstanceNucleicAcid.LinkageComponent();
							await ParseAsync(newItem_linkage, reader, outcome); // 100
							result.Linkage.Add(newItem_linkage);
							break;
						case "sugar":
							var newItem_sugar = new Hl7.Fhir.Model.SubstanceNucleicAcid.SugarComponent();
							await ParseAsync(newItem_sugar, reader, outcome); // 110
							result.Sugar.Add(newItem_sugar);
							break;
						default:
							// Property not found
