...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		public void Parse(Hl7.Fhir.Model.SubstanceNucleicAcid.SubunitComponent result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "fivePrime":
							...
							Parse(result.FivePrime as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".fivePrime", cancellationToken); // 80
							break;
						case "threePrime":
							result.ThreePrime = new Hl7.Fhir.Model.CodeableConcept();
							Parse(result.ThreePrime as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".threePrime", cancellationToken); // 90
							break;
						case "linkage":
							var newItem_linkage = new Hl7.Fhir.Model.SubstanceNucleicAcid.LinkageComponent();
							Parse(newItem_linkage, reader, outcome, locationPath + ".linkage["+result.Linkage.Count+"]", cancellationToken); // 100
							result.Linkage.Add(newItem_linkage);
							break;
						case "sugar":
							var newItem_sugar = new Hl7.Fhir.Model.SubstanceNucleicAcid.SugarComponent();
							Parse(newItem_sugar, reader, outcome, locationPath + ".sugar["+result.Sugar.Count+"]", cancellationToken); // 110
		...
		public async System.Threading.Tasks.Task ParseAsync(Hl7.Fhir.Model.SubstanceNucleicAcid.SubunitComponent result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "fivePrime":
							result.FivePrime = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.FivePrime as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".fivePrime", cancellationToken); // 80
							break;
						case "threePrime":
							result.ThreePrime = new Hl7.Fhir.Model.CodeableConcept();
							await ParseAsync(result.ThreePrime as Hl7.Fhir.Model.CodeableConcept, reader, outcome, locationPath + ".threePrime", cancellationToken); // 90
							break;
						case "linkage":
							var newItem_linkage = new Hl7.Fhir.Model.SubstanceNucleicAcid.LinkageComponent();
							await ParseAsync(newItem_linkage, reader, outcome, locationPath + ".linkage["+result.Linkage.Count+"]", cancellationToken); // 100
							result.Linkage.Add(newItem_linkage);
							break;
						case "sugar":
							var newItem_sugar = new Hl7.Fhir.Model.SubstanceNucleicAcid.SugarComponent();
							await ParseAsync(newItem_sugar, reader, outcome, locationPath + ".sugar["+result.Sugar.Count+"]", cancellationToken); // 110
							result.Sugar.Add(newItem_sugar);
							break;
						default:
							// Property not found
