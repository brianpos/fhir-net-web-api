...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(SubstanceReferenceInformation result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "comment":
							...
							Parse(result.CommentElement as Hl7.Fhir.Model.FhirString, reader, outcome, locationPath + ".comment"); // 90
							break;
						case "gene":
							var newItem_gene = new Hl7.Fhir.Model.SubstanceReferenceInformation.GeneComponent();
							Parse(newItem_gene, reader, outcome, locationPath + ".gene["+result.Gene.Count+"]"); // 100
						...
						case "geneElement":
							...
							Parse(newItem_geneElement, reader, outcome, locationPath + ".geneElement["+result.GeneElement.Count+"]"); // 110
						...
						case "classification":
							...
							Parse(newItem_classification, reader, outcome, locationPath + ".classification["+result.Classification.Count+"]"); // 120
						...
						case "target":
							...
							Parse(newItem_target, reader, outcome, locationPath + ".target["+result.Target.Count+"]"); // 130
		...
		private async System.Threading.Tasks.Task ParseAsync(SubstanceReferenceInformation result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "comment":
							result.CommentElement = new Hl7.Fhir.Model.FhirString();
							await ParseAsync(result.CommentElement as Hl7.Fhir.Model.FhirString, reader, outcome, locationPath + ".comment"); // 90
							break;
						case "gene":
							var newItem_gene = new Hl7.Fhir.Model.SubstanceReferenceInformation.GeneComponent();
							await ParseAsync(newItem_gene, reader, outcome, locationPath + ".gene["+result.Gene.Count+"]"); // 100
							result.Gene.Add(newItem_gene);
							break;
						case "geneElement":
							var newItem_geneElement = new Hl7.Fhir.Model.SubstanceReferenceInformation.GeneElementComponent();
							await ParseAsync(newItem_geneElement, reader, outcome, locationPath + ".geneElement["+result.GeneElement.Count+"]"); // 110
							result.GeneElement.Add(newItem_geneElement);
							break;
						case "classification":
							var newItem_classification = new Hl7.Fhir.Model.SubstanceReferenceInformation.ClassificationComponent();
							await ParseAsync(newItem_classification, reader, outcome, locationPath + ".classification["+result.Classification.Count+"]"); // 120
							result.Classification.Add(newItem_classification);
							break;
						case "target":
							var newItem_target = new Hl7.Fhir.Model.SubstanceReferenceInformation.TargetComponent();
							await ParseAsync(newItem_target, reader, outcome, locationPath + ".target["+result.Target.Count+"]"); // 130
							result.Target.Add(newItem_target);
							break;
						default:
							// Property not found
