...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(SupplyDelivery result, XmlReader reader, OperationOutcome outcome)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "status":
							...
							Parse(result.StatusElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.SupplyDelivery.SupplyDeliveryStatus>, reader, outcome); // 120
							break;
						case "patient":
						...
						case "suppliedItem":
							...
							Parse(result.SuppliedItem as Hl7.Fhir.Model.SupplyDelivery.SuppliedItemComponent, reader, outcome); // 150
							break;
						...
						case "supplier":
							...
							Parse(result.Supplier as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 170
							break;
						case "destination":
							result.Destination = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Destination as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 180
							break;
						case "receiver":
							var newItem_receiver = new Hl7.Fhir.Model.ResourceReference();
							Parse(newItem_receiver, reader, outcome); // 190
		...
		private async System.Threading.Tasks.Task ParseAsync(SupplyDelivery result, XmlReader reader, OperationOutcome outcome)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "status":
							result.StatusElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.SupplyDelivery.SupplyDeliveryStatus>();
							await ParseAsync(result.StatusElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.SupplyDelivery.SupplyDeliveryStatus>, reader, outcome); // 120
							break;
						case "patient":
							result.Patient = new Hl7.Fhir.Model.ResourceReference();
						...
						case "suppliedItem":
							result.SuppliedItem = new Hl7.Fhir.Model.SupplyDelivery.SuppliedItemComponent();
							await ParseAsync(result.SuppliedItem as Hl7.Fhir.Model.SupplyDelivery.SuppliedItemComponent, reader, outcome); // 150
							break;
						case "occurrenceDateTime":
							result.Occurrence = new Hl7.Fhir.Model.FhirDateTime();
						...
						case "supplier":
							result.Supplier = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Supplier as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 170
							break;
						case "destination":
							result.Destination = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Destination as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 180
							break;
						case "receiver":
							var newItem_receiver = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_receiver, reader, outcome); // 190
							result.Receiver.Add(newItem_receiver);
							break;
						default:
							// Property not found
