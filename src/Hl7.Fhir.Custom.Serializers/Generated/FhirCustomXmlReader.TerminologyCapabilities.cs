...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(TerminologyCapabilities result, XmlReader reader, OperationOutcome outcome)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "software":
							...
							Parse(result.Software as Hl7.Fhir.Model.TerminologyCapabilities.SoftwareComponent, reader, outcome); // 240
							break;
						case "implementation":
							result.Implementation = new Hl7.Fhir.Model.TerminologyCapabilities.ImplementationComponent();
							Parse(result.Implementation as Hl7.Fhir.Model.TerminologyCapabilities.ImplementationComponent, reader, outcome); // 250
							break;
						case "lockedDate":
							result.LockedDateElement = new Hl7.Fhir.Model.FhirBoolean();
							Parse(result.LockedDateElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome); // 260
							break;
						case "codeSystem":
							var newItem_codeSystem = new Hl7.Fhir.Model.TerminologyCapabilities.CodeSystemComponent();
							Parse(newItem_codeSystem, reader, outcome); // 270
							result.CodeSystem.Add(newItem_codeSystem);
							break;
						case "expansion":
							result.Expansion = new Hl7.Fhir.Model.TerminologyCapabilities.ExpansionComponent();
							Parse(result.Expansion as Hl7.Fhir.Model.TerminologyCapabilities.ExpansionComponent, reader, outcome); // 280
							break;
						case "codeSearch":
							result.CodeSearchElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.TerminologyCapabilities.CodeSearchSupport>();
							Parse(result.CodeSearchElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.TerminologyCapabilities.CodeSearchSupport>, reader, outcome); // 290
							break;
						case "validateCode":
							result.ValidateCode = new Hl7.Fhir.Model.TerminologyCapabilities.ValidateCodeComponent();
							Parse(result.ValidateCode as Hl7.Fhir.Model.TerminologyCapabilities.ValidateCodeComponent, reader, outcome); // 300
							break;
						case "translation":
							result.Translation = new Hl7.Fhir.Model.TerminologyCapabilities.TranslationComponent();
							Parse(result.Translation as Hl7.Fhir.Model.TerminologyCapabilities.TranslationComponent, reader, outcome); // 310
							break;
						case "closure":
							result.Closure = new Hl7.Fhir.Model.TerminologyCapabilities.ClosureComponent();
							Parse(result.Closure as Hl7.Fhir.Model.TerminologyCapabilities.ClosureComponent, reader, outcome); // 320
							break;
						default:
							// Property not found
		...
		private async System.Threading.Tasks.Task ParseAsync(TerminologyCapabilities result, XmlReader reader, OperationOutcome outcome)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "software":
							result.Software = new Hl7.Fhir.Model.TerminologyCapabilities.SoftwareComponent();
							await ParseAsync(result.Software as Hl7.Fhir.Model.TerminologyCapabilities.SoftwareComponent, reader, outcome); // 240
							break;
						case "implementation":
							result.Implementation = new Hl7.Fhir.Model.TerminologyCapabilities.ImplementationComponent();
							await ParseAsync(result.Implementation as Hl7.Fhir.Model.TerminologyCapabilities.ImplementationComponent, reader, outcome); // 250
							break;
						case "lockedDate":
							result.LockedDateElement = new Hl7.Fhir.Model.FhirBoolean();
							await ParseAsync(result.LockedDateElement as Hl7.Fhir.Model.FhirBoolean, reader, outcome); // 260
							break;
						case "codeSystem":
							var newItem_codeSystem = new Hl7.Fhir.Model.TerminologyCapabilities.CodeSystemComponent();
							await ParseAsync(newItem_codeSystem, reader, outcome); // 270
							result.CodeSystem.Add(newItem_codeSystem);
							break;
						case "expansion":
							result.Expansion = new Hl7.Fhir.Model.TerminologyCapabilities.ExpansionComponent();
							await ParseAsync(result.Expansion as Hl7.Fhir.Model.TerminologyCapabilities.ExpansionComponent, reader, outcome); // 280
							break;
						case "codeSearch":
							result.CodeSearchElement = new Hl7.Fhir.Model.Code<Hl7.Fhir.Model.TerminologyCapabilities.CodeSearchSupport>();
							await ParseAsync(result.CodeSearchElement as Hl7.Fhir.Model.Code<Hl7.Fhir.Model.TerminologyCapabilities.CodeSearchSupport>, reader, outcome); // 290
							break;
						case "validateCode":
							result.ValidateCode = new Hl7.Fhir.Model.TerminologyCapabilities.ValidateCodeComponent();
							await ParseAsync(result.ValidateCode as Hl7.Fhir.Model.TerminologyCapabilities.ValidateCodeComponent, reader, outcome); // 300
							break;
						case "translation":
							result.Translation = new Hl7.Fhir.Model.TerminologyCapabilities.TranslationComponent();
							await ParseAsync(result.Translation as Hl7.Fhir.Model.TerminologyCapabilities.TranslationComponent, reader, outcome); // 310
							break;
						case "closure":
							result.Closure = new Hl7.Fhir.Model.TerminologyCapabilities.ClosureComponent();
							await ParseAsync(result.Closure as Hl7.Fhir.Model.TerminologyCapabilities.ClosureComponent, reader, outcome); // 320
							break;
						default:
							// Property not found
