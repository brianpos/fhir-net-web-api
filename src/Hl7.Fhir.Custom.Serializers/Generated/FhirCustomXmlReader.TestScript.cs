...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(TestScript result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "identifier":
							...
							Parse(result.Identifier as Hl7.Fhir.Model.Identifier, reader, outcome, locationPath + ".identifier", cancellationToken); // 100
							break;
						case "version":
						...
						case "origin":
							...
							Parse(newItem_origin, reader, outcome, locationPath + ".origin["+result.Origin.Count+"]", cancellationToken); // 240
							result.Origin.Add(newItem_origin);
							break;
						case "destination":
							var newItem_destination = new Hl7.Fhir.Model.TestScript.DestinationComponent();
							Parse(newItem_destination, reader, outcome, locationPath + ".destination["+result.Destination.Count+"]", cancellationToken); // 250
							result.Destination.Add(newItem_destination);
							break;
						case "metadata":
							result.Metadata = new Hl7.Fhir.Model.TestScript.MetadataComponent();
							Parse(result.Metadata as Hl7.Fhir.Model.TestScript.MetadataComponent, reader, outcome, locationPath + ".metadata", cancellationToken); // 260
							break;
						case "fixture":
							var newItem_fixture = new Hl7.Fhir.Model.TestScript.FixtureComponent();
							Parse(newItem_fixture, reader, outcome, locationPath + ".fixture["+result.Fixture.Count+"]", cancellationToken); // 270
							result.Fixture.Add(newItem_fixture);
							break;
						case "profile":
							var newItem_profile = new Hl7.Fhir.Model.ResourceReference();
							Parse(newItem_profile, reader, outcome, locationPath + ".profile["+result.Profile.Count+"]", cancellationToken); // 280
							result.Profile.Add(newItem_profile);
							break;
						case "variable":
							var newItem_variable = new Hl7.Fhir.Model.TestScript.VariableComponent();
							Parse(newItem_variable, reader, outcome, locationPath + ".variable["+result.Variable.Count+"]", cancellationToken); // 290
							result.Variable.Add(newItem_variable);
							break;
						case "setup":
							result.Setup = new Hl7.Fhir.Model.TestScript.SetupComponent();
							Parse(result.Setup as Hl7.Fhir.Model.TestScript.SetupComponent, reader, outcome, locationPath + ".setup", cancellationToken); // 300
							break;
						case "test":
							var newItem_test = new Hl7.Fhir.Model.TestScript.TestComponent();
							Parse(newItem_test, reader, outcome, locationPath + ".test["+result.Test.Count+"]", cancellationToken); // 310
							result.Test.Add(newItem_test);
							break;
						case "teardown":
							result.Teardown = new Hl7.Fhir.Model.TestScript.TeardownComponent();
							Parse(result.Teardown as Hl7.Fhir.Model.TestScript.TeardownComponent, reader, outcome, locationPath + ".teardown", cancellationToken); // 320
							break;
						default:
							// Property not found
		...
		private async System.Threading.Tasks.Task ParseAsync(TestScript result, XmlReader reader, OperationOutcome outcome, string locationPath, CancellationToken cancellationToken)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "identifier":
							result.Identifier = new Hl7.Fhir.Model.Identifier();
							await ParseAsync(result.Identifier as Hl7.Fhir.Model.Identifier, reader, outcome, locationPath + ".identifier", cancellationToken); // 100
							break;
						case "version":
							result.VersionElement = new Hl7.Fhir.Model.FhirString();
						...
						case "origin":
							var newItem_origin = new Hl7.Fhir.Model.TestScript.OriginComponent();
							await ParseAsync(newItem_origin, reader, outcome, locationPath + ".origin["+result.Origin.Count+"]", cancellationToken); // 240
							result.Origin.Add(newItem_origin);
							break;
						case "destination":
							var newItem_destination = new Hl7.Fhir.Model.TestScript.DestinationComponent();
							await ParseAsync(newItem_destination, reader, outcome, locationPath + ".destination["+result.Destination.Count+"]", cancellationToken); // 250
							result.Destination.Add(newItem_destination);
							break;
						case "metadata":
							result.Metadata = new Hl7.Fhir.Model.TestScript.MetadataComponent();
							await ParseAsync(result.Metadata as Hl7.Fhir.Model.TestScript.MetadataComponent, reader, outcome, locationPath + ".metadata", cancellationToken); // 260
							break;
						case "fixture":
							var newItem_fixture = new Hl7.Fhir.Model.TestScript.FixtureComponent();
							await ParseAsync(newItem_fixture, reader, outcome, locationPath + ".fixture["+result.Fixture.Count+"]", cancellationToken); // 270
							result.Fixture.Add(newItem_fixture);
							break;
						case "profile":
							var newItem_profile = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(newItem_profile, reader, outcome, locationPath + ".profile["+result.Profile.Count+"]", cancellationToken); // 280
							result.Profile.Add(newItem_profile);
							break;
						case "variable":
							var newItem_variable = new Hl7.Fhir.Model.TestScript.VariableComponent();
							await ParseAsync(newItem_variable, reader, outcome, locationPath + ".variable["+result.Variable.Count+"]", cancellationToken); // 290
							result.Variable.Add(newItem_variable);
							break;
						case "setup":
							result.Setup = new Hl7.Fhir.Model.TestScript.SetupComponent();
							await ParseAsync(result.Setup as Hl7.Fhir.Model.TestScript.SetupComponent, reader, outcome, locationPath + ".setup", cancellationToken); // 300
							break;
						case "test":
							var newItem_test = new Hl7.Fhir.Model.TestScript.TestComponent();
							await ParseAsync(newItem_test, reader, outcome, locationPath + ".test["+result.Test.Count+"]", cancellationToken); // 310
							result.Test.Add(newItem_test);
							break;
						case "teardown":
							result.Teardown = new Hl7.Fhir.Model.TestScript.TeardownComponent();
							await ParseAsync(result.Teardown as Hl7.Fhir.Model.TestScript.TeardownComponent, reader, outcome, locationPath + ".teardown", cancellationToken); // 320
							break;
						default:
							// Property not found
