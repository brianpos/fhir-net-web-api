...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(VisionPrescription result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "created":
							...
							Parse(result.CreatedElement as Hl7.Fhir.Model.FhirDateTime, reader, outcome, locationPath + ".created"); // 110
							break;
						case "patient":
						...
						case "dateWritten":
							...
							Parse(result.DateWrittenElement as Hl7.Fhir.Model.FhirDateTime, reader, outcome, locationPath + ".dateWritten"); // 140
							break;
						case "prescriber":
							result.Prescriber = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Prescriber as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".prescriber"); // 150
							break;
						case "lensSpecification":
							var newItem_lensSpecification = new Hl7.Fhir.Model.VisionPrescription.LensSpecificationComponent();
							Parse(newItem_lensSpecification, reader, outcome, locationPath + ".lensSpecification["+result.LensSpecification.Count+"]"); // 160
		...
		private async System.Threading.Tasks.Task ParseAsync(VisionPrescription result, XmlReader reader, OperationOutcome outcome, string locationPath)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "created":
							result.CreatedElement = new Hl7.Fhir.Model.FhirDateTime();
							await ParseAsync(result.CreatedElement as Hl7.Fhir.Model.FhirDateTime, reader, outcome, locationPath + ".created"); // 110
							break;
						case "patient":
							result.Patient = new Hl7.Fhir.Model.ResourceReference();
						...
						case "dateWritten":
							result.DateWrittenElement = new Hl7.Fhir.Model.FhirDateTime();
							await ParseAsync(result.DateWrittenElement as Hl7.Fhir.Model.FhirDateTime, reader, outcome, locationPath + ".dateWritten"); // 140
							break;
						case "prescriber":
							result.Prescriber = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Prescriber as Hl7.Fhir.Model.ResourceReference, reader, outcome, locationPath + ".prescriber"); // 150
							break;
						case "lensSpecification":
							var newItem_lensSpecification = new Hl7.Fhir.Model.VisionPrescription.LensSpecificationComponent();
							await ParseAsync(newItem_lensSpecification, reader, outcome, locationPath + ".lensSpecification["+result.LensSpecification.Count+"]"); // 160
							result.LensSpecification.Add(newItem_lensSpecification);
							break;
						default:
							// Property not found
