...
namespace Hl7.Fhir.CustomSerializer
{
    ...
    {
		private void Parse(VisionPrescription result, XmlReader reader, OperationOutcome outcome)
		{
				...
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "dateWritten":
							...
							Parse(result.DateWrittenElement as Hl7.Fhir.Model.FhirDateTime, reader, outcome); // 140
							break;
						case "prescriber":
							result.Prescriber = new Hl7.Fhir.Model.ResourceReference();
							Parse(result.Prescriber as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 150
							break;
						case "lensSpecification":
							var newItem_lensSpecification = new Hl7.Fhir.Model.VisionPrescription.LensSpecificationComponent();
							Parse(newItem_lensSpecification, reader, outcome); // 160
		...
		private async System.Threading.Tasks.Task ParseAsync(VisionPrescription result, XmlReader reader, OperationOutcome outcome)
		{
			// skip ignored elements
			while (ShouldSkipNodeType(reader.NodeType))
			...
			while (await reader.ReadAsync().ConfigureAwait(false))
			{
				if (reader.IsStartElement())
				{
					switch (reader.Name)
					{
						...
						case "dateWritten":
							result.DateWrittenElement = new Hl7.Fhir.Model.FhirDateTime();
							await ParseAsync(result.DateWrittenElement as Hl7.Fhir.Model.FhirDateTime, reader, outcome); // 140
							break;
						case "prescriber":
							result.Prescriber = new Hl7.Fhir.Model.ResourceReference();
							await ParseAsync(result.Prescriber as Hl7.Fhir.Model.ResourceReference, reader, outcome); // 150
							break;
						case "lensSpecification":
							var newItem_lensSpecification = new Hl7.Fhir.Model.VisionPrescription.LensSpecificationComponent();
							await ParseAsync(newItem_lensSpecification, reader, outcome); // 160
							result.LensSpecification.Add(newItem_lensSpecification);
							break;
						default:
							// Property not found
